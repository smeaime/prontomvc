...
Object = "{12DE615C-8D4B-4936-8801-459AB2EAA3FC}#1.0#0"; "Controles1013.ocx"
Begin VB.Form frmSalidasMateriales 
   ...
   Begin RichTextLib.RichTextBox rchObservaciones 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"frmSalidasMateriales.frx":0000
   End
   ...
   Begin Controles1013.DbListView Lista 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmSalidasMateriales.frx":0082
   ...
   Begin RichTextLib.RichTextBox rchObservacionesItem 
      ...
      _Version        =   393217
      Enabled         =   -1  'True
      TextRTF         =   $"frmSalidasMateriales.frx":009E
   End
   Begin MSDataListLib.DataCombo dcfields 
   ...
   Begin MSComctlLib.ImageList Img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalidasMateriales.frx":0120
            Key             =   "Eliminado"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalidasMateriales.frx":017E
            Key             =   "Nuevo"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalidasMateriales.frx":01DC
            Key             =   "Modificado"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmSalidasMateriales.frx":023A
            Key             =   "Original"
         EndProperty
      EndProperty
   End
...
Private mDescargaPorKit As String
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      Case 0
         ...
         Dim mvarRegistroContableComprasAlActivo As String, mvarADistribuirEnPresupuestoDeObra As String
         Dim mvarPartida As String
         ...
         For Each dc In dcfields
            If dc.Enabled And dc.Visible Then
               If Not IsNumeric(dc.BoundText) And _
                     dc.Index <> 1 And dc.Index <> 2 And dc.Index <> 3 And _
                     dc.Index <> 7 And dc.Index <> 8 Then
                  ...
                  Do While Not .EOF
                     If Not .Fields("Eliminado").Value Then
                           ...
                           If IIf(IsNull(.Fields("DescargaPorKit").Value), "NO", .Fields("DescargaPorKit").Value) = "NO" Then
                              ...
                              If mvarId < 0 Then
                                 ...
                                 Do While Not oRsAux1.EOF
                                    ...
                                    oRsAux1.MoveNext
                                 Loop
                                 If mvarAux5 <> "SI" And mvarStock1 < Round(mvarCantidadUnidades + mvarCantidad1, 2) Then
                                    Set oRsDet = Nothing
                              ...
                              Else
                                 ...
                                 oRsStk.Close
                                 Set oRsStk = Nothing
                                 If mvarAux5 <> "SI" And mvarStock1 < Round(mvarCantidadUnidades - mvarStock, 2) Then
                                    Set oRsDet = Nothing
                                    MsgBox "El articulo " & mvarArticulo & ", tiene" & vbCrLf & _
                                             "stock insuficiente segun datos ingresados :" & vbCrLf & _
                                             "cantidad actual en stock para la partida, unidad, ubicacion y obra : " & mvarStock1 & vbCrLf & _
                        ...
                        If mvarAux3 = "SI" And Not IsNull(.Fields("IdEquipoDestino").Value) Then
                           Set oRsStk = Aplicacion.SalidasMateriales.TraerFiltrado("_ControlarParteDiarioEquipoDestino", _
                                                Array(.Fields("IdEquipoDestino").Value, DTFields(0).Value))
                           If oRsStk.RecordCount = 0 Then
                              oRsStk.Close
                              Set oRsStk = Nothing
                              Set oRsDet = Nothing
                              MsgBox "Hay equipo(s) destino que no tienen parte del dia " & DTFields(0).Value - 1 & vbCrLf & _
                                       "en el Pronto Mantenimiento", vbExclamation
                              Exit Sub
                           End If
                           oRsStk.Close
                        End If
                        ...
                        If Not IsNull(.Fields("IdDetalleValeSalida").Value) Then
                           Set oRsAux = Aplicacion.TablasGenerales.TraerFiltrado("DetValesSalida", _
                                       "_TodoMasPendientePorIdDetalle", .Fields("IdDetalleValeSalida").Value)
                           If oRsAux.RecordCount > 0 Then
                              If Not IsNull(oRsAux.Fields("IdOrdenTrabajo").Value) Then
                                 If IsNull(oRsAux.Fields("FechaFinalizacion").Value) Or _
                                    oRsAux.Fields("FechaFinalizacion").Value > DTFields(0).Value Or _
