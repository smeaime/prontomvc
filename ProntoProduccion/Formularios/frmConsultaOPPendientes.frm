...
Begin VB.Form frmOPsPendientes 
   Caption         =   "Ordenes de Produccion pendientes"
   ClientHeight    =   6675
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11700
   Icon            =   "frmConsultaOPPendientes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   6675
   ScaleWidth      =   11700
   ...
   Begin RichTextLib.RichTextBox rchObservacionesCumplido 
      ...
      _Version        =   393217
      Enabled         =   -1  'True
      TextRTF         =   $"frmConsultaOPPendientes.frx":076A
   End
   ...
   Begin Controles1013.DbListView Lista 
      ...
      EndProperty
      MouseIcon       =   "frmConsultaOPPendientes.frx":07EC
      OLEDragMode     =   1
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0808
            Key             =   "Imprimir"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":091A
            Key             =   "Buscar"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0A2C
            Key             =   "Ayuda"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0B3E
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0C50
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0D62
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":0E74
            Key             =   "Excel"
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList Img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":12C6
            Key             =   "Eliminado"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":13D8
            Key             =   "Nuevo"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":182A
            Key             =   "Modificado"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaOPPendientes.frx":1C7C
            Key             =   "Original"
         EndProperty
      EndProperty
   End
   Begin RichTextLib.RichTextBox rchObservaciones 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"frmConsultaOPPendientes.frx":20CE
   End
   Begin VB.Label lblLabel1 
      Caption         =   "*Se muestran solamente las OPs aprobadas y filtradas por artículo a producir"
      Height          =   255
      Left            =   4560
      TabIndex        =   15
      Top             =   6000
   ...
   End
End
Attribute VB_Name = "frmOPsPendientes"
...
Public NumeroProduccionOrdenElegida
Public ClienteElegida
Public Cantidad
...
Private Sub Form_Load()
   ...
   Set oRs = Aplicacion.TablasGenerales.TraerFiltrado("ProduccionOrdenes", "_SinCerrarParaLista", Array(Val(FiltroArticulo), Val(FiltroMaterial)))
...
On Error Resume Next
   ...
   End If
        ...
        NumeroProduccionOrdenElegida = Lista.SelectedItem.SubItems(1)
        ClienteElegida = Lista.SelectedItem.SubItems(5)
        Cantidad = Lista.SelectedItem.SubItems(9)
        glbUniRet = Lista.SelectedItem.SubItems(10)

         glbIdArticuloRet = Lista.SelectedItem.SubItems(7)
         'glbCantRet = Lista.SelectedItem.SubItems(8)
         'glbUniRet = Lista.SelectedItem.SubItems(9)
         'glbClienteRet = Lista.SelectedItem.SubItems(5)
         'glbFechaEntrega = Lista.SelectedItem.SubItems(2)
         glbIdColorRet = Lista.SelectedItem.SubItems(18)
