...
Public mvarIdUbicacion As Long
...
Public Sub BuscarPartidas()
   ...
   Set Lista.DataSource = Aplicacion.Articulos.TraerFiltrado("_StockPorPartidaParaProduccion", Array(mvarIdArticulo, mvarIdUbicacion))
