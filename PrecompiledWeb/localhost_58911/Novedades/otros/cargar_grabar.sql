...
--------------------------------------
 ...
 --   grabar desde bdl vpn
    
    
    
    
BACKUP DATABASE Capen
TO DISK = '\\192.168.66.7\Publico\Ftp-BDL\Mariano\Bases'    
--WITH FORMAT,      MEDIANAME = 'Z_SQLServerBackups',      NAME = 'Full Backup of AdventureWorks';

--2paso: comprimir el .bak
--3paso: copiarmelo
...
set @origen='C:\Backup\BDL\otros\bases\BDLMaster.bak'
...
--set @dir='C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA'
--set @dir='E:\Bases\'
set @dir='C:\Backup\BDL\otros\Bases\'
...
set @origen='C:\Backup\BDL\otros\Bases\BK Williams 19-2-13 2.bak'
...
--set @origen='E:\Backup\BDL\ProntoWeb\doc\williams\base\BK Williams 22-2-12.BAK'
--set @origen='E:\Backup\BDL\ProntoWeb\backups\bases\BK Williams 22-2-12.bak'
set @origen='c:\Backup\BDL\otros\Bases\Autotrol.bak'

declare @dir varchar(200)
--set @dir='C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\'
set @dir='C:\Program Files\Microsoft SQL Server\MSSQL10.MSSQLSERVER\MSSQL'
...
declare @origen varchar(200)
set @origen='c:\Backup\BDL\otros\Bases\BK PruebaCapen 8-9-11.BAK'
