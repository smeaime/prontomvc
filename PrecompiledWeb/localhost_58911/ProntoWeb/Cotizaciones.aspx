<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CotizacionesListado, App_Web_tpltxehw" title="Cotizaciones" theme="Azul" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                DataKeyNames="IdCotizacion" PageSize="10" AllowPaging="True" AllowSorting="True">
