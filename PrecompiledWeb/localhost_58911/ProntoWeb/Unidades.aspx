<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Unidades, App_Web_ybmx5aia" title="Unidades" theme="Azul" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:DropDownList ID="cmbBuscarEsteCampo" runat="server" Style="text-align: right;
        ...
        <asp:ListItem Text="Abreviatura" Value="Abreviatura" />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                DataKeyNames="idUnidad" AllowPaging="True" AllowSorting="True" PageSize="10">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Abreviatura">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtAbreviatura" runat="server" Text='<%# Bind("Abreviatura") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox  Width=50px ID="txtNewAbreviatura" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
