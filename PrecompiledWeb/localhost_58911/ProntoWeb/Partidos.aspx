<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Partidoes, App_Web_etthrpg0" title="Partidos" theme="Azul" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:TextBox ID="txtBuscar" runat="server" Style="text-align: right; margin-left: 28px;
        margin-top: 10px;" Text=""  AutoPostBack="True"></asp:TextBox>
                ...
                <asp:ListItem Text="Partido" Value="Partido" Selected="True" />
...
--%>
                    ...
                    <asp:TemplateField HeaderText="Partido">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtPartido" runat="server" Text='<%# Bind("Partido") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewPartido" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblPartido" runat="server" Text='<%# Bind("Partido") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Codigo ONCCA"  >
                        <EditItemTemplate>
                            <asp:TextBox ID="txtCodigoONCAA" Width="30" runat="server" Text='<%# Bind("[CodigoONCCA]") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewCodigoONCAA" Width="30" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate >
                            <asp:Label ID="lblCodigoONCAA" Width="30" runat="server" Text='<%# Bind("[CodigoONCCA]") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
