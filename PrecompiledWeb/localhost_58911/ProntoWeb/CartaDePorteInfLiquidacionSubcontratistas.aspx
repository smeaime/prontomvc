<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CartaDePorteInfLiquidacionSubcontratistas, App_Web_55qckufu" title="Liquidación de Subcontratistas" validaterequest="false" enableeventvalidation="false" theme="Azul" %>
    ...
    <div style="color: white">
        <asp:UpdatePanel ID="UpdatePanelResumen" runat="server">
            <ContentTemplate>
                <br />
                <div class="titulos">
                    Liquidación de Subcontratistas
                </div>
                <br />
                <br />
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:LinkButton ID="btnMasPanel" runat="server" Font-Bold="False" Font-Underline="True"
                            ...
                            display: none" BorderWidth="5px" Width="127px"></asp:LinkButton>
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="txtConcepto1" runat="server" Width="400px"></asp:TextBox><asp:TextBox
                      ...
                      <div class="row">
                        <div class="col-md-2">
                            Concepto 2
                                 ...
                                 <div class="col-md-10">
                            <asp:TextBox ID="txtConcepto2" runat="server" Width="400px"></asp:TextBox><asp:TextBox
