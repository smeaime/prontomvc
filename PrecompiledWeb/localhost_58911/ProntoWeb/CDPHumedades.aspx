<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CDPHumedades, App_Web_auymxxcj" title="Humedades" theme="Azul" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Assembly="System.Web.Extensions, Version=3.5.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
    Namespace="System.Web.UI" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <asp:LinkButton ID="LinkButton8" runat="server" Font-Bold="false" Font-Underline="True" Visible="false"
        ForeColor="White" CausesValidation="true" Font-Size="Small" Height="30px">Exportar a Excel</asp:LinkButton>
  <asp:TextBox ID="txtBuscar" runat="server" Style="text-align: right; margin-left: 39px;
        margin-top: 10px;" Text="" AutoPostBack="True"></asp:TextBox>
                ...
                <asp:ListItem Text="Producto" Value="Articulo" />
                <asp:ListItem Text="Humedad" Value="Humedad" />
                <asp:ListItem Text="Merma" Value="Merma" />
...
--%>
                    ...
                    <asp:TemplateField HeaderText="Producto">
                        <EditItemTemplate>
                            ...
                            <cc1:AutoCompleteExtender CompletionInterval="100" ID="AutoCompleteExtender24" runat="server" CompletionSetCount="12"
                                TargetControlID="txtArticulo" MinimumPrefixLength="1" ServiceMethod="GetCompletionList"
                                ServicePath="WebServiceArticulos.asmx" UseContextKey="True" FirstRowSelected="True"
                                CompletionListCssClass="AutoCompleteScroll" DelimiterCharacters="" Enabled="True">
                            </cc1:AutoCompleteExtender>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewArticulo" runat="server" autocomplete="off"></asp:TextBox>
                            <cc1:AutoCompleteExtender CompletionInterval="100" ID="AutoCompleteExtender4" runat="server" CompletionSetCount="12"
                                TargetControlID="txtNewArticulo" MinimumPrefixLength="1" ServiceMethod="GetCompletionList"
                                ServicePath="WebServiceArticulos.asmx" UseContextKey="True" FirstRowSelected="True"
                                CompletionListCssClass="AutoCompleteScroll" DelimiterCharacters="" Enabled="True">
                            </cc1:AutoCompleteExtender>
                        </FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Humedad">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtHumedad" runat="server" Text='<%# Bind("Humedad") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewHumedad" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblHumedad" runat="server" Text='<%# Bind("Humedad") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Merma" SortExpression="Merma">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtMerma" runat="server" Text='<%# Eval("Merma") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewMerma" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblMerma" runat="server" Text='<%# Bind("Merma") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
