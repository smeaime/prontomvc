<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CartaDePorteInformesAccesoClientes, App_Web_55qckufu" title="Informes" theme="Azul" %>
...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
    ...
    <%--http://stackoverflow.com/questions/4657210/permissions-issues-with-sql-2008-report-builder-2-0--%>
    <%--

ROLES EN REPORTING SERVICES
ROLES EN REPORTING SERVICES
ROLES EN REPORTING SERVICES
ROLES EN REPORTING SERVICES
ROLES EN REPORTING SERVICES
...
http://msdn.microsoft.com/en-us/library/bb558976(v=vs.90).aspx

SQL Server Reporting Services Roles
Visual Studio 2008 Other Versions This topic has not yet been rated - Rate this topic
...
Browser
    ...
    --%>
    <div style="width: 98%; table-layout: fixed; padding: 0; border: none;">
        <asp:updatepanel id="UpdatePanelResumen" runat="server">
            <contenttemplate>
                <br />
                <table  border="0" cellpadding="0" cellspacing="0"><tr><td>
                <asp:ListBox ID="DropDownList3" runat="server" Width="307px" Height="160px" AutoPostBack="true"
                    Style="margin-left: 0px; OVERFLOW: hidden;"  >
               <%--     <asp:ListItem Enabled="True">Ordenes de compra pendientes de facturar</asp:ListItem>
                    <asp:ListItem Enabled="false">Proyeccion de egresos</asp:ListItem>
                    <asp:ListItem Enabled="false">Proyeccion de egresos detallados</asp:ListItem>
                    <asp:ListItem Enabled="false">Cuadro de gastos</asp:ListItem>
                    <asp:ListItem Enabled="true">Cuadro de gastos detallados</asp:ListItem>
                    <asp:ListItem Enabled="false">Cash flow</asp:ListItem>
                    <asp:ListItem Enabled="false">Ventas</asp:ListItem>
                    <asp:ListItem Enabled="false">Ventas detalladas</asp:ListItem>
                    <asp:ListItem Enabled="true">Resumen Posicion financiera</asp:ListItem>
                    <asp:ListItem Enabled="true">Ingresos y Egresos por Obra</asp:ListItem>
                    <asp:ListItem Enabled="false">Presupuesto financiera por rubro contable</asp:ListItem>
                    <asp:ListItem Enabled="false">Presupuesto economico</asp:ListItem>

                    <asp:ListItem Enabled="true">-----------------</asp:ListItem>
                    <asp:ListItem Enabled="true">Proveedores - Listado de comprobantes detallado</asp:ListItem>
                    <asp:ListItem Enabled="true">Remitos por cliente</asp:ListItem>
                    <asp:ListItem Enabled="true">Salidas de materiales</asp:ListItem>
                    <asp:ListItem Enabled="true">Caja ingresos</asp:ListItem>--%>
                </asp:ListBox>
                </td><td>&nbsp;&nbsp;</td><td>
                <div>
                 <asp:hyperlink id="lnkReportBuilderDescarga" runat="server" target="_blank" navigateurl="http://www.microsoft.com/downloads/en/details.aspx?FamilyID=cd7d79e1-f41a-4193-b598-628f40688c6e"
        text="Report Builder 2 descarga" />
    <asp:hyperlink id="HyperLink2" runat="server" target="_blank" navigateurl="http://bdlconsultores.dyndns.org:81/ReportServer/reportbuilder/reportbuilder.application"
        text="Report Builder 2" /><br />
    <%--http://blogs.msdn.com/b/bobmeyers/archive/2006/01/24/report-builder-launch-parameters.aspx--%>
    <asp:hyperlink id="lnkReportServer" runat="server" target="_blank" navigateurl="http://bdlconsultores.dyndns.org:81/ReportServer"
        text="Report Server 2" />
    <asp:hyperlink id="lnkReportManager" runat="server" target="_blank" navigateurl="http://bdlconsultores.dyndns.org:81/ReportManager"
        text="Report Manager" />
    <asp:hyperlink id="HyperLink1" runat="server" target="_blank" navigateurl="http://192.168.66.123:80/Reports"
        text="Report Manager" /></div>
        <br />
                                <asp:Button ID="btnRefrescar2" Text="Refrescar" runat="server" Visible="True" 
                                    Height="27" />
                ...
                <asp:Panel ID="Panel4" runat="server">
                    ...
                    <table style="padding: 0px; border: none #FFFFFF; width: 92%; margin-right: 0px;
                        height: 224px;" cellpadding="1" cellspacing="1">
                        <tr>
                            <td colspan="3" style="border: thin none #FFFFFF; font-weight: bold; color: #FFFFFF;
                                font-size: large; height: 20px;" align="left" valign="top">
                            ...
                            <td style="height: 20px;" valign="top" align="right" colspan="3" class="style7">
                              
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 101px; height: 25px;" class="EncabezadoCell" colspan="2">
                        ...
                        <tr>
                            <td style="width: 101px; height: 40px;" class="EncabezadoCell">
                                <asp:Button ID="btnRefrescar" Text="VER INFORME" runat="server" Visible="True" CssClass="butCrear but"
                                    Height="27" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtQueContenga" runat="server" AutoPostBack="True" CssClass="CssTextBox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="EncabezadoCell" style="width: 15%; height: 18px;">
                    ...
                    <td class="EncabezadoCell" style="height: 18px" visible="false">
                        ...
                        <tr>
                            ...
                            <td class="EncabezadoCell" style="height: 18px">
                                <asp:CheckBox ID="chkCorredor" runat="server" Checked="true" />
                        ...
                        <tr>
                            ...
                            <td class="EncabezadoCell" style="width: 30%; height: 18px;">
                                <asp:CheckBox ID="chkDestinatario" runat="server" Checked="true" />
                ...
                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="Panel4"
                    ExpandControlID="btnMasPanel" CollapseControlID="btnMasPanel" CollapsedText="más..."
                    ExpandedText="ocultar" TextLabelID="btnMasPanel" Collapsed="True">
