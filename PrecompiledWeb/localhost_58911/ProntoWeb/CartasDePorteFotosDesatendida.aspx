<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CartasDePorteFotosDesatendida, App_Web_pt31r3lz" title="Importar Imágenes" theme="Azul" %>
    ...
    <table style="padding: 0px; border: none #FFFFFF; width: 700px; height: 62px; margin-right: 0px;"
        ...
        <tr>
            <td colspan="3" style="border: thin none #FFFFFF; font-weight: bold; color: #FFFFFF; font-size: medium; height: 37px;"
                ...
                <asp:Label ID="lblTitulo" ForeColor="" runat="server" Text="Imágenes de Carta Porte (upload desatendido)"
...
/////////////////////////////////////////////////////////////////////////////////////////--%>
    ...
    Mostrar informacion de los ultimos lotes procesados y los pendientes
    ...
    <asp:Panel runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanelAFU" runat="server" UpdateMode="Always"  Visible="false">
