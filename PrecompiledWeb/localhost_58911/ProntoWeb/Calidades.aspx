<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Calidades, App_Web_tpltxehw" title="Calidades" theme="Azul" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:TextBox ID="txtBuscar" runat="server" Style="text-align: right; margin-left: 26px;
...
--%>
                    ...
                    <asp:TemplateField HeaderText="Calidad">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtCalidad" runat="server" Text='<%# Bind("Descripcion") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewCalidad" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblCalidad" runat="server" Text='<%# Bind("Descripcion") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%-- --%>
                    <%-- --%>
