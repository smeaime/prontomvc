<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CartaDePorteInformesFertilizantes, App_Web_x0qhyvv1" title="Informes fertilizantes" validaterequest="false" enableeventvalidation="false" theme="Azul" %>
                ...
                <tr>
                    ...
                    <td style="width: 300px; height: 24px;" align="right">
                        ...
                        <asp:DropDownList ID="cmbInforme" runat="server" Width="500px" AutoPostBack="true"
                            ...
                            <asp:ListItem>Cupos por producto</asp:ListItem>
                    ...
                    <asp:Panel ID="Panel4" runat="server">
                        ...
                        <asp:ListItem Text="Semana pasada" />--%>
                            ...
                            <tr>
                                ...
                                <td class="EncabezadoCell" style="height: 18px; visibility:hidden">
