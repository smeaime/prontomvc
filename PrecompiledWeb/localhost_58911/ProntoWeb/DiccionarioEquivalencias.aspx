<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="DiccionarioEquivalencias, App_Web_wojhspd3" title="DiccionarioEquivalencias" theme="Azul" %>
    ...
    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="false" Font-Underline="True"
        ForeColor="White" CausesValidation="true" Font-Size="Small" Height="30px" Visible="False">Exportar a Excel</asp:LinkButton>
            <asp:TextBox ID="txtBuscar" runat="server" Style="text-align: right;" Text="" AutoPostBack="True"></asp:TextBox>
                ...
                <asp:ListItem Text="Palabra" Value="Palabra" />
                <asp:ListItem Text="Traduccion" Value="Traduccion" Selected="True" />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                ...
                DataKeyNames="IdDiccionarioEquivalencia"
...
--%>
                    ...
                    <asp:TemplateField HeaderText="Palabra">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtPalabra" runat="server" Text='<%# Bind("[Palabra]") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewPalabra" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblPalabra" runat="server" Text='<%# Bind("[Palabra]") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Traduccion">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTraduccion" runat="server" Text='<%# Bind("[Traduccion]") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewTraduccion" runat="server">
                            </asp:TextBox>
                            
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblTraduccion" runat="server" Text='<%# Bind("[Traduccion]") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
