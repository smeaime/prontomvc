<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="NotaDeCreditoABM, App_Web_dpg2bfma" title="Untitled Page" theme="Azul" %>
                ...
                <td class= "EncabezadoCell" style=" visibility: hidden;" colspan="4">
                    ...
                    <tr>
                        ...
                        <td class="EncabezadoCell" style="width: 200px;">
                            ...
                            <asp:TextBox ID="txtNumeroNotaDeCredito2" runat="server" Width="70px" Style="text-align: right;"
                                AutoPostBack="True" Enabled="False"></asp:TextBox>
                            <cc1:MaskedEditExtender ID="txtNumeroNotaDeCredito2_MaskedEditExtender" runat="server"
                                TargetControlID="txtNumeroNotaDeCredito2" Mask="99999999" MaskType="Number" InputDirection="RightToLeft"
                                AutoCompleteValue="0">
                            </cc1:MaskedEditExtender>
                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
                    ControlToValidate="txtNumeroNotaDeCredito1" 
                    ...
                    Font-Bold="True" ValidationGroup="Encabezado" style="display:none"></asp:RequiredFieldValidator>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtNumeroNotaDeCredito2"
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <table style="padding: 0px; border: none #FFFFFF; width: 698px; height: 62px; margin-right: 0px;"
                            ...
                            <tr>
                                <td class="EncabezadoCell" style="width: 100px; visibility: hidden;">
                                    Cond. de venta
                                </td>
                                <td class="EncabezadoCell" style="width: 220px; visibility: hidden;">
    ...
    <asp:UpdatePanel ID="UpdatePanelDetalle" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:LinkButton ID="LinkAgregarRenglon" runat="server" Font-Bold="False" ForeColor="White"
                ...
                <asp:Label ID="Label551" runat="server" ForeColor="White" Text="Agregar item" Font-Underline="True"> </asp:Label>
            </asp:LinkButton>
            <%--boton oculto (con css) obligatorio porque lo exige el modalpopup (que disparo por codebehind)--%>
                    ...
                    <td colspan="3" style="height: 22px">
                        ...
                        <asp:DropDownList ID="cmbCuentaGasto" runat="server" Width="400px" 
                            ...
                            <tr style="visibility: hidden; display: none">
                                ...
                                <td style="height: 16px;">
                                    <asp:DropDownList ID="cmbDetCuentaContable" runat="server" Width="400px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
...
--%>
    ...
    <br />
            ...
            CompleteBackColor="Lime" ErrorBackColor="Red"/> <%--puse AutoID por los problemas de Server Response Error. No se cuales son las consecuencias--%>
    ...
    <table style="padding: 0px; border: none #FFFFFF; width: 699px; margin-right: 0px;"
        ...
        <tr>
            <td colspan="2" style="border: thin none #FFFFFF; color: #FFFFFF;" align="left" valign="top"
                width="400">
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto; width: 702px;">
                            <asp:GridView ID="gvImputaciones" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Imputaciones FAC/REC" HeaderStyle-HorizontalAlign="left">
                                        <ItemStyle Wrap="True" Width="400" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label17" runat="server" Text='<%# Eval("ComprobanteImputadoNumeroConDescripcionCompleta")  %>'>
                                            </asp:Label>
                                    ...
                                    <%--                                    <asp:BoundField DataField="FechaComprobanteImputado" HeaderText="Fecha" ItemStyle-HorizontalAlign="Right"
                                        DataFormatString="{0:dd/M/yyyy}" Visible="true" />
                                    <asp:BoundField DataField="TotalComprobanteImputado" HeaderText="Total" ItemStyle-HorizontalAlign="Right"
                                        DataFormatString="{0:F2}" Visible="true" />--%>
                                </Columns>
                                <RowStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" />
                                <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                                <PagerStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Right" />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:LinkButton ID="LinkButtonImputacionSinAplicacion" runat="server" Font-Bold="False"
                                    ...
                                    <img src="../Imagenes/Agregar.png" alt="" style="vertical-align: middle; border: none;
                                        text-decoration: none;" height="16" />
                                    <asp:Label ID="Label221" runat="server" ForeColor="White" Text="Sin aplicación" Font-Underline="True"> </asp:Label>
                                </asp:LinkButton>
                                <br />
                                ...
                                <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtenderImputacion" runat="server"
                                    TargetControlID="button16" PopupControlID="Panel2" OkControlID="btnSaveItemImputacionAux"
                                    CancelControlID="Button2" DropShadow="False" BackgroundCssClass="modalBackground" />
                                <asp:Panel ID="Panel2" runat="server" Height="480px" Width="720px" CssClass="modalPopup">
                                    <%--Guarda! le puse display:none a través del codebehind para verlo en diseño!
                      style="display:none"  por si parpadea
            CssClass="modalPopup" para confirmar la opacidad 
cuando copias y pegas esto, tambien tenes que copiar y pegar el codebehind del click del boton que 
...
--%>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div style="width: 720px; height: 400px; overflow: auto" align="center">
                                                <asp:GridView ID="gvAuxPendientesImputar" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    DataSourceID="" GridLines="Horizontal" AllowPaging="True" Height="85%" CssClass="t1"
                                                    Width="702px">
                                    ...
                                    <asp:Button ID="Button2" runat="server" Font-Size="Small" Text="Cancelar" CssClass="but"
    ...
    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
        <ContentTemplate>
            <br />
            <br />
            <div style="width: 720px; overflow: auto" align="">
                <asp:Button ID="Button200" runat="server" Text="..." Font-Bold="False" Visible="False" />
                <asp:GridView ID="gvOCimputaciones" runat="server" AutoGenerateColumns="False" BackColor="White"
                    BorderColor="#507CBB" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="IdDetalleOrdenCompra,Cantidad"
                    DataSourceID="" GridLines="Horizontal" AllowPaging="True" Height="85%" CssClass="t1"
                    Width="702px" EmptyDataText="El cliente no tiene OC pendientes">
                    <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                    <Columns>
                        <asp:CommandField ShowSelectButton="false" />
                        <asp:BoundField DataField="IdOrdenCompra" InsertVisible="False" ReadOnly="True" SortExpression="Id"
                            Visible="False" />
                        <asp:TemplateField HeaderText="Imputaciones OC" HeaderStyle-HorizontalAlign="left">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Eval("Eliminado") %>' />
                                n°<asp:Label ID="NumeroOrdenCompra22" runat="server" Text='<%# Eval("NumeroOrdenCompra")   %>'></asp:Label>
                                n°cli<asp:Label ID="NumeroOrdenCompraCliente22" runat="server" Text='<%# " " + Eval("NumeroOrdenCompraCliente")   %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="IdOrdenCompra" HeaderText="Id" InsertVisible="False" ReadOnly="True"
                            SortExpression="Id" Visible="False" />
                        <%--                       <asp:BoundField DataField="NumeroOrdenCompra" HeaderText="n° OC" />
                        <asp:BoundField DataField="NumeroOrdenCompraCliente" HeaderText="n°OC en cliente" />
 --%>
                        <asp:BoundField DataField="ItemOC" HeaderText="Item" />
                        <asp:BoundField DataField="Articulo" HeaderText="Articulo" />
                        <asp:BoundField DataField="Importe" HeaderText="Importe" HeaderStyle-HorizontalAlign="Right"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:F2}" />
                        <asp:BoundField DataField="Precio" HeaderText="Precio" HeaderStyle-HorizontalAlign="Right"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:F2}" />
                        <asp:BoundField DataField="Pendiente" HeaderText="Pendiente" HeaderStyle-HorizontalAlign="Right"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:F2}" />
                        <asp:TemplateField HeaderText="a Acreditar" HeaderStyle-HorizontalAlign="left" ItemStyle-Width="50">
                            <ItemTemplate>
                                <asp:TextBox ID="txtAAcreditarItemOC" runat="server" Text='<%# Bind("aAcreditar") %>'
                                    Width="50" />
                            </ItemTemplate>
                        </asp:TemplateField>
