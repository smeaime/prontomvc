<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="CartasDePorteImportador, App_Web_fbqdhzi3" title="Importar Excel" theme="Azul" %>
        ...
        <table style="padding: 0px; border: none #FFFFFF; width: 700px; height: 62px; margin-right: 0px;"
            ...
            <tr>
                <td colspan="3" style="border: thin none #FFFFFF; font-weight: bold; color: #FFFFFF; font-size: medium; height: 37px;"
                    ...
                    <asp:Label ID="lblTitulo" ForeColor="" runat="server" Text="Importador de Excels (Pegatina)" class="titulos"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <asp:CheckBox ID="chkFiltrarErrores" runat="server" Text="Ver solo filas con errores"
                ...
                <div style="color: white;">
                    ...
                    <asp:CheckBox ID="chkAyer" runat="server" Text="usar la fecha de ayer?" />
                </div>
                <br />
                <br />
                ...
                COMO HACER PARA QUE EL TAMAÑO DE LAS CELDAS EN EDICION SEA EL MISMO QUE EN LECTURA--%>
                    ...
                    <asp:TemplateField HeaderText="Ir a" ShowHeader="False" ControlStyle-Width="30px"
                        ...
                        <ControlStyle Width="30px" />
                            ...
                            <asp:TemplateField HeaderText="Exporta">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Subnumero fact.">
                                <ItemTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:Panel ID="panelEquivalencias" runat="server" DefaultButton="Button8">
                    ...
                    <asp:Button ID="btnSaltarTodos" runat="server" Text="saltar todos" Visible="true" TabIndex="8" />
