<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Configuracion, App_Web_hpwltzg2" title="Configuración" theme="Azul" %>
            ...
            <ContentTemplate>
                ...
                <asp:Panel runat="server" ID="PanelSuperadmin" Visible="false">
                    ...
                    <div style="display: none">
                        ...
                        DESCARGAR BASE - RESTAURAR BASE Sincronizar base de desarrollo Ver trace de la aplicacion
                        http://[server]/[application]/trace.axd healthmonitoring enabled? debug enabled?
                        asp.net admin tool (solo con el Cassini) link al word de modificaciones store procs
                        mas usados permisos de escritura en directorios de error y generacion temporal de
                        .docx
                ...
                <table style="padding: 0px; border: none #FFFFFF; width: 95%; height: 100%; margin-right: 0px;"
                    ...
                    <tr>
                        <td class="EncabezadoCell" style="width: 90px; height: 23px;">
                            Notificaciones De 12:00 a 12:20 se actualizará el sistema. Por favor, disculpen
                            las molestias. BDL
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="EncabezadoCell" valign="bottom">
                            <asp:TextBox ID="montomaximo" runat="server" Width="" Height="" TabIndex="5"></asp:TextBox>
                        </td>
                        <td class="EncabezadoCell" style="width: 90px; height: 23px;">
                            Clientes controlados
                        </td>
                        <td>
                            <asp:TextBox ID="montomaximoclientes" TextMode="MultiLine" runat="server" Width="300px"
                                Height="70" TabIndex="5"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                ...
                <div style="display: none">
                    <asp:ListView ID="ListView1" runat="server" ShowFooter="True" AllowPaging="True"
                        ...
                        DataSourceID="LinqDataSource1" DataKeyNames="IdInformeWeb">
...
Scott
                --%>
                <asp:GridView ID="gvInformes" runat="server" ShowFooter="false" AllowPaging="True" Visible="false"
