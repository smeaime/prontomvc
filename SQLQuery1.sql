...
select @startRowIndex=NULL,@maximumRows=NULL,@estado=4,@QueContenga=NULL,@idVendedor=-1,@idCorredor=-1,@idDestinatario=-1,@idIntermediario=-1,@idRemComercial=-1,@idArticulo=-1,@idProcedencia=-1,@idDestino=-1,@AplicarANDuORalFiltro=0,
@ModoExportacion=N'Entregas',@fechadesde='2016-11-01 00:00:00',@fechahasta='2017-06-30 00:00:00',@puntoventa=-1,@IdAcopio=NULL,
@bTraerDuplicados='TRUE',@Contrato=NULL,@QueContenga2=NULL,@idClienteAuxiliarint=NULL,@AgrupadorDeTandaPeriodos=NULL,@Vagon=NULL,@Patente=NULL,@optCamionVagon=NULL,@p__linq__0='2016-11-01 00:00:00',@p__linq__1='2016-11-01 00:00:00',@p__linq__2='2016-11-01 00:00:00',@p__linq__3='2017-06-30 00:00:00',@p__linq__4='2016-11-01 00:00:00',@p__linq__5='2015-11-01 00:00:00',@p__linq__6='2016-11-01 00:00:00',@p__linq__7='2016-06-30 00:00:00',@p__linq__8='2016-11-01 00:00:00',@p__linq__9='2016-06-30 00:00:00'


select idcartadeporte,numerocartadeporte, clientefacturado, exporta from 
