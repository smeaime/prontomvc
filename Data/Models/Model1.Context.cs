...
namespace ProntoMVC.Data.Models
{
    ...
    public partial class DemoProntoEntities : DbContext
    {
        ...
        public virtual DbSet<DetalleSalidasMaterialesKit> DetalleSalidasMaterialesKits { get; set; }
        public virtual DbSet<DetalleSalidasMaterialesPresupuestosObra> DetalleSalidasMaterialesPresupuestosObras { get; set; }
        ...
        public virtual int PresupuestoObrasNodos_TX_Consumos(Nullable<int> idPresupuestoObrasNodo, Nullable<System.DateTime> fechaDesde, Nullable<System.DateTime> fechaHasta, string excluyente, Nullable<int> idObra)
        {
            var idPresupuestoObrasNodoParameter = idPresupuestoObrasNodo.HasValue ?
                new ObjectParameter("IdPresupuestoObrasNodo", idPresupuestoObrasNodo) :
                new ObjectParameter("IdPresupuestoObrasNodo", typeof(int));
            ...
            var excluyenteParameter = excluyente != null ?
                new ObjectParameter("Excluyente", excluyente) :
                new ObjectParameter("Excluyente", typeof(string));
    
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_Consumos", idPresupuestoObrasNodoParameter, fechaDesdeParameter, fechaHastaParameter, excluyenteParameter, idObraParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_ConsumosParaImputar(string activarRangoFechas, Nullable<System.DateTime> fechaDesde, Nullable<System.DateTime> fechaHasta, string incluirAsignados, string tipoMovimiento, Nullable<int> idObra)
        {
            var activarRangoFechasParameter = activarRangoFechas != null ?
                new ObjectParameter("ActivarRangoFechas", activarRangoFechas) :
                new ObjectParameter("ActivarRangoFechas", typeof(string));
            ...
            var incluirAsignadosParameter = incluirAsignados != null ?
                new ObjectParameter("IncluirAsignados", incluirAsignados) :
                new ObjectParameter("IncluirAsignados", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_ConsumosParaImputar", activarRangoFechasParameter, fechaDesdeParameter, fechaHastaParameter, incluirAsignadosParameter, tipoMovimientoParameter, idObraParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_DatosParaAsignacionPlantasProduccion(Nullable<int> idObra, Nullable<System.DateTime> fechaDesde, Nullable<System.DateTime> fechaHasta)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_DatosParaAsignacionPlantasProduccion", idObraParameter, fechaDesdeParameter, fechaHastaParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_DetallePxQ(Nullable<int> idPresupuestoObrasNodo, Nullable<int> codigoPresupuesto, Nullable<int> comparar1, Nullable<int> comparar2, Nullable<int> compararTomandoReal, Nullable<int> identificadorSesion)
        {
            var idPresupuestoObrasNodoParameter = idPresupuestoObrasNodo.HasValue ?
                new ObjectParameter("IdPresupuestoObrasNodo", idPresupuestoObrasNodo) :
                new ObjectParameter("IdPresupuestoObrasNodo", typeof(int));
    
            var codigoPresupuestoParameter = codigoPresupuesto.HasValue ?
                new ObjectParameter("CodigoPresupuesto", codigoPresupuesto) :
                new ObjectParameter("CodigoPresupuesto", typeof(int));
    
            var comparar1Parameter = comparar1.HasValue ?
                new ObjectParameter("Comparar1", comparar1) :
                new ObjectParameter("Comparar1", typeof(int));
    
            var comparar2Parameter = comparar2.HasValue ?
                new ObjectParameter("Comparar2", comparar2) :
                new ObjectParameter("Comparar2", typeof(int));
    
            var compararTomandoRealParameter = compararTomandoReal.HasValue ?
                new ObjectParameter("CompararTomandoReal", compararTomandoReal) :
                new ObjectParameter("CompararTomandoReal", typeof(int));
    
            var identificadorSesionParameter = identificadorSesion.HasValue ?
                new ObjectParameter("IdentificadorSesion", identificadorSesion) :
                new ObjectParameter("IdentificadorSesion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_DetallePxQ", idPresupuestoObrasNodoParameter, codigoPresupuestoParameter, comparar1Parameter, comparar2Parameter, compararTomandoRealParameter, identificadorSesionParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_EtapasImputablesPorObraParaCombo(Nullable<int> idObra, string presupuestoObraRubro, Nullable<int> codigoPresupuesto, string conHijos, string resumen)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            var presupuestoObraRubroParameter = presupuestoObraRubro != null ?
                new ObjectParameter("PresupuestoObraRubro", presupuestoObraRubro) :
                new ObjectParameter("PresupuestoObraRubro", typeof(string));
    
            var codigoPresupuestoParameter = codigoPresupuesto.HasValue ?
                new ObjectParameter("CodigoPresupuesto", codigoPresupuesto) :
                new ObjectParameter("CodigoPresupuesto", typeof(int));
    
            var conHijosParameter = conHijos != null ?
                new ObjectParameter("ConHijos", conHijos) :
                new ObjectParameter("ConHijos", typeof(string));
    
            var resumenParameter = resumen != null ?
                new ObjectParameter("Resumen", resumen) :
                new ObjectParameter("Resumen", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_EtapasImputablesPorObraParaCombo", idObraParameter, presupuestoObraRubroParameter, codigoPresupuestoParameter, conHijosParameter, resumenParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_Hijos_Result> PresupuestoObrasNodos_TX_Hijos(Nullable<int> idPresupuestoObrasNodo)
        {
            var idPresupuestoObrasNodoParameter = idPresupuestoObrasNodo.HasValue ?
                new ObjectParameter("IdPresupuestoObrasNodo", idPresupuestoObrasNodo) :
                new ObjectParameter("IdPresupuestoObrasNodo", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_Hijos_Result>("PresupuestoObrasNodos_TX_Hijos", idPresupuestoObrasNodoParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_ParaArbol(Nullable<int> idObra)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_ParaArbol", idObraParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_ParaInforme(Nullable<int> idObra, string tipoInforme, Nullable<int> desde, Nullable<System.DateTime> fechaDesde, Nullable<int> hasta, Nullable<System.DateTime> fechaHasta, string dts)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
            ...
            var dtsParameter = dts != null ?
                new ObjectParameter("Dts", dts) :
                new ObjectParameter("Dts", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_ParaInforme", idObraParameter, tipoInformeParameter, desdeParameter, fechaDesdeParameter, hastaParameter, fechaHastaParameter, dtsParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_ParaPopUp(Nullable<int> codigoPresupuesto, string soloPadres, Nullable<int> dia, Nullable<int> mes, Nullable<int> año, Nullable<int> idObra, Nullable<int> idPresupuestoObrasNodo)
        {
            var codigoPresupuestoParameter = codigoPresupuesto.HasValue ?
                new ObjectParameter("CodigoPresupuesto", codigoPresupuesto) :
                new ObjectParameter("CodigoPresupuesto", typeof(int));
    
            var soloPadresParameter = soloPadres != null ?
                new ObjectParameter("SoloPadres", soloPadres) :
                new ObjectParameter("SoloPadres", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_ParaPopUp", codigoPresupuestoParameter, soloPadresParameter, diaParameter, mesParameter, añoParameter, idObraParameter, idPresupuestoObrasNodoParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_ParaPresupuestoEstaticoYDinamico(Nullable<int> codigoPresupuesto, string datos, Nullable<int> idObra)
        {
            var codigoPresupuestoParameter = codigoPresupuesto.HasValue ?
                new ObjectParameter("CodigoPresupuesto", codigoPresupuesto) :
                new ObjectParameter("CodigoPresupuesto", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_ParaPresupuestoEstaticoYDinamico", codigoPresupuestoParameter, datosParameter, idObraParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_ParaTransmitir_Todos_Result> PresupuestoObrasNodos_TX_ParaTransmitir_Todos()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_ParaTransmitir_Todos_Result>("PresupuestoObrasNodos_TX_ParaTransmitir_Todos");
        }
    
        public virtual ObjectResult<Nullable<int>> PresupuestoObrasNodos_TX_PorCodigoPresupuesto(Nullable<int> idObra, Nullable<int> numeroPresupuesto)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            var numeroPresupuestoParameter = numeroPresupuesto.HasValue ?
                new ObjectParameter("NumeroPresupuesto", numeroPresupuesto) :
                new ObjectParameter("NumeroPresupuesto", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("PresupuestoObrasNodos_TX_PorCodigoPresupuesto", idObraParameter, numeroPresupuestoParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_PorItem_Result> PresupuestoObrasNodos_TX_PorItem(string item, Nullable<int> idObra)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_PorItem_Result>("PresupuestoObrasNodos_TX_PorItem", itemParameter, idObraParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_PorItemConHijos_Result> PresupuestoObrasNodos_TX_PorItemConHijos(string item, Nullable<int> idObra, string presupuestoObraRubro, string sinNodoPadre, Nullable<int> idEntidad)
        {
            var itemParameter = item != null ?
                new ObjectParameter("Item", item) :
                new ObjectParameter("Item", typeof(string));
            ...
            var sinNodoPadreParameter = sinNodoPadre != null ?
                new ObjectParameter("SinNodoPadre", sinNodoPadre) :
                new ObjectParameter("SinNodoPadre", typeof(string));
    
            var idEntidadParameter = idEntidad.HasValue ?
                new ObjectParameter("IdEntidad", idEntidad) :
                new ObjectParameter("IdEntidad", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_PorItemConHijos_Result>("PresupuestoObrasNodos_TX_PorItemConHijos", itemParameter, idObraParameter, presupuestoObraRubroParameter, sinNodoPadreParameter, idEntidadParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_PorNodo_Result> PresupuestoObrasNodos_TX_PorNodo(Nullable<int> idNodo, Nullable<int> codigoPresupuesto, Nullable<int> idObra)
        {
            var idNodoParameter = idNodo.HasValue ?
                new ObjectParameter("IdNodo", idNodo) :
                new ObjectParameter("IdNodo", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_PorNodo_Result>("PresupuestoObrasNodos_TX_PorNodo", idNodoParameter, codigoPresupuestoParameter, idObraParameter);
        }
    
        public virtual ObjectResult<PresupuestoObrasNodos_TX_PorNodoPadre_Result> PresupuestoObrasNodos_TX_PorNodoPadre(Nullable<int> idObra, Nullable<int> idNodoPadre)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            var idNodoPadreParameter = idNodoPadre.HasValue ?
                new ObjectParameter("IdNodoPadre", idNodoPadre) :
                new ObjectParameter("IdNodoPadre", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PresupuestoObrasNodos_TX_PorNodoPadre_Result>("PresupuestoObrasNodos_TX_PorNodoPadre", idObraParameter, idNodoPadreParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> PresupuestoObrasNodos_TX_PorObraCodigoPresupuesto(Nullable<int> idObra)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("PresupuestoObrasNodos_TX_PorObraCodigoPresupuesto", idObraParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_PorObraComparativa(Nullable<int> idObra, Nullable<int> idPresupuestoObrasNodo, Nullable<int> desde, Nullable<System.DateTime> fechaDesde, Nullable<int> hasta, Nullable<System.DateTime> fechaHasta)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_PorObraComparativa", idObraParameter, idPresupuestoObrasNodoParameter, desdeParameter, fechaDesdeParameter, hastaParameter, fechaHastaParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_PorObraComparativa_Detalles(Nullable<int> idObra, Nullable<int> idPresupuestoObrasNodo, Nullable<int> codigoPresupuesto)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_PorObraComparativa_Detalles", idObraParameter, idPresupuestoObrasNodoParameter, codigoPresupuestoParameter);
        }
    
        public virtual int PresupuestoObrasNodos_TX_PorObraConsumos(Nullable<int> idPresupuestoObraRubro, string soloPendientes, string conConsumosAsignados, Nullable<int> tipoConsumo, Nullable<int> idObra, Nullable<int> idDetalleObraDestino)
        {
            var idPresupuestoObraRubroParameter = idPresupuestoObraRubro.HasValue ?
                new ObjectParameter("IdPresupuestoObraRubro", idPresupuestoObraRubro) :
                new ObjectParameter("IdPresupuestoObraRubro", typeof(int));
    
            var soloPendientesParameter = soloPendientes != null ?
                new ObjectParameter("SoloPendientes", soloPendientes) :
                new ObjectParameter("SoloPendientes", typeof(string));
    
            var conConsumosAsignadosParameter = conConsumosAsignados != null ?
                new ObjectParameter("ConConsumosAsignados", conConsumosAsignados) :
                new ObjectParameter("ConConsumosAsignados", typeof(string));
    
            var tipoConsumoParameter = tipoConsumo.HasValue ?
                new ObjectParameter("TipoConsumo", tipoConsumo) :
                new ObjectParameter("TipoConsumo", typeof(int));
    
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            var idDetalleObraDestinoParameter = idDetalleObraDestino.HasValue ?
                new ObjectParameter("IdDetalleObraDestino", idDetalleObraDestino) :
                new ObjectParameter("IdDetalleObraDestino", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PresupuestoObrasNodos_TX_PorObraConsumos", idPresupuestoObraRubroParameter, soloPendientesParameter, conConsumosAsignadosParameter, tipoConsumoParameter, idObraParameter, idDetalleObraDestinoParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> PresupuestoObrasNodos_TX_TotalAvancePorMes(Nullable<int> idPresupuestoObrasNodo, Nullable<int> codigoPresupuesto, Nullable<int> mes, Nullable<int> año)
        {
            var idPresupuestoObrasNodoParameter = idPresupuestoObrasNodo.HasValue ?
                new ObjectParameter("IdPresupuestoObrasNodo", idPresupuestoObrasNodo) :
                new ObjectParameter("IdPresupuestoObrasNodo", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("PresupuestoObrasNodos_TX_TotalAvancePorMes", idPresupuestoObrasNodoParameter, codigoPresupuestoParameter, mesParameter, añoParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> PresupuestoObrasNodos_TX_UltimoPresupuesto(Nullable<int> idObra)
        {
            var idObraParameter = idObra.HasValue ?
                new ObjectParameter("IdObra", idObra) :
                new ObjectParameter("IdObra", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("PresupuestoObrasNodos_TX_UltimoPresupuesto", idObraParameter);
        }
    }
}
