...
namespace ProntoMVC.Data.Models
{
    ...
    public partial class DemoProntoEntities : DbContext
    {
        ...
        public virtual int AutorizacionesPorComprobante_CircuitoFirmasCompleto(Nullable<int> idFormulario, Nullable<int> idComprobante)
        {
            var idFormularioParameter = idFormulario.HasValue ?
                new ObjectParameter("IdFormulario", idFormulario) :
                new ObjectParameter("IdFormulario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AutorizacionesPorComprobante_CircuitoFirmasCompleto", idFormularioParameter, idComprobanteParameter);
        }
    }
}
