...
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('dbo.Stock') AND NAME ='IX_Stock_1')
    DROP INDEX IX_Stock_1 ON dbo.Stock;
GO

ALTER TABLE [dbo].[Stock]
         ALTER COLUMN [Partida] varchar (20)
GO
CREATE  NONCLUSTERED INDEX [IX_Stock_1] ON [dbo].[Stock]([IdArticulo] ASC, [Partida] ASC, [IdUbicacion] ASC, [IdObra] ASC, [IdUnidad] ASC, [NumeroCaja] ASC ) WITH FILLFACTOR = 90 ON [PRIMARY] 
GO
...
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('dbo.ProntoIniClaves') AND NAME ='IX_ProntoIniClaves')
    DROP INDEX IX_ProntoIniClaves ON dbo.ProntoIniClaves;
GO
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('dbo.ProntoIniClaves') AND NAME ='Indice1')
    DROP INDEX IX_ProntoIniClaves ON dbo.ProntoIniClaves;
GO


ALTER TABLE [dbo].[ProntoIniClaves]
       ALTER COLUMN [Clave] varchar (900)
GO       
CREATE  NONCLUSTERED INDEX [IX_ProntoIniClaves] ON [dbo].[ProntoIniClaves]([Clave] ASC ) WITH FILLFACTOR = 90 ON [PRIMARY] 
GO 

ALTER TABLE [dbo].[ProntoIniClaves]
       ALTER COLUMN [ValorPorDefecto] varchar (900)
...
ALTER TABLE [dbo].[Obras]
       ALTER COLUMN [Descripcion] varchar (100) COLLATE Modern_Spanish_CI_AS
...
GO
----------------<28-10-11>--------------------------
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('dbo.Clientes') AND NAME ='IX_Clientes_1')
    DROP INDEX IX_Clientes_1 ON dbo.Clientes;
GO
IF EXISTS(SELECT * FROM sys.indexes WHERE object_id = object_id('dbo.Clientes') AND NAME ='IX_Clientes_2')
    DROP INDEX IX_Clientes_2 ON dbo.Clientes;
GO

GO
ALTER TABLE [dbo].[Clientes] 
Alter Column [RazonSocial] [Varchar] (100) COLLATE Modern_Spanish_CI_AS NULL
GO
ALTER TABLE [dbo].[Clientes] 
Alter Column [Direccion] [Varchar] (100) COLLATE Modern_Spanish_CI_AS NULL
GO
CREATE  NONCLUSTERED INDEX [IX_Clientes_1] ON [dbo].[Clientes]([RazonSocial] ASC ) WITH FILLFACTOR = 90 ON [PRIMARY] 
GO
CREATE  UNIQUE  NONCLUSTERED INDEX [IX_Clientes_2] ON [dbo].[Clientes]([IdCliente] ASC, [RazonSocial] ASC, [Cuit] ASC, [Telefono] ASC, [Email] ASC, [FechaAlta] ASC ) WITH FILLFACTOR = 90 ON [PRIMARY] 
GO 
...
declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadGranosQuemados', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadGranosQuemados   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadGranosQuemados'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadGranosQuemadosBonifica_o_Rebaja', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadGranosQuemadosBonifica_o_Rebaja   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadGranosQuemadosBonifica_o_Rebaja'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadTierra', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadTierra   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadTierra'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadTierraBonifica_o_Rebaja', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadTierraBonifica_o_Rebaja   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadTierraBonifica_o_Rebaja'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadMermaChamico', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadMermaChamico   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadMermaChamico'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadMermaChamicoBonifica_o_Rebaja', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadMermaChamicoBonifica_o_Rebaja   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadMermaChamicoBonifica_o_Rebaja'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadMermaZarandeo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadMermaZarandeo   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadMermaZarandeo'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadMermaZarandeoBonifica_o_Rebaja', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadMermaZarandeoBonifica_o_Rebaja   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadMermaZarandeoBonifica_o_Rebaja'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','FueraDeEstandar', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    FueraDeEstandar   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'FueraDeEstandar'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadPuntaSombreada', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadPuntaSombreada   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadPuntaSombreada'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CobraAcarreo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CobraAcarreo   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CobraAcarreo'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','LiquidaViaje', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    LiquidaViaje   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'LiquidaViaje'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','IdClienteAuxiliar', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    IdClienteAuxiliar   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'IdClienteAuxiliar'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','CalidadDescuentofinal', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    CalidadDescuentofinal   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'CalidadDescuentofinal'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','PathImagen', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    PathImagen   [Varchar] (150)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'PathImagen'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','PathImagen2', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    PathImagen2   [Varchar] (150)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'PathImagen2'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','AgrupadorDeTandaPeriodos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    AgrupadorDeTandaPeriodos   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'AgrupadorDeTandaPeriodos'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','ClaveEncriptada', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    ClaveEncriptada   [Varchar] (150)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'ClaveEncriptada'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','NumeroCartaEnTextoParaBusqueda', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    NumeroCartaEnTextoParaBusqueda   [Varchar] (20)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'NumeroCartaEnTextoParaBusqueda'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','IdClienteEntregador', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    IdClienteEntregador   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'IdClienteEntregador'
end
GO
...
declare @esta1 int
exec _AlterTable 'CartasDePorte','SojaSustentableCodCondicion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    SojaSustentableCodCondicion   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'SojaSustentableCodCondicion'
end
GO


declare @esta1 int
exec _AlterTable 'CartasDePorte','SojaSustentableCondicion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    SojaSustentableCondicion   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'SojaSustentableCondicion'
end
GO

declare @esta1 int
exec _AlterTable 'CartasDePorte','SojaSustentableNroEstablecimientoDeProduccion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    SojaSustentableNroEstablecimientoDeProduccion   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/10/12', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'SojaSustentableNroEstablecimientoDeProduccion'
end
GO
...
--------------------<< 15-08-2014 >>----------------------
declare @esta1 int
exec _AlterTable 'CartasDePorte','IdClientePagadorFlete', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    IdClientePagadorFlete   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 30/07/14', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'IdClientePagadorFlete'
end
Go					
...
declare @esta1 int
exec _AlterTable 'CartasDePorte','SubnumeroVagonEnTextoParaBusqueda', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].CartasDePorte ADD
    SubnumeroVagonEnTextoParaBusqueda   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 30/07/14', N'user', N'dbo', N'table', N'CartasDePorte', N'column', N'SubnumeroVagonEnTextoParaBusqueda'
end
Go				
...
declare @esta1 int
exec _AlterTable 'Facturas','FueEnviadoCorreoConFacturaElectronica', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Facturas ADD
    FueEnviadoCorreoConFacturaElectronica   [varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'Facturas', N'column', N'FueEnviadoCorreoConFacturaElectronica'
end
Go	
...
declare @esta1 int
exec _AlterTable 'Localidades','IdPartido', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Localidades ADD
    IdPartido   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'Localidades', N'column', N'IdPartido'
end
Go	

--OJO CON ESTE TEMA QUE LO QUE SE ESTA HACIENDO ES AGREGAR UN CAMPO IDENTITI EN LA TABLA DE LOG POR ESO SE DESTRUYE Y SE VUELVE A GENERAR

If NOT exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[_TempLogComprobantesElectronicos]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
Begin
 
CREATE TABLE [dbo].[_TempLogComprobantesElectronicos](
  ...
  [Enviado] [ntext] NULL,
  [Recibido] [ntext] NULL,
 CONSTRAINT [PK__TempLogComprobantesElectronicos] PRIMARY KEY CLUSTERED 
(
  [IdLog] ASC
...
Insert Into _TempLogComprobantesElectronicos (Tipo,Letra,PuntoVenta,NumeroComprobante,Identificador,FechaRegistro,Enviado,Recibido)
Select Tipo,Letra,PuntoVenta,NumeroComprobante,Identificador,FechaRegistro,Enviado,Recibido from LogComprobantesElectronicos

Drop Table  LogComprobantesElectronicos
...
CREATE TABLE [dbo].[LogComprobantesElectronicos](
  ...
  [Enviado] [ntext] NULL,
  [Recibido] [ntext] NULL,
 CONSTRAINT [PK_LogComprobantesElectronicos] PRIMARY KEY CLUSTERED 
(
  [IdLog] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
Insert Into LogComprobantesElectronicos (Tipo,Letra,PuntoVenta,NumeroComprobante,Identificador,FechaRegistro,Enviado,Recibido)
Select Tipo,Letra,PuntoVenta,NumeroComprobante,Identificador,FechaRegistro,Enviado,Recibido from _TempLogComprobantesElectronicos
...
declare @esta1 int
exec _AlterTable 'PlazosFijos','NoExigirRubroContable', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].PlazosFijos ADD
    NoExigirRubroContable   [varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'PlazosFijos', N'column', N'NoExigirRubroContable'
end
Go	
...
-- Alter Column
ALTER TABLE [dbo].[DetalleFacturas]
         ALTER COLUMN [Cantidad] Numeric (18,3)
GO
ALTER TABLE [dbo].[DetalleOrdenesCompra]
         ALTER COLUMN [Cantidad] Numeric (18,3)
GO
ALTER TABLE [dbo].[DetalleRemitos]
         ALTER COLUMN [Cantidad] Numeric (18,3)
...
declare @esta1 int
exec _AlterTable 'OrdenesPago','ReversionContablePorAnulacion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    ReversionContablePorAnulacion   [varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'ReversionContablePorAnulacion'
end
Go	
-----------------------<<23-02-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','ImputarConsumoAObraActualEquipoMantenimiento', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    ImputarConsumoAObraActualEquipoMantenimiento   [varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'ImputarConsumoAObraActualEquipoMantenimiento'
end
Go	
-----------------------<<03-03-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DetalleOrdenesPago','ImporteRetencionSUSS', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleOrdenesPago ADD
    ImporteRetencionSUSS   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'DetalleOrdenesPago', N'column', N'ImporteRetencionSUSS'
end
Go	
-----------------------<<04-03-2015>>---------------------
declare @esta1 int
exec _AlterTable 'Conceptos','NoTomarEnRanking', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Conceptos ADD
    NoTomarEnRanking   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 28/11/2014', N'user', N'dbo', N'table', N'Conceptos', N'column', N'NoTomarEnRanking'
end
Go	
...
declare @esta1 int
exec _AlterTable 'Pedidos','IdPlazoEntrega', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Pedidos ADD
    IdPlazoEntrega   [int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Pedidos', N'column', N'IdPlazoEntrega'
end
Go	

-----------------------<<01-04-2015>>---------------------
declare @esta1 int
exec _AlterTable 'Provincias','IdCuentaRetencionIBrutos2', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Provincias ADD
    IdCuentaRetencionIBrutos2   [int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Provincias', N'column', N'IdCuentaRetencionIBrutos2'
end
Go	

declare @esta1 int
exec _AlterTable 'Provincias','ProximoNumeroCertificadoRetencionIIBB2', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Provincias ADD
    ProximoNumeroCertificadoRetencionIIBB2   [int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Provincias', N'column', N'ProximoNumeroCertificadoRetencionIIBB2'
end
Go	

-----------------------<<15-04-2015>>---------------------
declare @esta1 int
exec _AlterTable 'PresupuestoObrasNodosPxQxPresupuesto','PrecioVentaUnitario', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].PresupuestoObrasNodosPxQxPresupuesto ADD
    PrecioVentaUnitario   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'PresupuestoObrasNodosPxQxPresupuesto', N'column', N'PrecioVentaUnitario'
end
Go	

-----------------------<<20-04-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DetalleOrdenesPago','SaldoAFondoDeReparo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleOrdenesPago ADD
    SaldoAFondoDeReparo   [Numeric] (18,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleOrdenesPago', N'column', N'SaldoAFondoDeReparo'
end
Go	

-----------------------<<06-05-2015>>---------------------
declare @esta1 int
exec _AlterTable 'SalidasMateriales','Cliente', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].SalidasMateriales ADD
    Cliente   [Varchar] (100)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'SalidasMateriales', N'column', N'Cliente'
end
Go	

-----------------------<<29-05-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DetalleAutorizacionesFirmantes','IdObra', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleAutorizacionesFirmantes ADD
    IdObra   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleAutorizacionesFirmantes', N'column', N'IdObra'
end
Go	

-----------------------<<01-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'RubrosContables','TipoNegocioVentaGrupo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].RubrosContables ADD
    TipoNegocioVentaGrupo   [Varchar] (20)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'RubrosContables', N'column', N'TipoNegocioVentaGrupo'
end
Go

-----------------------<<02-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DistribucionesObras','Año', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DistribucionesObras ADD
    Año   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DistribucionesObras', N'column', N'Año'
end
Go	

declare @esta1 int
exec _AlterTable 'DistribucionesObras','Mes', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DistribucionesObras ADD
    Mes   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DistribucionesObras', N'column', N'Mes'
end
Go		

declare @esta1 int
exec _AlterTable 'DetalleDistribucionesObras','Grupo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleDistribucionesObras ADD
    Grupo   [Varchar] (20)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleDistribucionesObras', N'column', N'Grupo'
end
Go

-----------------------<<03-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'PresupuestoObrasNodos','BaseDatosOrigen', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].PresupuestoObrasNodos ADD
    BaseDatosOrigen   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'PresupuestoObrasNodos', N'column', N'BaseDatosOrigen'
end
Go

declare @esta1 int
exec _AlterTable 'Localidades','CodigoAfip', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Localidades ADD
    CodigoAfip   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Localidades', N'column', N'CodigoAfip'
end
Go	
...
declare @esta1 int
exec _AlterTable 'PresupuestoObrasNodosConsumos','BaseDatosOrigen', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].PresupuestoObrasNodosConsumos ADD
    BaseDatosOrigen   [Varchar] (50)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'PresupuestoObrasNodosConsumos', N'column', N'BaseDatosOrigen'
end
Go


declare @esta1 int
exec _AlterTable 'OrdenesPago','ArchivoAdjunto1', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    ArchivoAdjunto1   [Varchar] (100)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'ArchivoAdjunto1'
end
Go	

declare @esta1 int
exec _AlterTable 'OrdenesPago','ArchivoAdjunto2', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    ArchivoAdjunto2   [Varchar] (100)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'ArchivoAdjunto2'
end
Go	

declare @esta1 int
exec _AlterTable 'OrdenesPago','FechaReversionContablePorAnulacion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    FechaReversionContablePorAnulacion   [DateTime]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'FechaReversionContablePorAnulacion'
end
Go	


declare @esta1 int
exec _AlterTable 'OrdenesCompra','FechaEntrega', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesCompra ADD
    FechaEntrega   [DateTime]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesCompra', N'column', N'FechaEntrega'
end
Go	

 ALTER TABLE [dbo].[Articulos]
    Alter Column [ModeloEspecifico] [Varchar] (60) NULL
...
-----------------------<<19-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'Cuentas','Activa', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Cuentas ADD
    Activa   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Cuentas', N'column', N'Activa'
end
Go	

declare @esta1 int
exec _AlterTable 'Subcontratos','Contractual', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Subcontratos ADD
    Contractual   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Subcontratos', N'column', N'Contractual'
end
Go	
...
-----------------------<<23-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'Facturas','IdClienteObservaciones', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Facturas ADD
    IdClienteObservaciones   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Facturas', N'column', N'IdClienteObservaciones'
end
Go	

-----------------------<<24-06-2015>>---------------------
declare @esta1 int
exec _AlterTable 'NotasDebito','IdClienteObservaciones', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].NotasDebito ADD
    IdClienteObservaciones   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'NotasDebito', N'column', N'IdClienteObservaciones'
end
Go	

declare @esta1 int
exec _AlterTable 'NotasCredito','IdClienteObservaciones', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].NotasCredito ADD
    IdClienteObservaciones   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'NotasCredito', N'column', N'IdClienteObservaciones'
end
Go	

-----------------------<<14-07-2015>>---------------------
declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','OrdenTrabajoMalaAplicacion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    OrdenTrabajoMalaAplicacion   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'OrdenTrabajoMalaAplicacion'
end
Go	

declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','ImputarConsumoAObraSalida', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    ImputarConsumoAObraSalida   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'ImputarConsumoAObraSalida'
end
Go	

-----------------------<<27-07-2015>>---------------------
declare @esta1 int
exec _AlterTable 'Subcontratos','IdPresupuestoObrasNodo', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Subcontratos ADD
    IdPresupuestoObrasNodo   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Subcontratos', N'column', N'IdPresupuestoObrasNodo'
end
Go	
declare @esta1 int
exec _AlterTable 'Subcontratos','IdCuenta', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Subcontratos ADD
    IdCuenta   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Subcontratos', N'column', N'IdCuenta'
end
Go	

declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','NumeroSubcontrato', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    NumeroSubcontrato   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'NumeroSubcontrato'
end
Go	

declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','IdSubcontrato', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    IdSubcontrato   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'IdSubcontrato'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleSalidasMateriales','IdDetalleSubcontratoDatos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleSalidasMateriales ADD
    IdDetalleSubcontratoDatos   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleSalidasMateriales', N'column', N'IdDetalleSubcontratoDatos'
end
Go	
--------------------<< 12/08/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'DetalleFacturas','PorcentajeIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleFacturas ADD
    PorcentajeIva   [Numeric] (6,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleFacturas', N'column', N'PorcentajeIva'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleFacturas','ImporteIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleFacturas ADD
    ImporteIva   [Numeric] (18,4)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleFacturas', N'column', N'ImporteIva'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleNotasCredito','PorcentajeIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleNotasCredito ADD
    PorcentajeIva   [Numeric] (6,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleNotasCredito', N'column', N'PorcentajeIva'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleNotasCredito','ImporteIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleNotasCredito ADD
    ImporteIva   [Numeric] (18,4)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleNotasCredito', N'column', N'ImporteIva'
end
Go	

declare @esta1 int
exec _AlterTable 'DetalleNotasDebito','PorcentajeIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleNotasDebito ADD
    PorcentajeIva   [Numeric] (6,2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleNotasDebito', N'column', N'PorcentajeIva'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleNotasDebito','ImporteIva', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleNotasDebito ADD
    ImporteIva   [Numeric] (18,4)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleNotasDebito', N'column', N'ImporteIva'
end
Go	

--------------------<< 21/08/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Viajes','IdDetalleLiquidacionFlete', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Viajes ADD
    IdDetalleLiquidacionFlete   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Viajes', N'column', N'IdDetalleLiquidacionFlete'
end
Go	
declare @esta1 int
exec _AlterTable 'Viajes','IdUsuarioDioPorCumplidoLiquidacionFletes', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Viajes ADD
    IdUsuarioDioPorCumplidoLiquidacionFletes   [Int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Viajes', N'column', N'IdUsuarioDioPorCumplidoLiquidacionFletes'
end
Go	

declare @esta1 int
exec _AlterTable 'Viajes','FechaDioPorCumplidoLiquidacionFletes', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Viajes ADD
    FechaDioPorCumplidoLiquidacionFletes   [DateTime]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Viajes', N'column', N'FechaDioPorCumplidoLiquidacionFletes'
end
Go	

declare @esta1 int
exec _AlterTable 'Viajes','ObservacionDioPorCumplidoLiquidacionFletes', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Viajes ADD
    ObservacionDioPorCumplidoLiquidacionFletes   [ntext]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Viajes', N'column', N'ObservacionDioPorCumplidoLiquidacionFletes'
end
Go	
...
--------------------<< 18/09/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'TarjetasCredito','IdBanco', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].TarjetasCredito ADD
    IdBanco   [int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'TarjetasCredito', N'column', N'IdBanco'
end
Go	

--------------------<< 07/10/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'OrdenesPago','IdTipoRetencionGanancia', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    IdTipoRetencionGanancia   [int]  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'IdTipoRetencionGanancia'
end
Go	
declare @esta1 int
exec _AlterTable 'OrdenesPago','CuitOpcional', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    CuitOpcional   [Varchar] (10) NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'CuitOpcional'
end
Go	
--------------------<< 18/10/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Comparativas','Cumplida', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Comparativas ADD
    Cumplida   [Varchar] (2)  NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Comparativas', N'column', N'Cumplida'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleControlesCalidad','DescripcionDelProblema', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleControlesCalidad ADD
    DescripcionDelProblema   [Ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleControlesCalidad', N'column', N'DescripcionDelProblema'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleControlesCalidad','CausaDelProblema', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleControlesCalidad ADD
    CausaDelProblema   [Ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleControlesCalidad', N'column', N'CausaDelProblema'
end
Go	
declare @esta1 int
exec _AlterTable 'DetalleControlesCalidad','Disposicion', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleControlesCalidad ADD
    Disposicion   [Ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleControlesCalidad', N'column', N'Disposicion'
end
Go	
declare @esta1 int
exec _AlterTable 'Empresa','ConstitucionSocietaria', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Empresa ADD
    ConstitucionSocietaria   [Varchar] (500)   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Empresa', N'column', N'ConstitucionSocietaria'
end
Go	
declare @esta1 int
exec _AlterTable 'ComprobantesProveedores','NoTomarParaCalculoDeImpuestos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].ComprobantesProveedores ADD
    NoTomarParaCalculoDeImpuestos   [Varchar] (2)   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'ComprobantesProveedores', N'column', N'NoTomarParaCalculoDeImpuestos'
end
Go	
...
--------------------<< 06/11/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'OrdenesPago','IdPuntoVenta', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    IdPuntoVenta   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'IdPuntoVenta'
end
Go	
declare @esta1 int
exec _AlterTable 'OrdenesPago','PuntoVenta', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].OrdenesPago ADD
    PuntoVenta   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'OrdenesPago', N'column', N'PuntoVenta'
end
Go	
--------------------<< 10/11/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'ComprobantesProveedores','IdPuntoVenta', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].ComprobantesProveedores ADD
    IdPuntoVenta   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'ComprobantesProveedores', N'column', N'IdPuntoVenta'
end
Go

declare @esta1 int
exec _AlterTable 'ComprobantesProveedores','PuntoVenta', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].ComprobantesProveedores ADD
    PuntoVenta   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'ComprobantesProveedores', N'column', N'PuntoVenta'
end
Go	

--------------------<< 17/11/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Pedidos','Inspecciones', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Pedidos ADD
    Inspecciones   [Ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Pedidos', N'column', N'Inspecciones'
end
Go

--------------------<< 30/11/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Empleados','PuntosVentaAsociados', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Empleados ADD
    PuntosVentaAsociados   [Ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Empleados', N'column', N'PuntosVentaAsociados'
end
Go
--------------------<< 16/12/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'DetalleAsientos','IdEntidadOrigen', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].DetalleAsientos ADD
    IdEntidadOrigen   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'DetalleAsientos', N'column', N'IdEntidadOrigen'
end
Go

--------------------<< 21/12/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Cuentas','CodigoRubroContable', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Cuentas ADD
    CodigoRubroContable   [Int]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 03/10/2014', N'user', N'dbo', N'table', N'Cuentas', N'column', N'CodigoRubroContable'
end
Go

--------------------<< 23/12/2015 >>----------------------
declare @esta1 int
exec _AlterTable 'Parametros','PedidosSubcontratos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Parametros ADD
    PedidosSubcontratos   [ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/12/2015', N'user', N'dbo', N'table', N'Parametros', N'column', N'PedidosSubcontratos'
end
Go

declare @esta1 int
exec _AlterTable 'Pedidos','Subcontratos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Pedidos ADD
    Subcontratos   [ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/12/2015', N'user', N'dbo', N'table', N'Pedidos', N'column', N'Subcontratos'
end
Go

declare @esta1 int
exec _AlterTable 'Pedidos','ImprimeSubcontratos', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Pedidos ADD
    ImprimeSubcontratos   [Varchar] (2)   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/12/2015', N'user', N'dbo', N'table', N'Pedidos', N'column', N'ImprimeSubcontratos'
end
Go	

declare @esta1 int
exec _AlterTable 'Pedidos','NotasSeguimiento', @esta = @esta1 output
if @esta1 = 0
begin
--select @esta1 as Existe_Si_1_NO_0
  ALTER TABLE [dbo].Pedidos ADD
    NotasSeguimiento   [ntext]   NULL
   exec sp_addextendedproperty N'MS_Description', N'Campo Agregado el dia 23/12/2015', N'user', N'dbo', N'table', N'Pedidos', N'column', N'NotasSeguimiento'
end
Go
