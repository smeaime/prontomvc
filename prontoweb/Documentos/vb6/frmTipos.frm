...
Option Explicit
Dim WithEvents origen As ComPronto.Tipo
Attribute origen.VB_VarHelpID = -1
Dim WithEvents oBind As BindingCollection
Attribute oBind.VB_VarHelpID = -1
Dim actL2 As ControlForm
Private mvarId As Long, mGrupo As Integer
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Tipos.Item(vnewvalue)
...
Public Property Let Grupo(ByVal vnewvalue As Integer)

   mGrupo = vnewvalue

End Property

Public Property Get Clasificacion() As String

   Select Case Me.Grupo
      Case 0
         Clasificacion = "Tipos"
      Case 1
         Clasificacion = "TiposArticulos"
      Case Else
         Clasificacion = "Tipos"
   End Select
