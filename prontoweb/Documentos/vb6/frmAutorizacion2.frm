...
Private mvarAutorizo As String, mvarSector As String, mvarCargo As String
...
Private Sub Form_Load()
   ...
   Set oAp = Aplicacion
   If mvarSector <> "" Then
      Set oRsAutoriza = oAp.Empleados.TraerFiltrado("_PorSector", Array(mvarSector, mvarCargo))
   Else
...
Public Property Let Cargo(ByVal vnewvalue As String)
