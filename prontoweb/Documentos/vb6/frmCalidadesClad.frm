VERSION 5.00
Begin VB.Form frmCalidadesClad 
   Caption         =   "Calidades Clad"
   ClientHeight    =   1635
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5670
   Icon            =   "frmCalidadesClad.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   1635
   ScaleWidth      =   5670
   ...
   End
End
Attribute VB_Name = "frmCalidadesClad"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.CalidadClad
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.CalidadesClad.Item(vnewvalue)
