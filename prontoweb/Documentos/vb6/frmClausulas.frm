VERSION 5.00
Begin VB.Form frmClausulas 
   Caption         =   "Clausulas para pedidos"
   ClientHeight    =   2775
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8745
   ...
   End
End
Attribute VB_Name = "frmClausulas"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.Clausula
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Clausulas.Item(vnewvalue)
