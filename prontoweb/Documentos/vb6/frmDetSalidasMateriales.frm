...
Begin VB.Form frmDetSalidasMateriales 
   ...
   ClientTop       =   345
   ClientWidth     =   10830
   Icon            =   "frmDetSalidasMateriales.frx":0000
   LinkTopic       =   "Form1"
   OLEDropMode     =   1  'Manual
   ScaleHeight     =   7995
   ScaleWidth      =   10830
   StartUpPosition =   2  'CenterScreen
   Begin VB.CommandButton cmdPresupuestoObra 
   ...
   Begin RichTextLib.RichTextBox rchObservaciones 
      ...
      Enabled         =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"frmDetSalidasMateriales.frx":076A
   End
   Begin FileBrowser1.FileBrowser FileBrowser1 
      Height          =   330
      Index           =   1
   ...
   Begin MSComctlLib.ImageList img_cPMenu 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":07EC
            Key             =   "Tareas"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":10C6
            Key             =   "Obras"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":19A0
            Key             =   "Etapas"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":227A
            Key             =   "Sectores"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":2B54
            Key             =   "TareasNP"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":342E
            Key             =   "TareasP"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":3D08
            Key             =   "TareasM"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":45E2
            Key             =   "Celdas"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetSalidasMateriales.frx":4EBC
            Key             =   "DesdoblarItem"
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox picBackground 
      ...
      Height          =   1500
      Left            =   8280
      Picture         =   "frmDetSalidasMateriales.frx":51D6
      ScaleHeight     =   1500
      ScaleWidth      =   3750
      TabIndex        =   90
      Top             =   2835
...
Private mvarRegistroContableComprasAlActivo As String, mvarADistribuirEnPresupuestoDeObra As String, mConCerradas As String
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      Case 0
         ...
         If mvarParaMantenimiento = "SI" And DataCombo1(4).Visible And Not IsNumeric(DataCombo1(4).BoundText) Then
            MsgBox "Debe indicar el equipo destino", vbInformation
            Exit Sub
         End If
         ...
         If dcfields(7).Visible And Len(dcfields(7).Text) > 0 And IsNull(origen.Registro.Fields("IdOrdenTrabajo").Value) Then
            MsgBox "Orden de trabajo incorrecta", vbCritical
            Exit Sub
         End If
         ...
         Dim mvarIdStock As Long, mvarIdObra1 As Long
         Dim i As Integer
         Dim mvarUnidad As String, mvarAux1 As String, mvarAux2 As String, mvarAux3 As String, mvarTomarObraCabecera As String
         ...
         For Each dc In DataCombo1
            If (dc.Enabled And dc.Visible) Or dc.Index = 0 Then
               If Len(Trim(dc.BoundText)) = 0 And dc.Index <> 4 And Not (dc.Index = 7 And mDescargaPorKitHabilitada) Then
...
'         origen.Registro.Fields("IdUnidad").Value = mvarIdUnidad
         ...
         If IsNull(origen.Registro.Fields("IdObra").Value) Or origen.Registro.Fields("IdObra").Value = 0 Then
         ...
         With origen.Registro
            If mvarTomarObraCabecera = "SI" And Not IsNull(oSalidaMateriales.Registro.Fields("IdObra").Value) Then
               mvarIdObra1 = oSalidaMateriales.Registro.Fields("IdObra").Value
            Else
               mvarIdObra1 = .Fields("IdObra").Value
            End If
            ...
            Set oRs = Aplicacion.Articulos.TraerFiltrado("_StockPorArticuloPartidaUnidadUbicacionObra", _
                     Array(.Fields("IdArticulo").Value, IIf(IsNull(.Fields("Partida").Value), "", .Fields("Partida").Value), _
                           .Fields("IdUnidad").Value, IIf(IsNull(.Fields("IdUbicacion").Value), 0, .Fields("IdUbicacion").Value), mvarIdObra1))
...
'            .Fields("IdUnidad").Value = mvarIdUnidad
         ...
         If BuscarClaveINI("Requerir detalle de kits en salida de materiales") = "SI" And Frame1.Visible And Option2.Value Then
            Set oF = New frmDetSalidasMaterialesKit
            With oF
               Set .SalidaMateriales = oSalidaMateriales
               .IdDetalleSalidaMateriales = origen.Id
               .IdArticulo = DataCombo1(1).BoundText
               .Cantidad = txtCantidad.Text
               .IdUnidad = DataCombo1(0).BoundText
               .Show vbModal, Me
            End With
            Unload oF
            Set oF = Nothing
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   mConCerradas = ""
   If mTipoSalida = 3 Or mTipoSalida = 4 Then mConCerradas = "SI"
   ...
   If BuscarClaveINI("Exigir etapa de obra en circuito de compras para salida de materiales") = "SI" Then
      lblLabels(22).Visible = True
      If mvarPresupuestadorObraNuevo Then
         CargaPopUpMenu2
         cPMenu.Restore "OBRAS"
         cmdPresupuestoObra.Visible = True
         With DataCombo1(7)
   ...
   If BuscarClaveINI("Habilitar obra en detalle de salida de materiales") = "SI" Then DataCombo1(3).Enabled = True
   
   If BuscarClaveINI("Mostrar boton asignacion de partidas en salida de materiales") = "SI" Then cmd(3).Visible = True
            ...
            If Len(oControl.Tag) Then
               ...
               ElseIf oControl.Tag = "OrdenesTrabajo" Then
                  If Not mOTsMantenimiento Then
                     Set oControl.RowSource = oAp.OrdenesTrabajo.TraerFiltrado("_ParaCombo", Array(Me.FechaSalida, mConCerradas))
                  End If
   ...
   If Not IsNull(origen.Registro.Fields("IdDetalleValeSalida").Value) Then cmd(2).Enabled = False
...
Private Sub cmdPresupuestoObra_Click()

   On Error Resume Next
   
   Dim oF As frm_Aux
   Dim oRs As ADOR.Recordset
   Dim mItem As String, s As String
   Dim mOk As Boolean
   Dim mIdPresu As Long, mIdEmpleado As Long
   Dim mVector, mVector1
   
   Set oF = New frm_Aux
   With oF
      .Caption = "Imputacion presupuesto"
      .Label1.Caption = "Codigo item :"
      .Show vbModal, Me
      mOk = .Ok
      mItem = .Text1.Text
   End With
   ...
   Set oRs = Aplicacion.PresupuestoObrasNodos.TraerFiltrado("_PorItemConHijos", Array(mItem, -1, "M"))
   If oRs.RecordCount = 0 Then
      mIdPresu = 0
      MsgBox "El item de presupuesto de obra no existe, reingrese", vbExclamation
   ElseIf oRs.RecordCount = 1 Then
      mIdPresu = oRs.Fields(0).Value
   Else
      Set oF = New frm_Aux
      With oF
         .Caption = "Imputacion presupuesto"
         ...
         If UBound(mVector) = 0 Then
            MsgBox "Debe elegir un item del presupuesto de obra", vbExclamation
            mIdPresu = 0
         ElseIf UBound(mVector) > 1 Then
            MsgBox "Debe elegir solo un item del presupuesto de obra", vbExclamation
            mIdPresu = 0
         Else
   ...
   If mIdPresu > 0 Then AsignarPopUp1 "Obr|" & mIdPresu
         ...
         If IsNumeric(DataCombo1(Index).BoundText) Then
            ...
            With origen.Registro
               If oRs.RecordCount > 0 And _
                     (IsNull(.Fields("IdArticulo").Value) Or .Fields("IdArticulo").Value <> DataCombo1(1).BoundText) Then
...
'                  DataCombo1(0).BoundText = mvarIdUnidadCU
                  ...
                  If mvarRegistroContableComprasAlActivo = "SI" And mvarADistribuirEnPresupuestoDeObra = "SI" And _
                     ...
                     With origen.Registro
                        If Not IsNull(oRs.Fields("IdCuentaCompras").Value) And Not IsNull(.Fields("IdObra").Value) Then
                           Set oRsAux = Aplicacion.Cuentas.TraerFiltrado("_PorObraCuentaMadre", Array(.Fields("IdObra").Value, 0, DataCombo1(1).BoundText))
                           If oRsAux.RecordCount > 0 Then
                              .Fields("IdCuenta").Value = oRsAux.Fields("IdCuenta").Value
                           End If
                           oRsAux.Close
            ...
            If mDescargaPorKit = "SI" Then
               ...
               If oRs.RecordCount > 0 Then
                  Frame1.Enabled = True
                  If mvarId < 0 Then Option2.Value = True
                  DataCombo1(7).Enabled = False
                  With origen.Registro
                     .Fields("IdPresupuestoObrasNodo").Value = Null
                     If Not IsNull(oRs.Fields("IdObra").Value) And mvarId < 0 Then .Fields("IdObra").Value = oRs.Fields("IdObra").Value
                  End With
                  cmdPresupuestoObra.Enabled = False
                  mDescargaPorKitHabilitada = True
               Else
                  Option1.Value = True
                  Frame1.Enabled = False
                  If BuscarClaveINI("Exigir etapa de obra en circuito de compras para salida de materiales") = "SI" And mvarPresupuestadorObraNuevo Then
                     DataCombo1(7).Enabled = True
                     cmdPresupuestoObra.Enabled = True
                  End If
               End If
               oRs.Close
            End If
      ...
      Case 3
         If IsNumeric(DataCombo1(Index).BoundText) Then
            ...
            End If
            MostrarStockActual
            If BuscarClaveINI("Limitar ubicaciones por obra") = "SI" Then
            'If glbIdObraAsignadaUsuario > 0 Then
               Set DataCombo1(2).RowSource = Aplicacion.Ubicaciones.TraerFiltrado("_PorObra", DataCombo1(Index).BoundText)
            End If
         End If
...
'            Set oRs = Aplicacion.Articulos.TraerFiltrado("_PorId", DataCombo1(Index).BoundText)
            ...
            If mOTsMantenimiento Then
               Set oRs = Aplicacion.TablasGenerales.TraerFiltrado("ProntoMantenimiento", "_OTsPorEquipo", DataCombo1(Index).BoundText)
               Set dcfields(7).RowSource = oRs
               If BuscarClaveINI("Inicializar orden de trabajo en salida de materiales") = "SI" Then
                  If oRs.RecordCount > 0 And IsNull(origen.Registro.Fields("IdOrdenTrabajo").Value) Then
                     oRs.MoveFirst
                     origen.Registro.Fields("IdOrdenTrabajo").Value = oRs.Fields("IdOrdenTrabajo").Value
                  End If
               End If
            End If
         Else
...
Private Sub DataCombo1_MouseDown(Index As Integer, Button As Integer, Shift As Integer, x As Single, y As Single)
   ...
   If Button = vbRightButton Then
      If Index = 7 Then
         Dim iIndex As Long
         iIndex = cPMenu.ShowPopupMenu(x, y)
         If (iIndex > 0) Then AsignarPopUp1 cPMenu.ItemKey(iIndex)
      End If
   End If
...
Private Sub dcfields_GotFocus(Index As Integer)
   ...
   If Index = 7 And Len(dcfields(Index).Text) = 0 Then SendKeys "%{DOWN}"
...
Private Sub dcfields_LostFocus(Index As Integer)
   ...
   If Index = 7 Then
      If Len(dcfields(Index).BoundText) > 0 And dcfields(Index).BoundText <> dcfields(Index).Text Then
         origen.Registro.Fields(dcfields(Index).DataField).Value = dcfields(Index).BoundText
      End If
   End If
...
Public Sub CargaPopUpMenu2()

   Dim oRs1 As ADOR.Recordset
   Dim i As Integer, j As Integer
   Dim Key1 As Long, Key2 As Long, Key3 As Long, Key4 As Long, Key5 As Long, Key6 As Long, Key21 As Long, Key22 As Long
   Dim Key23 As Long, nada As Long, Keyg As Long, Keyg1 As Long, Keyg2 As Long, Keyg3 As Long, Keyg4 As Long
   Dim nOBT As Long, mIdNodoPadre As Long, mIdObra As Long, mIdPresupuestoObrasNodo As Long
   Dim mObra As String, mDetalle As String, mClave As String
   Dim PrimeraVez As Boolean, mAuxB1 As Boolean

   On Error GoTo Mal
   
   Set cPMenu = New cPopupMenu
   With cPMenu
      .ImageList = img_cPMenu
      .hWndOwner = Me.hwnd
   ...
   Key1 = cPMenu.AddItem("Opciones", , , Key1, img_cPMenu.ListImages("Obras").Index - 1, , , "Obr|0")
   
   Set oRs1 = Aplicacion.PresupuestoObrasNodos.TraerFiltrado("_ParaPopUp")
   With oRs1
      If .RecordCount > 0 Then
         .MoveFirst
         Do While Not .EOF
            nOBT = nOBT + 1
            mIdPresupuestoObrasNodo = IIf(IsNull(.Fields("IdPresupuestoObrasNodo").Value), 0, .Fields("IdPresupuestoObrasNodo").Value)
            mDetalle = IIf(IsNull(.Fields("Descripcion").Value), "", .Fields("Descripcion").Value)
            mIdNodoPadre = IIf(IsNull(.Fields("IdNodoPadre").Value), 0, .Fields("IdNodoPadre").Value)
            mClave = "Obr|" & mIdNodoPadre
            Keyg = cPMenu.IndexForKey(mClave)
            mAuxB1 = True
            If .Fields("Materiales").Value <> "S" And .Fields("Hoja").Value = "S" Then mAuxB1 = False
            Keyg1 = cPMenu.AddItem(mDetalle, , , Keyg, img_cPMenu.ListImages("Obras").Index - 1, , mAuxB1, "Obr|" & mIdPresupuestoObrasNodo)
            .MoveNext
         Loop
      End If
      .Close
...
Public Sub AsignarPopUp1(ByVal ItemClave As String)

   On Error GoTo Mal

   Dim mIdPresupuestoObrasNodo As Long, mIdComprobante As Long, mIdComprobanteDetalle As Long
   Dim mTipo As String
   Dim oRs As ADOR.Recordset
   Dim oL As ListItem
   Dim mVector

   Select Case mId(ItemClave, 1, 4)
      Case "Obr|"
         mVector = VBA.Split(ItemClave, "|")
         mIdPresupuestoObrasNodo = mVector(1)
         Set oRs = Aplicacion.TablasGenerales.TraerUno("PresupuestoObrasNodos", mIdPresupuestoObrasNodo)
         If oRs.RecordCount > 0 Then origen.Registro.Fields("IdPresupuestoObrasNodo").Value = mIdPresupuestoObrasNodo
         oRs.Close
   End Select
