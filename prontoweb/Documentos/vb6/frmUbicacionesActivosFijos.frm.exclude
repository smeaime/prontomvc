VERSION 5.00
Begin VB.Form frmUbicacionesActivosFijos 
   Caption         =   "Ubicaciones de activos fijos"
   ClientHeight    =   1440
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5625
   ...
   End
End
Attribute VB_Name = "frmUbicacionesActivosFijos"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.UbicacionActivoFijo
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         With actL2
            .ListaEditada = "UbicacionesActivosFijos"
            .AccionRegistro = est
            .Disparador = mvarId
         End With
...
Public Property Let Id(ByVal vNewValue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.UbicacionesActivosFijos.Item(vNewValue)
