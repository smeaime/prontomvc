...
Begin VB.Form frmDetRecibosCuentas 
   Caption         =   "Item de registro contable [ Recibos de pago ]"
   ClientHeight    =   3615
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8745
   Icon            =   "frmDetRecibosCuentas.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3615
   ScaleWidth      =   8745
   ...
   End
End
Attribute VB_Name = "frmDetRecibosCuentas"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.DetReciboCuentas
...
Public Property Let Id(ByVal vNewValue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oRecibo.DetRecibosCuentas.Item(vNewValue)
