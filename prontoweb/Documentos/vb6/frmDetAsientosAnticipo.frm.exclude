...
Begin VB.Form frmDetAsientosAnticipo 
   Caption         =   "Item de anticipo al personal [ Asiento manual ]"
   ClientHeight    =   2820
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5385
   Icon            =   "frmDetAsientosAnticipo.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2820
   ScaleWidth      =   5385
   ...
   End
End
Attribute VB_Name = "frmDetAsientosAnticipo"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.DetAsientoAnticipos
...
Public Property Let Id(ByVal vNewValue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAsiento.DetAsientosAnticipos.Item(vNewValue)
