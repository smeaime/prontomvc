...
Begin VB.Form frmRelaciones 
   ...
   ClientTop       =   345
   ClientWidth     =   6885
   Icon            =   "frmRelaciones.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2115
   ScaleWidth      =   6885
   StartUpPosition =   2  'CenterScreen
   Begin VB.TextBox txtId 
      DataField       =   "IdRelacion"
      Enabled         =   0   'False
      Height          =   285
      Left            =   2175
      TabIndex        =   5
...
Option Explicit
Dim WithEvents origen As ComPronto.Relacion
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Relaciones.Item(vnewvalue)
