VERSION 5.00
Begin VB.Form frmGrados 
   Caption         =   "Ingreso de grados"
   ClientHeight    =   1605
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5880
   Icon            =   "frmGrados.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   1605
   ScaleWidth      =   5880
   ...
   End
End
Attribute VB_Name = "frmGrados"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.Grado
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Grados.Item(vnewvalue)
