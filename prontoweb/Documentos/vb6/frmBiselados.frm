VERSION 5.00
Begin VB.Form frmBiselados 
   Caption         =   "Biselados"
   ClientHeight    =   2070
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5805
   Icon            =   "frmBiselados.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2070
   ScaleWidth      =   5805
   ...
   End
End
Attribute VB_Name = "frmBiselados"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.Biselado
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Biselados.Item(vnewvalue)
