VERSION 5.00
Begin VB.Form frmPlanos 
   Caption         =   "Planos"
   ClientHeight    =   2205
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7590
   Icon            =   "frmPlanos.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2205
   ScaleWidth      =   7590
   ...
   End
End
Attribute VB_Name = "frmPlanos"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.Plano
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         If Len(Trim(txtNumeroPlano.Text)) = 0 Then
            MsgBox "Falta completar el campo numero de plano", vbCritical
            Exit Sub
         End If
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Planos.Item(vnewvalue)
...
Private Sub txtNumeroPlano_GotFocus()
...
Private Sub txtNumeroPlano_KeyPress(KeyAscii As Integer)
