VERSION 5.00
Begin VB.Form frmCodigosUniversales 
   Caption         =   "Codigos universales"
   ClientHeight    =   2055
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5520
   Icon            =   "frmCodigosUniversales.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2055
   ScaleWidth      =   5520
   StartUpPosition =   2  'CenterScreen
   Begin VB.TextBox txtId 
      DataField       =   "IdCodigoUniversal"
      Enabled         =   0   'False
      Height          =   285
      Left            =   2220
      TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frmCodigosUniversales"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.CodigoUniversal
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         With actL2
            .ListaEditada = "CodigosUniversales"
            .AccionRegistro = est
            .Disparador = mvarId
         End With
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.CodigosUniversales.Item(vnewvalue)
