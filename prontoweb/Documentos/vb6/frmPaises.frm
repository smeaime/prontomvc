...
Option Explicit
Dim WithEvents origen As ComPronto.Pais
   ...
   Select Case Index
      ...
      Case 0
         ...
         If Len(txtDescripcion.Text) = 0 Then
            MsgBox "No ingreso el nombre del pais", vbExclamation
            Exit Sub
         End If
         
         If Len(txtCodigo.Text) = 0 Then
            MsgBox "No ingreso el codigo del pais", vbExclamation
            Exit Sub
         End If
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Paises.Item(vnewvalue)
...
Private Sub txtCodigo_Validate(Cancel As Boolean)
   ...
   If mvarId < 0 Then
      ...
      Set oRs = Aplicacion.Paises.TraerFiltrado("_PorCodigo", txtCodigo.Text)
      If oRs.RecordCount > 0 Then
         MsgBox "Codigo de pais ya ingresado. Reingrese.", vbCritical
         Cancel = True
      End If
      oRs.Close
      Set oRs = Nothing
...
Private Sub txtDescripcion_Validate(Cancel As Boolean)
   ...
   If mvarId < 0 Then
      Dim oRs As ADOR.Recordset
      Set oRs = Aplicacion.Paises.TraerFiltrado("_PorNombre", txtDescripcion.Text)
      If oRs.RecordCount > 0 Then
         MsgBox "Pais ya ingresado. Reingrese.", vbCritical
         Cancel = True
      End If
      oRs.Close
      Set oRs = Nothing
