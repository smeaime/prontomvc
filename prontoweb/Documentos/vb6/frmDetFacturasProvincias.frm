...
Begin VB.Form frmDetFacturasProvincias 
   Caption         =   "Distribucion de IIBB por provincias"
   ClientHeight    =   3210
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4170
   Icon            =   "frmDetFacturasProvincias.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3210
   ScaleWidth      =   4170
   ...
   Begin Controles1013.DbListView Lista 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmDetFacturasProvincias.frx":076A
      MultiSelect     =   0   'False
      OLEDropMode     =   1
   ...
   Begin MSComctlLib.ImageList Img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetFacturasProvincias.frx":0786
            Key             =   "Eliminado"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetFacturasProvincias.frx":0898
            Key             =   "Nuevo"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetFacturasProvincias.frx":0CEA
            Key             =   "Modificado"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDetFacturasProvincias.frx":113C
            Key             =   "Original"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmDetFacturasProvincias"
...
Sub Editar(ByVal Cual As Long)
   ...
   Else
      With oFactura.DetFacturasProvincias.Item(Cual)
         With .Registro
...
Private Sub cmdOk_Click()
   ...
   With oFactura.DetFacturasProvincias.Item(mvarId)
      With .Registro
      ...
      .Modificado = True
   End With
   Set Lista.DataSource = oFactura.DetFacturasProvincias.RegistrosConFormato
   ...
   Select Case Index
      ...
      Case 2
         With Lista.SelectedItem
            oFactura.DetFacturasProvincias.Item(.Tag).Eliminado = True
            .SmallIcon = "Eliminado"
...
Public Sub CalcularTotales()
   ...
   Set oRs = oFactura.DetFacturasProvincias.Registros
   mTotal = 0
   With oRs
