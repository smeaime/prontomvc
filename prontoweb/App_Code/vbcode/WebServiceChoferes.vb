...
Public Class WebServiceChoferes
    ...
    Public Function GetCompletionList(ByVal prefixText As String, ByVal count As Integer, ByVal contextKey As String) As String()
        ...
        Dim articulolist = EntidadManager.GetStoreProcedure(sc, enumSPs.wChoferes_TX_BusquedaConCUIT, prefixText)
        'Dim articulolist = EntidadManager.ExecDinamico(sc, "SELECT  TOP 100  IdChofer,Nombre FROM Choferes WHERE Nombre LIKE '" & prefixText & "%'")
        For Each proveedor As Data.DataRow In articulolist.Rows
            'items.Add(articulo.Descripcion)

            cod = proveedor.Item("IdChofer") ' & "^" & proveedor.Item("Cuit")
