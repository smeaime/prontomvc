...
Public Class WebServiceWilliamsDestinos
    ...
    Public Function GetCompletionList(ByVal prefixText As String, ByVal count As Integer, ByVal contextKey As String) As String()
        ...
        Dim articulolist = EntidadManager.ExecDinamico(sc, "SELECT  TOP 100  IdWilliamsDestino,Descripcion FROM WilliamsDestinos WHERE Descripcion LIKE '" & prefixText & "%'")
        For Each proveedor As Data.DataRow In articulolist.Rows
            'items.Add(articulo.Descripcion)

            cod = proveedor.Item("IdWilliamsDestino") ' & "^" & proveedor.Item("Cuit")
            items.Add(AjaxControlToolkit.AutoCompleteExtender.CreateAutoCompleteItem(proveedor.Item("Descripcion"), cod))
        Next
