...
Public Class WebServiceTransportistas
    ...
    Public Function GetCompletionList(ByVal prefixText As String, ByVal count As Integer, ByVal contextKey As String) As String()
        ...
        Dim lista = EntidadManager.GetStoreProcedure(sc, enumSPs.wTransportistas_TX_BusquedaConCUIT, prefixText)

        'Dim articulolist = EntidadManager.ExecDinamico(sc, _
        '                    "SELECT  TOP 100  IdTransportista,RazonSocial,Cuit " & _
        '                    "FROM Transportistas WHERE RazonSocial LIKE '" & prefixText & "%'")

        For Each proveedor As Data.DataRow In lista.Rows
            'items.Add(articulo.Descripcion)

            cod = proveedor.Item("IdTransportista") & "^" & proveedor.Item("Cuit")
