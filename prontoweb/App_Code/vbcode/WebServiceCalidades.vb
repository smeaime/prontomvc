...
Public Class WebServiceCalidades
    ...
    Public Function GetCompletionList(ByVal prefixText As String, ByVal count As Integer, ByVal contextKey As String) As String()
        ...
        Dim articulolist = EntidadManager.ExecDinamico(sc, "SELECT  TOP 100  IdCalidad,Descripcion FROM Calidades WHERE Descripcion LIKE '" & prefixText & "%'")
        For Each proveedor As Data.DataRow In articulolist.Rows
            'items.Add(articulo.Descripcion)

            cod = proveedor.Item("IdCalidad") ' & "^" & proveedor.Item("Cuit")
