...
<script RunAt="server">
    ...
    Private Function RegisterCacheEntry() As Boolean
        ...
        HttpContext.Current.Cache.Add(DummyCacheItemKey, "Test", Nothing, _
                DateTime.MaxValue, TimeSpan.FromMinutes(1), _
    ...
    Sub Application_Error(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            If Body.ToLower.Contains("deadlock") Or Body.ToLower.Contains("timeout") _
                ...
                Body &= ".       Hacer profile del IIS.  avisar si se está backupeando a las 4 de la mañana Ver si el error " & _
        ...
        Try
            ...
            MandaEmailSimple(direccion, _
                         If(lastErrorWrapperHttp Is Nothing, "<nadie>" & " en ", User.Identity.Name & " en ") & ConfigurationManager.AppSettings("ConfiguracionEmpresa") & " ProntoWeb" & ": " & lastErrorMessage, _
                           Body, _
