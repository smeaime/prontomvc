    ...
    Protected Sub Login1_LoggedIn(ByVal sender As Object, ByVal e As System.EventArgs) Handles Login1.LoggedIn
        ...
        If BDLMasterEmpresasManagerMigrar.ElUsuarioTieneUnaSolaEmpresa(ConexBDLmaster, Session(SESSIONPRONTO_UserId)) Then
            ...
            If BDLMasterEmpresasManager.EmpresaPropietariaDeLaBase(conexbase) = "Williams" Then
                ...
                ElseIf Not (Request.UrlReferrer.AbsoluteUri.ToLower.Contains("login.aspx") Or Request.UrlReferrer.AbsoluteUri.ToLower.Contains("loginmobile.aspx")) Then
                ...
                Try
                    ...
                    If rol(0) = "Cliente" Or rol(0) = "WilliamsClientes" Then Login1.DestinationPageUrl = "~/ProntoWeb/CartasPortesExternoMovil.aspx"
                Catch ex As Exception
                    ErrHandler2.WriteError(ex)
                End Try
