...
Begin VB.Form frmPlazosEntrega 
   Caption         =   "Plazos de entrega"
   ClientHeight    =   3180
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6990
   Icon            =   "frmPlazosEntrega.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3180
   ScaleWidth      =   6990
   ...
   Begin RichTextLib.RichTextBox rchObservaciones 
      ...
      Enabled         =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"frmPlazosEntrega.frx":076A
   End
   ...
   End
End
Attribute VB_Name = "frmPlazosEntrega"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.PlazoEntrega
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.PlazosEntrega.Item(vnewvalue)
