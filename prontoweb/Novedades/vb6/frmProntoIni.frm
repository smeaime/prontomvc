...
Begin VB.Form frmProntoIni 
   ...
   Begin VB.Menu MnuDet 
      ...
      End
      Begin VB.Menu MnuDetA 
         Caption         =   "Eliminar claves del usuario"
         Index           =   6
      End
   End
...
Public Sub EliminarClaves()
   ...
   mVector1 = VBA.Split(Arbol.SelectedItem.Key, "|")
   If mId(mVector1(0), 1, 1) = "K" Then
      mIdEmpleado = Val(mId(mVector1(0), 2, 10))
   ElseIf IsNumeric(mVector1(0)) Then
      mIdEmpleado = mVector1(0)
   Else
      Exit Sub
   End If
   ...
   For Each mNode In Arbol.Nodes
      mVector1 = VBA.Split(mNode.Key, "|")
      If mIdEmpleado = mVector1(0) Then
         s = s & mNode.Key & ","
      End If
   Next
   ...
   For i = 0 To UBound(mVector1)
      ...
      Aplicacion.Tarea "ProntoIni_Eliminar", Array(mVector2(0), mVector2(1))
      Arbol.Nodes.Remove (mVector1(i))
   Next
