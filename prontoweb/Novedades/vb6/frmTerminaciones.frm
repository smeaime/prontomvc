VERSION 5.00
Begin VB.Form frmTerminaciones 
   Caption         =   "Terminaciones"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5625
   ...
   End
End
Attribute VB_Name = "frmTerminaciones"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents Origen As ComAesa.Terminacion
...
Public Property Let Id(ByVal vNewValue As Long)
   ...
   Set oap = Aplicacion
   Set Origen = oap.Terminaciones.Item(vNewValue)
