VERSION 5.00
Begin VB.Form frmTTermicos 
   Caption         =   "Tratamientos Termicos"
   ClientHeight    =   2070
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7515
   Icon            =   "frmTTermicos.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2070
   ScaleWidth      =   7515
   ...
   End
End
Attribute VB_Name = "frmTTermicos"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.TTermico
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         With actL2
            .ListaEditada = "TratamientosTermicos"
            .AccionRegistro = est
            .Disparador = mvarId
         End With
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.TTermicos.Item(vnewvalue)
