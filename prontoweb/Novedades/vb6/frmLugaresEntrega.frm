...
Begin VB.Form frmLugaresEntrega 
   Caption         =   "Lugares de entrega"
   ClientHeight    =   3270
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6975
   Icon            =   "frmLugaresEntrega.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3270
   ScaleWidth      =   6975
   ...
   Begin RichTextLib.RichTextBox rchObservaciones 
      ...
      Enabled         =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"frmLugaresEntrega.frx":076A
   End
   ...
   End
End
Attribute VB_Name = "frmLugaresEntrega"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.LugarEntrega
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.LugaresEntrega.Item(vnewvalue)
   ...
   Else
      With origen.Registro
         rchObservaciones.Text = .Fields("Detalle").Value
      End With
   End If
