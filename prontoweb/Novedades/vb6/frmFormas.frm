...
Option Explicit
Dim WithEvents origen As ComPronto.Forma
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Formas.Item(vnewvalue)
...
'Show 'The form!
'SetWindowRgn hwnd, CreateEllipticRgn(100, 50, 600, 300), True
