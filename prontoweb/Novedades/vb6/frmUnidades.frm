...
Begin VB.Form frmUnidades 
   ...
   Begin VB.TextBox txtTaraEnKg 
      ...
      Width           =   765
   End
   Begin VB.TextBox txtUnidadesPorPack 
      DataField       =   "UnidadesPorPack"
      Height          =   285
      Left            =   2610
      TabIndex        =   4
      Top             =   1710
...
Option Explicit
Dim WithEvents origen As ComPronto.Unidad
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Unidades.Item(vnewvalue)
...
Private Sub txtTaraEnKg_GotFocus()
...
Private Sub txtTaraEnKg_KeyPress(KeyAscii As Integer)

   If KeyAscii = Asc(vbCr) Then SendKeys "{TAB}", True

End Sub

Private Sub txtUnidadesPorPack_GotFocus()

   With txtUnidadesPorPack
      .SelStart = 0
      .SelLength = Len(.Text)
   End With
...
Private Sub txtUnidadesPorPack_KeyPress(KeyAscii As Integer)
