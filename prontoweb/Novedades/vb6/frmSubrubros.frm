...
Option Explicit
Dim WithEvents origen As ComPronto.Subrubro
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         If Len(txtSubrubro.Text) = 0 Then
            MsgBox "No puede grabar un subrubro sin descripcion", vbExclamation
            Exit Sub
         End If
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Subrubros.Item(vnewvalue)
...
Private Sub txtSubrubro_GotFocus()
...
Private Sub txtSubrubro_KeyPress(KeyAscii As Integer)
