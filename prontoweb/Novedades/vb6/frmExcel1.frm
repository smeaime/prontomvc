...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      Case 0
         ...
         Dim mTipo As String, mResDet As String, mImprime As String, mArgL2 As String, mArgL3 As String, mArgL4 As String
         Dim mArgL5 As String, mArgL6 As String, mArgL7 As String, mArticulo As String, mAuxS1 As String
         Dim mObra As Long, mIdProveedor As Long, mIdPedido As Long, mArgL1 As Long, mNumero As Long, mIdArticulo As Long
         Dim mIdCuentaBancaria As Long
         Dim mSalida As Integer, mGrupo As Integer
         Dim mUnloadMe As Boolean
         Dim mAux1
         ...
         ElseIf mCodigo = "GenFac" Then
            ...
            If Frame11.Visible Then
               If Option27.Value Then
                  mGrupo = 1
               ElseIf Option28.Value Then
                  mGrupo = 2
               ElseIf Option29.Value Then
                  mGrupo = 3
               End If
            End If
         ...
         ElseIf mCodigo = "PosBancos" Then
            mArgL2 = BuscarClaveINI("Modelo para posicion bancaria")
            Select Case mArgL2
               Case "Modelo1"
                  If dcfields(5).Enabled Then
                     If Not IsNumeric(dcfields(5).BoundText) Then
                        MsgBox "Falta indicar la cuenta bancaria", vbExclamation
                        Exit Sub
                     End If
                  End If
                  If Len(Text1.Text) = 0 Then
                     MsgBox "Falta indicar el saldo actual del banco", vbExclamation
                     Exit Sub
                  End If
            End Select
         End If
               ...
               Select Case mCodigo
                  ...
                  Case "MatRec"
                     ...
                     Set oRs = CopiarTodosLosRegistros(oAp.TablasGenerales.TraerFiltrado("Recepciones", _
                                 "_MaterialesRecibidos", Array(mDesde, mHasta, mObra, mIdArticulo, mNumero, mIdProveedor)))
                     With oRs
                        If .RecordCount > 0 Then
                           .MoveFirst
                           Do While Not .EOF
                  ...
                  Case "CashFlow"
                     oEx.Run "GenerarCashFlow", glbStringConexion, Text1.Text, Text2.Text, glbEmpresa, mImprime, Val(txtCopias.Text)
                     mUnloadMe = True
               
                  Case "CashFlow2"
                     oEx.Run "Generar", glbStringConexion, Text1.Text, Text2.Text, glbEmpresa, mImprime, Val(txtCopias.Text)
                     mUnloadMe = True
                  ...
                  Case "EstadoResultado2"
                     oEx.Run "Generar", glbStringConexion, Text1.Text, Text2.Text, glbEmpresa, mImprime, Val(txtCopias.Text), mResDet
                     mUnloadMe = True
                  ...
                  Case "EstadoResultado4"
                     oEx.Run "GenerarEstadoResultado4", glbStringConexion, Text1.Text, Text2.Text, glbEmpresa, mImprime, Val(txtCopias.Text)
                     mUnloadMe = True
               
                  Case "EstadoResultado5"
                     oEx.Run "GenerarEstadoResultado5", glbStringConexion, Text1.Text, Text2.Text, glbEmpresa, mImprime, Val(txtCopias.Text)
                     mUnloadMe = True
                  ...
                  Case "ResFF"
                     ...
                     End If
                     oEx.Run "GenerarResFF", glbStringConexion, Text1.Text, dcfields(1).BoundText, glbEmpresa, mImprime, Val(txtCopias.Text), mObra
                  ...
                  Case "InformeOTs"
                     ...
                     End If
                     mAuxS1 = ""
                     If Option26.Value And Check2.Value = 1 Then mAuxS1 = "SI"
                     oEx.Run "InformeOTs", glbStringConexion, mDesde, mHasta, mImprime, Val(txtCopias.Text), _
                                           Trim(txtNumero.Text), mArgL5 & "|" & mArgL2 & "|" & mAux1 & "|" & mAuxS1
                  ...
                  Case "SalMatTransp"
                     Set oRs = oAp.TablasGenerales.TraerFiltrado("SalidasMateriales", "_DatosTransporte", Array(mDesde, mHasta, mObra))
                  ...
                  Case "PosBancos"
                     ...
                     Select Case mArgL2
                        Case "Modelo1"
                           mIdCuentaBancaria = -1
                           If dcfields(5).Enabled Then mIdCuentaBancaria = dcfields(5).BoundText
                           oEx.Run "GenerarPosicionBancaria1", glbStringConexion, mDesde, mImprime, Val(txtCopias.Text), glbEmpresaSegunString, glbPathPlantillas, mIdCuentaBancaria, Val(Text1.Text)
                        Case Else
                           oEx.Run "GenerarPosicionBancaria", glbStringConexion, mDesde, mImprime, Val(txtCopias.Text), glbEmpresaSegunString, glbPathPlantillas
                     End Select
                     mUnloadMe = True
               End Select
               If mImprime = "S" Then
...
Public Property Let Codigo(ByVal vNewValue As String)
   ...
   Select Case mCodigo
      ...
      Case "MatRec"
         ...
         Option16.Value = True
         With cmd(0)
            .Top = Frame6.Top + Frame6.Height + 100
         End With
         With cmd(1)
            .Top = cmd(0).Top
            .Left = cmd(0).Left + cmd(0).Width + 100
      ...
      Case "GenFac"
         ...
         If Len(mAux) > 0 Then
            ...
            With Option27
               ...
               .Value = True
            End With
            Option28.Caption = mVector(1)
            Option29.Caption = mVector(2)
            Me.Height = Me.Height
            ...
            End With
            With lblEstado
               .Top = cmd(1).Top + cmd(1).Height
               .Left = Frame2.Left
               .Width = DTFields(0).Width * 4.5
               .Height = cmd(1).Height * 2.5
            End With
         Else
            With lblEstado
               .Top = DTFields(0).Top
         ...
         End With
         With Frame8
            .Top = Frame11.Top + Frame11.Height + 100
            .Left = Frame2.Left
      ...
      Case "CashFlow", "CashFlow2", "CashFlow3", "CashFlow4", "CashFlow5", _
         ...
         If mCodigo = "EstadoResultado2" Or mCodigo = "EstadoResultado3" Then
            Frame1.Visible = True
            Option2.Value = True
         Else
            Frame1.Visible = False
      ...
      Case "PosBancos"
         ...
         With lblLabels(1)
            .Width = .Width * 2.95
            .Caption = "Resumen posicion bancaria al :"
         End With
         If BuscarClaveINI("Modelo para posicion bancaria") = "Modelo1" Then
            With lblLabels(0)
               .Top = lblLabels(1).Top + lblLabels(1).Height + 100
               .Left = lblLabels(1).Left
               .Width = lblLabels(1).Width
               .Caption = "Saldo actual banco :"
               .Visible = True
            End With
            With Text1
               .Top = lblLabels(0).Top
...
Public Sub GenerarFacturasAutomaticas(ByVal SoloAbonos As Boolean, ByVal Grupo As Integer)
   ...
   Set oRs = oAp.OrdenesCompra.TraerFiltrado("_OrdenesAFacturarAutomaticas_PorCliente", _
                        Array(DTFields(0).Value, mConceptosAbono, mSoloAbonos, Grupo, mOCSeleccionadas))
