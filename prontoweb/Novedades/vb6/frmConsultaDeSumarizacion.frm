...
Begin VB.Form frmConsultaDeSumarizacion 
   ClientHeight    =   5100
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11820
   Icon            =   "frmConsultaDeSumarizacion.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5100
   ScaleWidth      =   11820
   ...
   Begin Controles1013.DbListView Lista 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmConsultaDeSumarizacion.frx":076A
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0786
            Key             =   "Imprimir"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0898
            Key             =   "Buscar"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":09AA
            Key             =   "Ayuda"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0ABC
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0BCE
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0CE0
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmConsultaDeSumarizacion.frx":0DF2
            Key             =   "Excel"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmConsultaDeSumarizacion"
...
Public Property Let Id(ByVal vnewvalue As String)
   ...
   Select Case mvarId
      Case 1
         Me.Caption = "Acopios por obra sumarizadas"
      Case 2
         Me.Caption = "Listas de materiales por obra sumarizadas"
      Case 3
         Me.Caption = "Requerimientos de materiales por obra sumarizadas"
      Case 4
         Me.Caption = "Reservas de stock por obra sumarizadas"
   End Select
...
Public Sub Calcular()
   ...
   Select Case mvarId
      Case 1
         Set Lista.DataSource = Aplicacion.Acopios.TraerFiltrado("_Sumarizadas", mvarIdObra)
      Case 2
         Set Lista.DataSource = Aplicacion.LMateriales.TraerFiltrado("_Sumarizadas", mvarIdObra)
      Case 3
         Set Lista.DataSource = Aplicacion.Requerimientos.TraerFiltrado("_Sumarizadas", mvarIdObra)
      Case 4
         Set Lista.DataSource = Aplicacion.Reservas.TraerFiltrado("_Sumarizadas", mvarIdObra)
   End Select
