VERSION 5.00
Begin VB.Form frmSchedulers 
   Caption         =   "Ingreso de scheduler"
   ClientHeight    =   1605
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5700
   Icon            =   "frmSchedulers.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   1605
   ScaleWidth      =   5700
   StartUpPosition =   2  'CenterScreen
   Begin VB.TextBox txtId 
      DataField       =   "IdScheduler"
      Enabled         =   0   'False
      Height          =   285
      Left            =   2280
      TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frmSchedulers"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.Scheduler
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.Schedulers.Item(vnewvalue)
