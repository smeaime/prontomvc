VERSION 5.00
Begin VB.Form frmUnidadesOperativas 
   Caption         =   "Unidades operativas"
   ClientHeight    =   1740
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5655
   Icon            =   "frmUnidadesOperativas.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   1740
   ScaleWidth      =   5655
   ...
   End
End
Attribute VB_Name = "frmUnidadesOperativas"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.UnidadOperativa
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         With actL2
            .ListaEditada = "UnidadesOperativas"
            .AccionRegistro = est
            .Disparador = mvarId
         End With
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.UnidadesOperativas.Item(vnewvalue)
