VERSION 5.00
Begin VB.Form frmCoeficientesContables 
   Caption         =   "Coeficientes contables"
   ClientHeight    =   2340
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4275
   Icon            =   "frmCoeficientesContables.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   2340
   ScaleWidth      =   4275
   ...
   End
End
Attribute VB_Name = "frmCoeficientesContables"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim WithEvents origen As ComPronto.CoeficienteContable
...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         With actL2
            .ListaEditada = "CoeficientesContables"
            .AccionRegistro = est
            .Disparador = mvarId
         End With
...
Public Property Let Id(ByVal vnewvalue As Long)
   ...
   Set oAp = Aplicacion
   Set origen = oAp.CoeficientesContables.Item(vnewvalue)
