...
--CREATE NONCLUSTERED INDEX IDX_prueba2
--ON [dbo].[CartasDePorte] (FechaDescarga)
--GO

--CREATE NONCLUSTERED INDEX IDX_prueba
--ON [dbo].[CartasDePorte] ([NumeroCartaDePorte],SubnumeroVagon,Exporta, Anulada)
--GO
...
select top 50 * FROM cartasdeporte
ORDER BY [NumeroCartaDePorte] DESC

select top 50 [IdArticulo] FROM cartasdeporte
ORDER BY FechaDescarga DESC
...
SELECT TOP (50) 
    ...
    -- ORDER BY [Project1].[FechaDescarga] DESC
