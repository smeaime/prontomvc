<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FacturaElectronicaEncriptada.aspx.vb"
    Inherits="FacturaElectronicaEncriptada" Title="Williams Entregas" %>
...
<body class="bodyMasterPage">
    ...
    <br />
    <asp:Button ID="btnDescargaPDF" Text="Descargar PDF de factura electronica" runat="server"
        Height="50px" />
    <asp:Button ID="Button1" Text="Descargar PDF de adjuntos de facturacion" runat="server"
        Height="50px" />
        ...
        <ContentTemplate>
            <div style="background-color: #FFFFFF; width: 800px">
                <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    Width="95%" Visible="true" ZoomMode="PageWidth" Height="1200px" SizeToReportContent="True" AsyncRendering="False" >
