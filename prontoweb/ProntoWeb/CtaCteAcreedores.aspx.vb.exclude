...
Partial Class CtaCteAcreedores
    ...
    Sub gvCuentasRebind()
        ...
        b.Sort = "Proveedor ASC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
    ...
    Sub gvEstadoRebind()
        ...
        ''b.Sort = "[Fecha Factura],Numero DESC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
        ''b.Sort = "Proveedor DESC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
        ''ViewState("Sort") = b.Sort
        ...
        idProveedor = Convert.ToInt32(gvCuentas.SelectedDataKey.Value)

        Dim oCli = ProveedorManager.GetItem(HFSC.Value, idProveedor)
        lblProveedor.Text = oCli.RazonSocial
        ...
        lblSaldo.Text = FF2(CtaCteAcreedorManager.Saldo(HFSC.Value, idProveedor))
        ...
        'ObjectDataSource4.SelectParameters.Add("Param1", idProveedor)
    ...
    Function GetDataSource() As DataTable
        ...
        If Not IsNothing(gvCuentas.SelectedDataKey) Then
            idProveedor = Convert.ToInt32(gvCuentas.SelectedDataKey.Value)
        End If
        'dim dt=EntidadManager.GetStoreProcedure(hfSC.value,"Ctasctesa_TXPorMayor",idProveedor,alcance, iisValidSqlDate(txtFechaHasta.Text, "1/1/1900"), iisValidSqlDate(txtFechaDesde.Text, "1/1/2100"), consolidar }

        If IsNothing(idProveedor) Or idProveedor < 1 Then Exit Function
        ...
        If RadioButtonListTrans_O_Mayor.SelectedValue <> "Por Mayor" Then
            ...
            dt = EntidadManager.TraerFiltrado(HFSC.Value, enumSPs.CtasCtesA_TXPorTrs, idProveedor, mTodo, iisValidSqlDate(txtFechaHasta.Text, "1/1/2100"), iisValidSqlDate(txtFechaDesde.Text, "1/1/1900"), -1)
            ...
            If False Then 'pinta que el store de Acreedores (a diferencia del de Deudores) ya trae saldotrs!
                ...
                For Each dr In dt.Rows
                    With dr
                        ...
                        If Trs <> iisNull(.item("IdImputacion"), -1) Then
                            'es un IF para crear agrupaciones... cuando encuentra un 
                            'IdImputacion distinto, hace el "AGGREGATE" con el SUM del saldo
        ...
        Else
            ...
            '///////////////////////////////////////////////////////////////////////////////////
            '///////////////////////////////////////////////////////////////////////////////////
            dt = EntidadManager.TraerFiltrado(HFSC.Value, enumSPs.CtasCtesA_TXPorMayor, idProveedor, mTodo, iisValidSqlDate(txtFechaHasta.Text, "1/1/2100"), iisValidSqlDate(txtFechaDesde.Text, "1/1/1900"), -1)
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        output = DataTableToExcel(dv, "", "Cuenta corriente Acreedor")
    ...
    Protected Sub ObjectDataSource4_Selecting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceSelectingEventArgs) Handles ObjectDataSource4.Selecting
        ...
        'Dim idProveedor = BuscaIdProveedorPreciso(txtAutocompleteProveedor.Text, HFSC.Value).ToString
        ...
        If idProveedor > 0 Then
            Dim oPrv = ProveedorManager.GetItem(HFSC.Value, idProveedor)
            lblProveedor.Text = oPrv.RazonSocial
            lblTelefono.Text = oPrv.RazonSocial
            lblMail.Text = oPrv.Email
            lblSaldo.Text = oPrv.Saldo
        End If
        ...
        End If
        e.InputParameters("Parametros") = New String() {idProveedor, -1, iisValidSqlDate(txtFechaHasta.Text, "1/1/1900"), iisValidSqlDate(txtFechaDesde.Text, "1/1/2100"), -1}

        'exec Ctasctesa_TXPorMayor 84, -1, 'Ene 12 2011 12:00AM', 'Ene  1 2000 12:00AM', -1
        'exec Ctasctesa_TXPorTrs 84, -1, 'Ene 12 2011 12:00AM', 'Ene  1 2000 12:00AM', -1
