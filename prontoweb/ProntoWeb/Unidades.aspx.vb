...
Imports UnidadesManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class Unidades
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                dr.Item("Abreviatura") = TextoWebControl(.FindControl("txtNewAbreviatura"))
                'dr.Item("IdTitular") = IdNull(BuscaIdClientePreciso(TextoWebControl(.FindControl("txtNewCliente")), HFSC.Value))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("Abreviatura") = TextoWebControl(.FindControl("txtAbreviatura"))
            'dr.Item("IdTitular") = IdNull(BuscaIdClientePreciso(TextoWebControl(.FindControl("txtCliente")), HFSC.Value))
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        UnidadesManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    '    Dim establecimientos = From e In db.Unidades
...
<Serializable()> Public Class Unidad
