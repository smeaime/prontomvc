...
Imports CDPHumedadManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class CDPHumedades
    ...
    Sub Permisos()
        Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "Humedad")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                If IsNull(IdNull(BuscaIdArticuloPreciso(TextoWebControl(.FindControl("txtNewArticulo")), HFSC.Value))) Then
                    MsgBoxAjax(Me, "Elija un articulo")
                    Return
                End If
                ...
                dr.Item("Humedad") = Val(TextoWebControl(.FindControl("txtNewHumedad")))
                dr.Item("Merma") = Val(TextoWebControl(.FindControl("txtNewMerma")))
                dr.Item("IdArticulo") = IdNull(BuscaIdArticuloPreciso(TextoWebControl(.FindControl("txtNewArticulo")), HFSC.Value))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("Humedad") = Val(TextoWebControl(.FindControl("txtHumedad")))
            dr.Item("Merma") = Val(TextoWebControl(.FindControl("txtMerma")))

            dr.Item("IdArticulo") = IdNull(BuscaIdArticuloPreciso(TextoWebControl(.FindControl("txtArticulo")), HFSC.Value))
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        CDPHumedadManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    Private Sub ReBind()
        ...
        dv.Sort = "IdArticulo ASC,Humedad DESC"
...
<Serializable()> Public Class CDPHumedad
...
Public Class CDPHumedadManager

    Const Tabla = "CDPHumedades"
    Const IdTabla = "IdCDPHumedad"
    ...
    'Public Shared Function Insert(ByVal SC As String, ByVal IdArticulo As Long, ByVal Humedad As Double, ByVal Merma As Double)
    ...
    '    myCommand = New SqlCommand(String.Format("INSERT INTO CDPHumedades (IdArticulo,Humedad,Merma) VALUES ( {0},{1},{2} ) ", IdArticulo, Humedad, Merma), myConnection)
    ...
    Public Shared Function Fetch(ByVal SC As String) As DataTable
        ...
        Return ExecDinamico(SC, "SELECT A.*, " & _
                            " Articulos.Descripcion as Articulo " & _
                            " FROM " & Tabla & " A " & _
                            " LEFT OUTER JOIN Articulos ON A.IdArticulo = Articulos.IdArticulo " & _
                            "")
