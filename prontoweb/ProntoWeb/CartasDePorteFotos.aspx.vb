...
Partial Class CartasDePorteImportador
    ...
    Protected Sub AsyncFileUpload1_UploadedComplete(ByVal sender As Object, ByVal e As AjaxControlToolkit.AsyncFileUploadEventArgs) Handles AsyncFileUpload1.UploadedComplete
        ...
        If (AsyncFileUpload1.IsUploading) Then Return

        'http://stackoverflow.com/questions/5018044/asyncfileupload-postback-causes-double-upload
        If (Request.Params.Get("__EVENTTARGET") <> "UpdatePanelAFU") Then
            'Return
        End If
        ...
        'Dim nuevosubdir = DIRTEMP + CrearDirectorioParaLoteImagenes(DirApp, Session(SESSIONPRONTO_UserName))
        'Dim destarchivo = nuevosubdir + AsyncFileUpload1.PostedFile.FileName
        'AsyncFileUpload1.SaveAs(destarchivo)


        Dim DIRTEMP As String = System.IO.Path.GetTempPath()
        Dim destarchivo = DIRTEMP + AsyncFileUpload1.PostedFile.FileName
        ...
        Try
            If InStr(AsyncFileUpload1.FileName, ".zip") Then
                'CartaDePorteManager.
                'ProntoFuncionesUIWeb.AdjuntarImagenEnZip(SC, AsyncFileUpload1, -1, sError, DirApp)





                Dim archivos As Generic.List(Of String) = ClassFlexicapture.PreprocesarArchivoSubido(destarchivo, Session(SESSIONPRONTO_UserName) + "_IMPORT1", DirApp, True, False, False, 0)
