<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CartasDePorteReasignarImagen.aspx.vb"
    Inherits="CartasDePorteReasignarImagen" Title="Asignar imagen" %>
...
<body class="bodyMasterPage">
    ...
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>--%>
        ...
        Número 
        <asp:TextBox ID="TextBox1" runat="server" Width="200px" Visible="true"></asp:TextBox>
        <asp:Button ID="btnDescargaPDF" Text="Aceptar" runat="server" Height="20px" />
        <br />
        <br />

        
        <asp:Panel runat="server" Height="700px" Width="100%" ScrollBars="Both">
            <asp:Image ID="imgFotoCarta" runat="server" Style="" />
        </asp:Panel>
