...
Imports PartidoesManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class Partidoes
    ...
    Sub ImportaCodigosONCAA()
        ...
        'Dim dtPartidoes = ExecDinamico(HFSC.Value, "SELECT * from Partidoes")
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            If Not IsNothing(cmbProvincia) Then
                ...
                BuscaTextoEnCombo(cmbProvincia, CStr(DirectCast(GridView1.DataSource, DataView).Table.Rows(e.Row.RowIndex).Item("Provincia")))
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                If TextoWebControl(.FindControl("txtNewPartido")) = "" Then
                ...
                dr.Item("Nombre") = TextoWebControl(.FindControl("txtNewPartido"))
                dr.Item("Codigo") = TextoWebControl(.FindControl("txtNewCodigoONCAA"))
                dr.Item("CodigoONCCA") = TextoWebControl(.FindControl("txtNewCodigoONCAA"))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("Nombre") = TextoWebControl(.FindControl("txtPartido"))
            dr.Item("Codigo") = TextoWebControl(.FindControl("txtCodigoONCAA"))
            dr.Item("CodigoONCCA") = TextoWebControl(.FindControl("txtCodigoONCAA"))
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        Try
            PartidoesManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
            ReBind()
        Catch sqlEx As SqlException When sqlEx.Number = 547  'handle foreign key violation(547)
            ...
            MsgBoxAjax(Me, "La Partido está siendo usada") ' "La Partido está siendo usada")
        ...
        Catch sqlEx As SqlException  'all other SQL exceptions
            'Do something about the exception
            MsgBoxAjax(Me, sqlex.ToString) ' "La Partido está siendo usada")
        Catch ex As Exception
            MsgBoxAjax(Me, ex.ToString) ' "La Partido está siendo usada")
        End Try

        'If IsNothing()) Then
        '    'MsgBoxAlert("La Partido está siendo usada")
        '    MsgBoxAjax(Me, "La Partido está siendo usada")
        'Else
        '    ReBind()
        'End If
    End Sub
...
<Serializable()> Public Class Partido
...
Public Class PartidoesManager

    Const Tabla = "Partidos"
    Const IdTabla = "IdPartido"
    ...
    Public Shared Function Fetch(ByVal SC As String) As DataTable
        ...
        'Return EntidadManager.ExecDinamico(SC, "wPartidoes_TT")

        Return ExecDinamico(SC, String.Format("SELECT PARTIDOS.*, PARTIDOS.Nombre as Partido, CodigoPostal as [Codigo Postal], Provincias.Nombre as Provincia " & _
                            " FROM PARTIDOS " & _
                            " LEFT JOIN PROVINCIAS on Provincias.IdProvincia=Partidos.IdProvincia                   " & _
                            ""))
        ...
        '                    " LEFT OUTER JOIN Partidoes LOCORI ON CDP.Procedencia = LOCORI.IdPartido " & _
