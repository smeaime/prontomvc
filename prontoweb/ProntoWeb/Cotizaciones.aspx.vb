...
Imports CotizacionesManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class CotizacionesListado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then 'es decir, si es la primera vez que se carga
            ...
            GridView1.FooterRow.FindControl("txtNewCotizacion").Focus()
            ' GridView1.FooterRow.FindControl("txtNewCotizacion").
            ...
            Session("Busqueda") = ""
            DirectCast(Me.Master.FindControl("txtSuperbuscador"), TextBox).Text = ""
    ...
    Protected Sub Page_LoadComplete(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LoadComplete
        'lo hago acá y no en el Load para que no me lo pise el Load del MasterPage
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            Dim cmbMoneda As DropDownList = e.Row.FindControl("cmbMoneda")
            If Not IsNothing(cmbMoneda) Then
                cmbMoneda.DataSource = EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.Monedas_TL)
                cmbMoneda.DataTextField = "Titulo"
                cmbMoneda.DataValueField = "IdMoneda"
                cmbMoneda.DataBind()
                'BuscaTextoEnCombo(cmbMoneda, "Dolares")
                'cmbMoneda.Items.Insert(0, New ListItem("", -1)) 'recorda que hay DOS combos (uno para alta y otro para edicion)
        ...
        If (e.Row.RowType = DataControlRowType.Footer) Then
            ...
            Dim cmbNewMoneda As DropDownList = e.Row.FindControl("cmbNewMoneda")
            cmbNewMoneda.DataSource = EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.Monedas_TL)
            cmbNewMoneda.DataTextField = "Titulo"
            cmbNewMoneda.DataValueField = "IdMoneda"
            cmbNewMoneda.DataBind()
            BuscaTextoEnCombo(cmbNewMoneda, "Dolares")
            'cmbNewMoneda.Items.Insert(0, New ListItem("", -1))   'recorda que hay DOS combos (uno para alta y otro para edicion)
            'cmbNewType.DataSource = .FetchCustomerType()
            'cmbNewType.DataBind()


            Dim txtNewFecha As TextBox = e.Row.FindControl("txtNewFecha")
            txtNewFecha.Text = Today
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                dr.Item("Fecha") = TextoWebControl(.FindControl("txtNewFecha"))
                dr.Item("IdMoneda") = IdNull(CType(.FindControl("cmbNewMoneda"), DropDownList).SelectedValue)
                dr.Item("Cotizacion") = TextoWebControl(.FindControl("txtNewCotizacion"))
                dr.Item("CotizacionLibre") = TextoWebControl(.FindControl("txtNewCotLibre"))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("Fecha") = TextoWebControl(.FindControl("txtFecha"))
            dr.Item("IdMoneda") = IdNull(CType(.FindControl("cmbMoneda"), DropDownList).SelectedValue)
            dr.Item("Cotizacion") = TextoWebControl(.FindControl("txtCotizacion"))
            dr.Item("CotizacionLibre") = TextoWebControl(.FindControl("txtCotLibre"))
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        CotizacionesManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    Private Sub ReBind()
        ...
        dv = DataTableORDER(dv.ToTable, "IdCotizacion DESC")
...
"           CTG as CTG " & _
                  " FROM CartasDePorte CDP " & _
                   ...
                   " LEFT OUTER JOIN Cotizaciones TRANS ON CDP.IdTransportista = TRANS.IdTransportista " & _
...
<Serializable()> Public Class Cotizaciones
...
Public Class CotizacionesManager

    Const Tabla = "Cotizaciones"
    Const IdTabla = "IdCotizacion"
    ...
    Public Shared Function Fetch(ByVal SC As String) As DataTable
        ...
        Dim s = "Select " & _
     "Cotizaciones.IdTransportista, " & _
     "Cotizaciones.RazonSocial,  " & _
     "Cotizaciones.Direccion,  " & _
     "Localidades.Nombre AS [Localidad],  " & _
     "Cotizaciones.CodigoPostal,  " & _
     "Provincias.Nombre AS [Provincia],  " & _
     "Paises.Descripcion AS [Pais],  " & _
     "Cotizaciones.Telefono,  " & _
     "Cotizaciones.Fax,  " & _
     "Cotizaciones.Email,  " & _
     "Cotizaciones.Cuit,  " & _
     "DescripcionIva.Descripcion AS [Condicion IVA],  " & _
     "Cotizaciones.Contacto, " & _
     "Cotizaciones.Horario, " & _
        "    Cotizaciones.Celular " & _
        "    FROM Cotizaciones " & _
     "LEFT JOIN DescripcionIva ON Cotizaciones.IdCodigoIva = DescripcionIva.IdCodigoIva  " & _
     "LEFT JOIN Localidades ON Cotizaciones.IdLocalidad = Localidades.IdLocalidad  " & _
     "LEFT JOIN Provincias ON Cotizaciones.IdProvincia = Provincias.IdProvincia " & _
     "LEFT JOIN Paises ON Cotizaciones.IdPais = Paises.IdPais " & _
        "ORDER BY Cotizaciones.RazonSocial "
