<%@ Page Language="VB" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="ReclamosPorUsuarioMovil.aspx.vb" Inherits="ReclamosPorUsuarioMovil"
    Title="Informes" %>
...
<body style="background-color: #9ec3e8" class="">
                    ...
                    <table style="color: black; width: 320px; vertical-align: bottom !important;">
                        <tr>
                            ...
                            <td style="font-size: 16px; text-align: center">
                                ...
                                <b style="font-size: 18px; text-align: center">Conversación CP</b>
                                <br />
                        ...
                        <tr style="margin-top: 7px; visibility: hidden; display:none">
  ...
  padding:0;*/
            ...
            <div id="ListaPager" class="scroll" style="text-align: center; height: ;">
                    ...
                    <asp:TextBox ID="TextBox5" runat="server" CssClass="CssTextBox" Width="250px" TextMode="MultiLine" Enabled="true"></asp:TextBox>

                    <asp:Button ID="Button6" runat="server" Text="enviar" />



            <div class="row-fluid" style="margin-bottom: ; margin-top: 5px; visibility:hidden; display: none">
...
<script type="text/javascript">
    ...
    function cambiarSituaciones(ids, user, pass, callback) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                idscartas: ids,
                idsituacion: $("#SituacionNueva").val(),
    ...
    $().ready(function () {
        ...
        { name: 'ArchivoAdjunto', index: 'ArchivoAdjunto', align: 'left', width: 100, editable: true, hidden: true, sortable: false },
            ...
            height: $(window).height() - 260, //'auto', // '100%', //$(window).height() - 260, // '100%'
