...
Partial Class NotasDeCredito
    ...
    Sub Imprimir(ByVal IdNotaDeCredito As Long)
        ...
        output = ImprimirWordDOT(p, Me, HFSC.Value, Session, Response, IdNotaDeCredito, mvarClausula, mPrinter, mCopias, System.IO.Path.GetTempPath & "NotaCredito.doc")
        Try
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdNotaDeCredito As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("NotaDeCredito.aspx?Id={0}", IdNotaDeCredito.ToString))
        End Select
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, "DetNotasCredito_TXCre", DataBinder.Eval(e.Row.DataItem, "Id"))
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("NotaDeCredito.aspx?Id=-1"))
    End Sub
    ...
    Sub Rebind()
        ...
        b.Sort = "[Fecha credito] DESC,Numero DESC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
