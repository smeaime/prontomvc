<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="ControlesCalidad.aspx.vb" Inherits="ControlesCalidad" Title="Establecimientos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:DropDownList ID="cmbBuscarEsteCampo" runat="server" Style="text-align: right;
        ...
        <asp:ListItem Text="Auxiliar 1" Value="AuxiliarString1" />
        <asp:ListItem Text="Productor" Value="Productor" />
        <asp:ListItem Text="Localidad" Value="Localidad" />
        <asp:ListItem Text="CUIT" Value="CUIT" />
        <asp:ListItem Text="Auxiliar 2" Value="AuxiliarString2" />
    </asp:DropDownList>
    <br />
    <br />
    <%--/////////////////////////////////////////////////////////////////////        
