<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="ComprobantesPrv.aspx.vb" Inherits="ComprobantePrvs" Title="Comprobantes de Proveedor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:TextBox ID="txtBuscar" runat="server" Style="text-align: right; background-image: url(imagenes/lupita.jpg);
                background-position: right; background-repeat: no-repeat;" Text="" AutoPostBack="True"></asp:TextBox>
...
--%>
                                    ...
                                    <asp:BoundField DataField="Nro_interno" HeaderText="n°int" />
                                    ...
                                    <asp:TemplateField HeaderText="Fecha" SortExpression="Fecha">
                                        <EditItemTemplate>
                                            &nbsp;&nbsp;
                                            <asp:Calendar ID="Calendar1" runat="server" SelectedDate='<%# Bind("[Fecha Comp_]") %>'>
                                            </asp:Calendar>
                                        </EditItemTemplate>
                                        <ControlStyle Width="100px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("[Fecha Comp_]", "{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
...
--%>
                                    ...
                                    <%-- <asp:BoundField DataField="Total ComprobantePrv" HeaderText="Total" />--%>
                                    <%--            <asp:BoundField DataField="Anulada" HeaderText="Anulada" />--%>
                                            ...
                                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderColor="#CCCCCC"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="left">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("Cuenta") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
