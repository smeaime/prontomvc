...
Imports EmpleadoesManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class empleados
    ...
    Function GenerarWHERE() As String
        ...
        '"Convert(CuentaOrden1, 'System.String') LIKE '*" & txtBuscar.Text & "*'" _
        '& " OR " & _
        '"Convert(empleado, 'System.String') LIKE '*" & txtBuscar.Text & "*'" _
        '& " OR " & _
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                'dr.Item("CodigoEmpleado") = IIf(TextoWebControl(.FindControl("txtNewCodigo")) = "", DBNull.Value, TextoWebControl(.FindControl("txtNewCodigo")))
                ...
                Try
                    ...
                    Dim emp As Pronto.ERP.BO.Empleado = New Pronto.ERP.BO.Empleado 'EmpleadoManager.GetItem(HFSC.Value, -1)
                    emp.Id = -1
                    emp.PuntoVentaAsociado = iisNull(TextoWebControl(.FindControl("txtNewCUIT")), 0)
                    emp.Email = iisNull(TextoWebControl(.FindControl("txtNewEmail")), "")
                    emp.UsuarioNT = iisNull(TextoWebControl(.FindControl("txtNewDireccion")), "")
                    emp.Nombre = iisNull(TextoWebControl(.FindControl("txtNewRazonSocial")), "")
                    EmpleadoManager.Save(HFSC.Value, emp)
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            'Dim dr = dt.Rows(0)
            'dr.Item("CodigoEmpleado") = TextoWebControl(.FindControl("txtCodigo"))
            ...
            Try
                Dim emp = EmpleadoManager.GetItem(HFSC.Value, Id)
                emp.PuntoVentaAsociado = iisNull(TextoWebControl(.FindControl("txtCUIT")), 0)
                emp.Email = iisNull(TextoWebControl(.FindControl("txtEmail")), "")
                emp.UsuarioNT = iisNull(TextoWebControl(.FindControl("txtDireccion")), "")
                emp.Nombre = iisNull(TextoWebControl(.FindControl("txtRazonSocial")), "")
                EmpleadoManager.Save(HFSC.Value, emp)
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        EmpleadoesManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    'Function generarNotasDeEntrega(ByVal FechaDesde As Date, ByVal FechaHasta As Date, ByVal PosicionODescarga As String, ByVal IdEmpleado As Integer, ByVal CuentaOrden1 As Integer, ByVal CuentaOrden2 As Integer, ByVal Corredor As Integer, ByVal IdEntregador As Integer, ByVal IdArticulo As Integer) As String
...
"           CTG as CTG " & _
                  " FROM CartasDePorte CDP " & _
                   " LEFT OUTER JOIN Clientes CLIVEN ON CDP.empleado = CLIVEN.IdCliente " & _
                   ...
                   " LEFT OUTER JOIN empleados CLICOR ON CDP.Corredor = CLICOR.IdEmpleado " & _
    ...
    iisIdValido(.Item("empleado"), "           AND CDP.empleado = " & .Item("empleado"), "") & _
    ...
    IIf(iisNull(.Item("EsPosicion"), False), "  AND FechaDescarga IS NULL ", " AND NOT FechaDescarga IS NULL ") & _
            ...
            '        Dim strWHERE = "    WHERE 1=1 " & _
            'IIf(IdEmpleado > 0, "           AND CDP.empleado = " & IdEmpleado, "") & _
...
Public Class EmpleadoesManager

    Const Tabla = "empleados"
    Const IdTabla = "IdEmpleado"
    ...
    Public Shared Function Validar(ByVal SC As String, ByVal dr As DataRow) As String
        With dr
            ...
            Dim id = EntidadManager.TablaSelectId(SC, Tabla, "REPLACE(CUIT,'-','')='" & .Item("CUIT").Replace("-", "") & "'   AND IdEmpleado<>'" & .Item(0) & "'")
            If id <> 0 Then
            ...
            'Dim ds As System.Data.DataSet = Pronto.ERP.Bll.EntidadManager.GetListTX(HFSC.Value, "empleados", "TX_PorCuit", TextoWebControl(.FindControl("txtNewCUIT")))
    ...
    Public Shared Function Fetch(ByVal SC As String) As DataTable
        ...
        'Return EntidadManager.GetListTX(SC, "empleados", "TT", Nothing).Tables(0)
        'Return EntidadManager.ExecDinamico(SC, "Empleadoes_TT")
        Return EntidadManager.ExecDinamico(SC, "select * from Empleados")
