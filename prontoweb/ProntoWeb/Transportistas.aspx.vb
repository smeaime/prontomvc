...
Imports TransportistasManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class Transportistas
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                dr.Item("RazonSocial") = TextoWebControl(.FindControl("txtNewRazonSocial"))
                ...
                dr.Item("IdPais") = 1
                dr.Item("IdCodigoIva") = 1
                dr.Item("IdProvincia") = 1
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("RazonSocial") = TextoWebControl(.FindControl("txtRazonSocial"))
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        Try
            TransportistasManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        Catch ex As Exception
            ErrHandler2.WriteError(ex)
            MsgBoxAjax(Me, "El transportista se está usando en una o más cartas porte")
            Return
        End Try
...
<Serializable()> Public Class Transportista
...
Public Class TransportistasManager

    Const Tabla = "Transportistas"
    Const IdTabla = "IdTransportista"
    ...
    Public Shared Function Validar(ByVal SC As String, ByVal dr As DataRow) As String
        With dr
            ...
            Dim sWhere = "REPLACE(CUIT,'-','')='" & .Item("CUIT").Replace("-", "") & "'   AND IdTransportista<>" & _c(.Item(0))
            Dim id = EntidadManager.TablaSelectId(SC, "Transportistas", sWhere)
            If id <> 0 Then
