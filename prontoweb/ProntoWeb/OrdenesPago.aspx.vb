...
Partial Class OrdenesPago
    ...
    Sub Imprimir(ByVal IdOrdenPago)
        ...
        output = ImprimirWordDOT(DirApp() & "\Documentos\" & "OrdenPago_PRONTO_0001.dot", Me, HFSC.Value, Session, Response, IdOrdenPago, mPrinter, mCopias, Args, System.IO.Path.GetTempPath & "OrdenPago.doc")
        Try
    ...
    Sub Permisos()
        'Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "OrdenesPago")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdOrdenPago As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("OrdenPago.aspx?Id={0}", IdOrdenPago.ToString))
        End Select
    End Sub

    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim gp As GridView = e.Row.Cells(getGridIDcolbyHeader("Valores", GridView1)).Controls(1) 'el indice de cell hay que cambiarlo si se agregan o quitan columnas...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.DetOrdenesPagoValores_TXOrdenPago, DataBinder.Eval(e.Row.DataItem, "IdOrdenPago"))
            gp.DataBind()
        End If
    End Sub
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("OrdenPago.aspx?Id=-1"))
    End Sub
    ...
    Sub Rebind()
        ...
        Dim dt As DataTable = EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.OrdenesPago_TXFecha, DateAdd(DateInterval.Year, -2, Now), Now, -1)
        ...
        'ordeno
        Dim b As Data.DataView = DataTableORDER(dt, "IdOrdenPago DESC")
