...
public class JQGridHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        ServicioCartaPorte.jqGridJson jsonData = a.CDPMovimientos_DynamicGridData(SC, sortColumnName, sortOrderBy, Convert.ToInt32(pageIndex), Convert.ToInt32(numberOfRows), isSearch == "true", filters );
