...
Partial Class Fertilizantes
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("Fertilizante.aspx?Id=-1"))
    ...
    Sub ReBindPrimeraPaginaConUltimasCreadas()
        ...
        Dim db As LinqCartasPorteDataContext = New LinqCartasPorteDataContext(Encriptar(HFSC.Value))
        ...
        Dim q = From c In db2.FertilizantesCupos
                Where c.NumeradorTexto.Contains(TextBox2.Text) Or TextBox2.Text = ""
                Order By c.FechaModificacion Descending
                Take 8
                Select New With {
                    .NumeradorTexto = c.NumeradorTexto, c.IdFertilizanteCupo, c.Cantidad, c.FechaModificacion, c.FechaIngreso, c.NumeroRemito,
                    .Cliente = If(c.Cliente1 Is Nothing, "", c.Cliente1.RazonSocial),
                    .Producto = If(c.Articulo Is Nothing, "", c.Articulo.Descripcion)
                   }
