...
Imports Pronto.ERP.Bll.DiccionarioEquivalenciasManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class DiccionarioEquivalencias
    ...
    Function GenerarWHERE() As String
        ...
        '"Convert(CuentaOrden1, 'System.String') LIKE '*" & txtBuscar.Text & "*'" _
        '& " OR " & _
        '"Convert(DiccionarioEquivalencia, 'System.String') LIKE '*" & txtBuscar.Text & "*'" _
        '& " OR " & _
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                'If TextoWebControl(.FindControl("txtNewRazonSocial")) = "" Then
                ...
                dr.Item("Palabra") = TextoWebControl(.FindControl("txtNewPalabra"))
                dr.Item("Traduccion") = TextoWebControl(.FindControl("txtNewTraduccion"))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            'Metodo con datatable
            Dim Id As Integer = GridView1.DataKeys(e.RowIndex).Values(0).ToString()
            ...
            dr.Item("Palabra") = TextoWebControl(.FindControl("txtPalabra"))
            dr.Item("Traduccion") = TextoWebControl(.FindControl("txtTraduccion"))
            ...
            'o.DiccionarioEquivalencia = BuscaIdClientePreciso(TextoWebControl(.FindControl("txtDiccionarioEquivalencia")), HFSC.Value)
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        DiccionarioEquivalenciasManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    'Function generarNotasDeEntrega(ByVal FechaDesde As Date, ByVal FechaHasta As Date, ByVal PosicionODescarga As String, ByVal IdDiccionarioEquivalencia As Integer, ByVal CuentaOrden1 As Integer, ByVal CuentaOrden2 As Integer, ByVal Corredor As Integer, ByVal IdEntregador As Integer, ByVal IdArticulo As Integer) As String
...
"           CTG as CTG " & _
                  " FROM CartasDePorte CDP " & _
                   " LEFT OUTER JOIN Clientes CLIVEN ON CDP.DiccionarioEquivalencia = CLIVEN.IdCliente " & _
                   ...
                   " LEFT OUTER JOIN DiccionarioEquivalencias CLICOR ON CDP.Corredor = CLICOR.IdDiccionarioEquivalencia " & _
    ...
    iisIdValido(.Item("DiccionarioEquivalencia"), "           AND CDP.DiccionarioEquivalencia = " & .Item("DiccionarioEquivalencia"), "") & _
    ...
    IIf(iisNull(.Item("EsPosicion"), False), "  AND FechaDescarga IS NULL ", " AND NOT FechaDescarga IS NULL ") & _
            ...
            '        Dim strWHERE = "    WHERE 1=1 " & _
            'IIf(IdDiccionarioEquivalencia > 0, "           AND CDP.DiccionarioEquivalencia = " & IdDiccionarioEquivalencia, "") & _
