...
Imports CDPEstablecimientosManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class CDPEstablecimientos
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        CDPEstablecimientosManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    Sub usarLinqToSql()
        ...
        'CDPEstablecimientos = From p In db.establecimientos
