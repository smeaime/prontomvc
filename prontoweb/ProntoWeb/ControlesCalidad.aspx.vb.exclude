...
Imports ControlesCalidadManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class ControlesCalidad
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ControlesCalidadManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    Sub usarLinqToSql()
        ...
        'ControlesCalidad = From p In db.establecimientos
...
<Serializable()> Public Class ControlCalidad
...
Public Class ControlesCalidadManager

    Const Tabla = "ControlesCalidad"
