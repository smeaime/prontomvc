...
Partial Class NotasDeDebito
    ...
    Protected Sub Imprimir(ByVal IdNotaDeDebito)
        ...
        output = ImprimirWordDOT(p, Me, HFSC.Value, Session, Response, IdNotaDeDebito, mvarClausula, mPrinter, mCopias, System.IO.Path.GetTempPath & "NotaDebito.doc")
        Try
    ...
    Sub Permisos()
        'Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "Notas de Crédito")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdNotaDeDebito As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("NotaDeDebito.aspx?Id={0}", IdNotaDeDebito.ToString))
        End Select
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, "DetNotasDebito_TXDeb", DataBinder.Eval(e.Row.DataItem, "Id"))
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("NotaDeDebito.aspx?Id=-1"))
    End Sub
    ...
    Sub Rebind()
        ...
        b.Sort = "[Fecha debito] DESC,Numero DESC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
