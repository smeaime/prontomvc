...
Partial Class Recibos
    ...
    Sub Imprimir(ByVal IdRecibo)
        ...
        output = ImprimirWordDOT(p, Me, HFSC.Value, Session, Response, IdRecibo, mvarClausula, mPrinter, mCopias, System.IO.Path.GetTempPath & "Recibo.doc", EmpresaSegunString, PathLogo)
        Try
    ...
    End Sub
    Sub Permisos()
        'Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "Recibos")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdRecibo As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("Recibo.aspx?Id={0}", IdRecibo.ToString))
        End Select
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, "DetRecibos_TXRecibo", DataBinder.Eval(e.Row.DataItem, "Id"))
            gp.DataBind()
        End If
    End Sub
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("Recibo.aspx?Id=-1"))
    End Sub
    ...
    Sub Rebind()
        ...
        'b.Sort = "[Fecha recibo] DESC,Numero DESC" ' e.SortExpression + " " + ConvertSortDirectionToSql(e.SortDirection)
        b.Sort = "Id DESC"
