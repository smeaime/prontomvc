...
Imports ObrasManager 'como la capa de negocios la tengo acá para debuguear en tiempo de ejecucion, la importo desde acá
...
Partial Class Obras
    ...
    Sub Permisos()
        Try
            Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, Session(SESSIONPRONTO_UserId), "Establecimientos")
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            If Not IsNothing(ac) Then ac.ContextKey = HFSC.Value
            ac = e.Row.FindControl("AutoCompleteExtender211")
            If Not IsNothing(ac) Then ac.ContextKey = HFSC.Value
        ...
        If (e.Row.RowType = DataControlRowType.Footer) Then
            ...
            ac.ContextKey = HFSC.Value
            'ac = e.Row.FindControl("AutoCompleteExtender122")
            'ac.ContextKey = HFSC.Value
    ...
    Function GenerarWHERE() As String
        ...
        '& " OR " & _
        '" EstablecimientoDesc LIKE '*" & txtBuscar.Text & "*'    )" ' _
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf (e.CommandName.Equals("Edit")) Then
            ...
            'Response.Redirect(String.Format("Obra.aspx?Id={0}", IdRequerimiento.ToString))
        ...
        ElseIf (e.CommandName.Equals("AddNew")) Then
            ...
            With r
                ...
                If TextoWebControl(.FindControl("txtNewDescripcion")) = "" Then
                    ...
                    Return
                End If
                If TextoWebControl(.FindControl("txtNewCliente")) = "" Then
                ...
                Dim dr = dt.NewRow
                dr.Item("NumeroObra") = TextoWebControl(.FindControl("txtNewNumeroObra"))
                ...
                'dr.Item("Codigo") = TextoWebControl(.FindControl("txtNewCodigo"))
                ' dr.Item("CUIT") = TextoWebControl(.FindControl("txtNewCUIT"))

                '   dr.Item("AuxiliarString1") = TextoWebControl(.FindControl("txtNewAuxiliar1"))
                '  dr.Item("AuxiliarString2") = TextoWebControl(.FindControl("txtNewAuxiliar2"))
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        ...
        With GridView1.Rows(e.RowIndex)
            ...
            dr.Item("NumeroObra") = TextoWebControl(.FindControl("txtNumeroObra"))
            ...
            'dr.Item("Codigo") = TextoWebControl(.FindControl("txtCodigoONCAA"))
            'dr.Item("CUIT") = TextoWebControl(.FindControl("txtCUIT"))


            'dr.Item("AuxiliarString1") = TextoWebControl(.FindControl("txtAuxiliar1"))
            'dr.Item("AuxiliarString2") = TextoWebControl(.FindControl("txtAuxiliar2"))
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("Obra.aspx?Id=-1"))
    End Sub
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ObrasManager.Delete(HFSC.Value, GridView1.DataKeys(e.RowIndex).Values(0).ToString())
        ReBind()
    End Sub
    ...
    '////////////////////////////////////////////////////////////////////////////////////////
    'Sub usarLinqToSql()
    '    'http://speakingin.net/2007/05/30/linq-to-sql-2%C2%AA-parte-definiendo-nuestras-clases-del-modelo-de-datos/

    '    'Dim db = New datac

    '    ' EntidadManager.RebindEstablecimientos(HFSC.Value)
    ...
    '    Dim db As New wDemoWilliamsModel.wDemoWilliamsEntities(reconstr)
    ...
    '    'Sectores = From p In db.establecimientos
    '    'From c In db.Clientes.Where(Function(i) i.IdCliente = e.IdCliente).DefaultIfEmpty _
    '    Dim establecimientos = From e In db.Obras _
    '                           Join c In db.Clientes On e.IdCliente Equals c.IdCliente _
    '                           Where e.Descripcion.Contains(txtBuscar.Text) Or txtBuscar.Text = "" _
    '                           Select e.IdObra, e.NumeroObra, e.Descripcion, e.TipoObra, c.RazonSocial

    '    'Dim establecimientos = From e In db.Obras _
    '    'Where(e.Descripcion.Contains(txtBuscar.Text))
    ...
    '    GridView1.DataSource = establecimientos
    '    GridView1.DataBind()
...
"         LOCDES.Descripcion   as  Establecimiento , " & _
...
"           CTG as CTG " & _
                  " FROM CartasDePorte CDP " & _
                   ...
                   " LEFT OUTER JOIN WilliamsEstablecimientos LOCDES ON CDP.Establecimiento = LOCDES.IdWilliamsEstablecimiento " & _
                "")
