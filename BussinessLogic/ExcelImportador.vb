...
Public Class ExcelImportadorManager
    ...
    Public Shared Function ImportacionComprobantesFondoFijo2(dt As DataTable, SC As String)
        ...
        Dim oCP = New ProntoMVC.Data.Models.ComprobanteProveedor
        ...
        Do While True
            ...
            If Len(Trim(dt.Rows(fl).Item(2))) > 0 Or Len(Trim(dt.Rows(fl).Item(3))) > 0 Or Len(Trim(dt.Rows(fl).Item(4))) > 0 Or
                ...
                If mIdCuentaFF = 0 Then
                    ...
                    End If
                    oForm.Label1 = mMensaje & vbCrLf & vbCrLf & "mCodigoCuentaFF " & dt.Rows(2).Item(10)
                ...
                If mFechaRecepcion > gblFechaUltimoCierre Then
                    ...
                    oRsAux1 = oAp.ComprobantesProveedores.TraerFiltrado("_PorNumeroComprobante", mIdProveedor, mLetra, mNumeroComprobante1, mNumeroComprobante2, -1, mIdTipoComprobante)
                    If oRsAux1.RecordCount = 0 Then
                        ...
                        Do While Len(Trim(dt.Rows(fl).Item(2))) > 0 And mLetra = Trim(dt.Rows(fl).Item(6)) And mNumeroComprobante1 = dt.Rows(fl).Item(7) And mNumeroComprobante2 = dt.Rows(fl).Item(8) And
                            ...
                            If Len(mCodigoCuentaGasto) > 0 Then
                                ...
                                If oRsAux1.RecordCount > 0 Then
                                    ...
                                    oRsAux1.Close
                                    oRsAux1 = oAp.Cuentas.TraerFiltrado("_PorObraCuentaGasto", mIdObra, mIdCuentaGasto)
                                    If oRsAux1.RecordCount > 0 Then
                                        ...
                                        If mIdRubroContable = 0 And Not IsNull(oRsAux1.CodigoRubroContable) Then
                                            'oRsAux2 = Aplicacion.RubrosContables.TraerFiltrado("_PorCodigo", oRsAux1.CodigoRubroContable, mIdObra, "SI")
                            ...
                            If Len(mItemPresupuestoObrasNodo) > 0 Then
                                'oRsAux1 = Aplicacion.PresupuestoObrasNodos.TraerFiltrado("_PorItem", mItemPresupuestoObrasNodo, mIdObra)
