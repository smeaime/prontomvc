...
Namespace Pronto.ERP.Bll
    ...
    Public Class CtaCteDeudorManager
        Inherits ServicedComponent


        Const Tabla = "CuentasCorrientesDeudores"
...
Public Shared Function GetList(ByVal SC As String) As NotaDeDebitoList
        ...
        Public Shared Function GetListDataset(ByVal SC As String) As System.Data.DataSet
            ...
            Try
                ds = GeneralDB.TraerDatos(SC, "CtasCtesD_TX_TT", -1, -1)
            Catch ex As Exception
                ds = GeneralDB.TraerDatos(SC, "CtasCtesD_TT")
            End Try
        ...
        Public Shared Function Saldo(ByVal SC As String, ByVal IdCliente As Long, Optional ByVal IdMoneda As Long = 1) As Double
            ...
            If IdMoneda = 1 Then
                dt = EntidadManager.TraerFiltrado(SC, enumSPs.CtasCtesD_TXTotal, IdCliente, -1, #1/1/2100#, -1)
            Else
                dt = EntidadManager.TraerFiltrado(SC, enumSPs.CtasCtesD_TXTotal_Dolares, IdCliente, -1, #1/1/2100#)
            End If
        ...
        Public Shared Function GetListTX(ByVal SC As String, ByVal TX As String, ByVal ParamArray Parametros() As Object) As System.Data.DataSet
            ...
            ' Try
            'ds = GeneralDB.TraerDatos(SC, "wCtasCtesD_TX" & TX, Parametros)
            ' Catch ex As Exception
            ds = GeneralDB.TraerDatos(SC, "CtasCtesD_TX" & TX, Parametros)
            ' End Try
            ds.Tables(0).Columns.Add(dc)
            Return ds
        End Function
