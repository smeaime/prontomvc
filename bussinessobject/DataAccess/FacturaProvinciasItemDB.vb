...
Namespace Pronto.ERP.Dal
    ...
    Public Class FacturaProvinciasItemDB
        ...
        Public Shared Function GetList(ByVal SC As String, ByVal IdFactura As Integer) As FacturaItemList
            ...
            Dim myConnection As SqlConnection = New SqlConnection(encriptar(SC))
            Try
                Dim myCommand As SqlCommand = New SqlCommand("DetFacturaProvincia_TX_PorIdCabecera", myConnection)
                myCommand.CommandType = CommandType.StoredProcedure
        ...
        Public Shared Function Save(ByVal SC As String, ByVal myFacturaItem As FacturaProvinciasItem) As Integer
                ...
                If Not .Eliminado Then
                    ...
                    Try
                        ...
                        If .Nuevo Then
                            ...
                            myCommand = New SqlCommand("DetFacturasProvincias_A", myConnection)
                            myCommand.CommandType = CommandType.StoredProcedure

                            Dim param As SqlParameter = myCommand.Parameters.AddWithValue("@IdDetalleFacturaProvincias", -1)
                            param.Direction = ParameterDirection.Output

                        Else

                            myCommand = New SqlCommand("DetFacturasProvincias_M", myConnection)
                            myCommand.CommandType = CommandType.StoredProcedure

                            myCommand.Parameters.AddWithValue("@IdDetalleFacturaProvincias", .Id)
                        End If
