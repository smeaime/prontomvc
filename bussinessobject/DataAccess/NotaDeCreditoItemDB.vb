...
Namespace Pronto.ERP.Dal
    ...
    Public Class NotaDeCreditoItemDB
        ...
        Public Shared Function GetList(ByVal SC As String, ByVal IdNotaDeCredito As Integer) As NotaDeCreditoItemList
            ...
            Dim myConnection As SqlConnection = New SqlConnection(encriptar(SC))
            Try
                Dim myCommand As SqlCommand = New SqlCommand("DetNotasCredito_TX_PorIdCabecera", myConnection)
                myCommand.CommandType = CommandType.StoredProcedure
        ...
        Public Shared Function Save(ByVal SC As String, ByVal myNotaDeCreditoItem As NotaDeCreditoItem) As Integer
                ...
                If Not .Eliminado Then
                    ...
                    Try
                        ...
                        If .Nuevo Then
                            ...
                            Dim param As SqlParameter = myCommand.Parameters.AddWithValue("@IdDetalleNotaCredito", -1)
                        ...
                        Else
                            ...
                            myCommand.Parameters.AddWithValue("@IdDetalleNotaCredito", .Id)
                        End If
