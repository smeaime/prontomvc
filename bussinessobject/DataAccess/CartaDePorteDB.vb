        ...
        Public Shared Function Save(ByVal SC As String, ByVal myCartaDePorte As CartaDePorte) As Integer
            ...
            With myCartaDePorte
                Try
                    ...
                    myCommand.Parameters.AddWithValue("@NetoProc", myCartaDePorte.NetoProc)
                    ...
                    myCommand.Parameters.AddWithValue("@NetoFinal", myCartaDePorte.NetoFinal)
            ...
            Try
                With myCartaDePorte
                    ...
                    If Not myDataRecord.IsDBNull(myDataRecord.GetOrdinal("NetoProc")) Then
                        myCartaDePorte.NetoProc = myDataRecord.GetDecimal(myDataRecord.GetOrdinal("NetoProc"))
                    End If
                    ...
                    If Not myDataRecord.IsDBNull(myDataRecord.GetOrdinal("NetoFinal")) Then
                        myCartaDePorte.NetoFinal = myDataRecord.GetDecimal(myDataRecord.GetOrdinal("NetoFinal"))
                    End If
                    ...
                    End If
                    If Not myDataRecord.IsDBNull(myDataRecord.GetOrdinal("TransportistaCUIT")) Then
                        myCartaDePorte.TransportistaCUIT = myDataRecord.GetString(myDataRecord.GetOrdinal("TransportistaCUIT"))
                    End If
                    If Not myDataRecord.IsDBNull(myDataRecord.GetOrdinal("ChoferCUIT")) Then
                        myCartaDePorte.ChoferCUIT = myDataRecord.GetString(myDataRecord.GetOrdinal("ChoferCUIT"))
                    End If
