...
Namespace Pronto.ERP.BO
    ...
    <Serializable()> Public Class RemitoItem
        Private _Id As Integer = -1
        Private _Idremito As Integer = -1
        ...
        Public Partida As String = String.Empty
        Public DescargaPorKit As String = String.Empty
        Public NumeroCaja As Integer = 0
