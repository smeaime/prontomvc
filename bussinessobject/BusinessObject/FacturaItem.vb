...
Namespace Pronto.ERP.BO
    ...
    <Serializable()> Public Class FacturaItem
        Private _Id As Integer = -1
        Private _IdFactura As Integer = -1
        ...
        Private _Precio As Double = 0   'Ehhhh? No puedo hacer bind desde la grilla a esto porque no tiene property???? http://www.mikepope.com/blog/AddComment.aspx?blogid=1419
        Private _PrecioUnitarioTotal As Double = 0
        ...
        Public NumeroFactura As Long = 0
        ...
        Public ParteDolar As Double = 0
        Public PartePesos As Double = 0
        Public PorcentajeCertificacion As Double = 0
        Public TipoCancelacion As Integer = 0
        Public NotaAclaracion As String = String.Empty
        Public EnviarEmail As String = String.Empty
        Public IdFacturaOriginal As Integer = 0
        Public IdDetalleFacturaOriginal As Integer = 0
