...
Namespace Pronto.ERP.BO
    ...
    <Serializable()> Public Class Requerimiento
        ...
        Private _TipoRequerimiento As String = String.Empty
        ...
        Private _Detalles As RequerimientoItemList = New RequerimientoItemList
        ...
        Public Property Detalles() As RequerimientoItemList
            Get
                Return _Detalles
            End Get
            Set(ByVal value As RequerimientoItemList)
                _Detalles = value
            End Set
        End Property


        Public Function BuscarRenglonPorIdDetalle(ByVal id As Integer) As RequerimientoItem
