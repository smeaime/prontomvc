...
Namespace Pronto.ERP.BO
    ...
    <Serializable()> Public Class Remito
        ...
        Private _IdRemitoOriginal As Integer = 0
        ...
        Private _TipoRemito As String = String.Empty
        ...
        Private _Detalles As RemitoItemList = New RemitoItemList
        ...
        Public __COMPRONTO_Remito 'As ComPronto.Remito
        ...
        '    Get
        '        Return __COMPRONTO_Remito.Registro.Fields("NumeroRemito").Value
        '    End Get
        '    Set(ByVal value As Integer)
        '        __COMPRONTO_Remito.Registro.Fields("NumeroRemito").Value = value
        '    End Set
        'End Property
        ...
        Public Property IdRemitoOriginal() As Integer
            Get
                Return _IdRemitoOriginal
            End Get
            Set(ByVal value As Integer)
                _IdRemitoOriginal = value
            End Set
        End Property
        ...
        Public Property TipoRemito() As String
            Get
                Return _TipoRemito
            End Get
            Set(ByVal value As String)
        ...
        Public Property Detalles() As RemitoItemList
            Get
                Return _Detalles
            End Get
            Set(ByVal value As RemitoItemList)
                _Detalles = value
            End Set
        End Property


        Public Function BuscarRenglonPorIdDetalle(ByVal id As Integer) As RemitoItem
