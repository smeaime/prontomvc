...
Namespace Pronto.ERP.Dal
    ...
    Public Class FacturaRemitosItemDB
        ...
        Public Shared Function GetList(ByVal SC As String, ByVal IdFactura As Integer) As FacturaItemList
            ...
            Dim myConnection As SqlConnection = New SqlConnection(encriptar(SC))
            Try
                Dim myCommand As SqlCommand = New SqlCommand("DetFacturaRemito_TX_PorIdCabecera", myConnection)
                myCommand.CommandType = CommandType.StoredProcedure
        ...
        Public Shared Function Save(ByVal SC As String, ByVal myFacturaItem As FacturaRemitosItem) As Integer
                ...
                If Not .Eliminado Then
                    ...
                    Try
                        ...
                        If .Nuevo Then
                            ...
                            myCommand = New SqlCommand("DetFacturasRemitos_A", myConnection)
                            myCommand.CommandType = CommandType.StoredProcedure

                            Dim param As SqlParameter = myCommand.Parameters.AddWithValue("@IdDetalleFacturaRemitos", -1)
                            param.Direction = ParameterDirection.Output

                        Else

                            myCommand = New SqlCommand("DetFacturasRemitos_M", myConnection)
                            myCommand.CommandType = CommandType.StoredProcedure

                            myCommand.Parameters.AddWithValue("@IdDetalleFacturaRemitos", .Id)
                        End If
