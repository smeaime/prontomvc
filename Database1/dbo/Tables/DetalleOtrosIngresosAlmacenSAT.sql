CREATE TABLE [dbo].[DetalleOtrosIngresosAlmacenSAT] (
    ...
    CONSTRAINT [PK_DetalleOtrosIngresosAlmacenSAT] PRIMARY KEY CLUSTERED ([IdDetalleOtroIngresoAlmacen] ASC) WITH (FILLFACTOR = 90)
);
