CREATE TABLE [dbo].[NotasCredito] (
    ...
    CONSTRAINT [PK_NotasCredito] PRIMARY KEY NONCLUSTERED ([IdNotaCredito] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_NotasCredito_Clientes] FOREIGN KEY ([IdCliente]) REFERENCES [dbo].[Clientes] ([IdCliente])
);


GO
CREATE NONCLUSTERED INDEX [Indice1]
    ON [dbo].[NotasCredito]([FechaNotaCredito] ASC, [IdNotaCredito] ASC) WITH (FILLFACTOR = 90);
