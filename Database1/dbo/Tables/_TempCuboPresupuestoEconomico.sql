CREATE TABLE [dbo].[_TempCuboPresupuestoEconomico] (
    [IdPresupuestoEconomico]  INT             IDENTITY (1, 1) NOT NULL,
    ...
    [TotalPresupuestoTeorico] NUMERIC (18, 2) NULL,
    [TotalSaldo]              NUMERIC (18, 2) NULL,
    CONSTRAINT [PK__TempCuboPresupuestoEconomico] PRIMARY KEY CLUSTERED ([IdPresupuestoEconomico] ASC) WITH (FILLFACTOR = 90)
);
