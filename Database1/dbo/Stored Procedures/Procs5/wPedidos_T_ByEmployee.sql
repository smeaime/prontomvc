...
CREATE Procedure [dbo].[wPedidos_T_ByEmployee]
...
DECLARE @ActivarSolicitudMateriales varchar(2), @FechaInicial datetime
...
INSERT INTO #Auxiliar1 
 ...
 WHERE Requerimientos.IdSolicito = @IdSolicito and Requerimientos.FechaRequerimiento>=@FechaInicial
