...
INSERT INTO #Auxiliar1 
 ...
 WHERE (@IdRequerimiento=-1 or DetReq.IdRequerimiento=@IdRequerimiento) and Requerimientos.IdSolicito = @IdSolicito and Requerimientos.Cumplido <> 'AN'
...
WHERE (@IdRequerimiento=-1 or Requerimientos.IdRequerimiento=@IdRequerimiento) and 
	(Confirmado is null or Confirmado<>'NO') And Requerimientos.IdSolicito = @IdSolicito and Requerimientos.Cumplido <> 'AN'
