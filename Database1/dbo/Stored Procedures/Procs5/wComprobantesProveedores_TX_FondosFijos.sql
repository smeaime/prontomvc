...
CREATE Procedure [dbo].[wComprobantesProveedores_TX_FondosFijos]
@IdObra int=null
AS 
...
WHERE (Cab.IdProveedor is null and Cab.IdCuenta is not null) 
		and (@IdObra=-1 or @IdObra=Cab.IdObra)
