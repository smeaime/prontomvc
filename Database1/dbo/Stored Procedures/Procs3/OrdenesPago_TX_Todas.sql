CREATE  Procedure [dbo].[OrdenesPago_TX_Todas]
...
SET @vector_X='0011111111166666666666161111151111111111111133'
SET @vector_T='0049041222133333232333622050551434522520005500'
...
SELECT 
 ...
 IsNull((Select Top 1 dc.NombreAnterior From DetalleCuentas dc Where dc.IdCuenta=Cuentas.IdCuenta and dc.FechaCambio>op.FechaOrdenPago Order By dc.FechaCambio),Cuentas.Descripcion) AS [Cuenta],
