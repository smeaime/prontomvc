...
CREATE PROCEDURE [dbo].[InformeDeDiario_TX_2_Resumido_Modelo2]
...
Set @vector_X='000000011166133'
Set @vector_T='000000042344900'
...
SELECT
 ...
 Substring(IsNull(#Auxiliar1.Detalle,'')+' '+IsNull(#Auxiliar1.Concepto,''),1,100) as [Detalle],
 Null as [Debe],
 Null as [Haber],
...
GROUP BY #Auxiliar1.Fecha, #Auxiliar1.Tipo, #Auxiliar1.Asiento, 
	...
	#Auxiliar1.Concepto, #Auxiliar1.Detalle, #Auxiliar1.Comprobante
