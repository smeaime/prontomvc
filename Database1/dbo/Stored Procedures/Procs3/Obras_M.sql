...
SET 
 ...
 EsPlantaDeProduccionInterna=@EsPlantaDeProduccionInterna,
 ActivarPresupuestoObra=@ActivarPresupuestoObra,
 ProximoNumeroAutorizacionCompra=@ProximoNumeroAutorizacionCompra,
 AuxiliarDeMateriales=@AuxiliarDeMateriales,
 DiasLiquidacionCertificados=@DiasLiquidacionCertificados,
 IdObraRelacionada=@IdObraRelacionada,
 OrdenamientoSecundario=@OrdenamientoSecundario
WHERE (IdObra=@IdObra)
