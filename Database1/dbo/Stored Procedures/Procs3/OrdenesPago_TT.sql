CREATE  Procedure [dbo].[OrdenesPago_TT]
...
SET @vector_T='004904122213333323233362205055143452222552224400'
...
SELECT 
 ...
 Case When op.Anulada='SI' Then 'Anulada' Else Case When op.Estado='CA' Then 'En caja' When op.Estado='FI' Then 'A la firma' When op.Estado='EN' Then 'Entregado' When op.Estado='CO' Then 'Caja obra' Else '' End
 End as [Estado],
 ...
 (Select Top 1 o.NumeroOrdenPago From OrdenesPago o Where o.IdOrdenPago=op.IdOPComplementariaFF) as [OP complem. FF],
...
WHERE (op.Confirmado is null or op.Confirmado<>'NO') and 
