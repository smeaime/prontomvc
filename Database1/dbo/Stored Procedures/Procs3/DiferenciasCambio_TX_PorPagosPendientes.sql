...
CREATE Procedure [dbo].[DiferenciasCambio_TX_PorPagosPendientes]
...
WHERE DiferenciasCambio.Estado is null and 
	...
	(op.CotizacionDolar-cp.CotizacionDolar) is not null and (op.CotizacionDolar-cp.CotizacionDolar)<>0 
