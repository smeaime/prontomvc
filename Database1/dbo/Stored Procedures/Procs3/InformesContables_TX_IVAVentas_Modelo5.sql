CREATE PROCEDURE [dbo].[InformesContables_TX_IVAVentas_Modelo5]
...
SET @vector_E=' FON:8,CEN | FON:8,CEN |  FON:8,LEF | FON:8,CEN | FON:8,CEN | FON:8,NUM:#COMMA##0.00 |'+
		' FON:8,NUM:#COMMA##0.00 | FON:8,NUM:#COMMA##0.00 | FON:8,NUM:#COMMA##0.00 | FON:8,NUM:#COMMA##0.00 |'+
		' FON:8,NUM:#COMMA##0.00 | FON:8,NUM:#COMMA##0.00 '
SET @vector_E1=' ANC:10,FON:8,CEN | ANC:16,FON:8,CEN | ANC:35,FON:8,LEF | ANC:18,FON:8,CEN |'+
		' ANC:13,FON:8,CEN | ANC:10,FON:8,NUM:#COMMA##0.00 | ANC:10,FON:8,NUM:#COMMA##0.00 | ANC:10,FON:8,NUM:#COMMA##0.00 |'+
		' ANC:6,FON:8,NUM:#COMMA##0.00 | ANC:10,FON:8,NUM:#COMMA##0.00 | ANC:10,FON:8,NUM:#COMMA##0.00 | ANC:10,FON:8,NUM:#COMMA##0.00 '
IF @IdCtaAdicCol1>0
    BEGIN
