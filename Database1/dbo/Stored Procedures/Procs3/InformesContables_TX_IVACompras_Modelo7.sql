CREATE PROCEDURE [dbo].[InformesContables_TX_IVACompras_Modelo7]
...
/*
	Modelo similar al 0, pero cuando un comprobante tiene mas de una alicuota de iva, repite todo el renglon (para filtrar en excel) - VialAgro
*/
...
INSERT INTO #Auxiliar 
 SELECT 
	...
	Case When #Auxiliar2.A_MostrarTodo<=3 Then cp.FechaRecepcion Else Null End,
	Case When #Auxiliar2.A_MostrarTodo<=3 Then cp.FechaComprobante Else Null End,
	Case When #Auxiliar2.A_MostrarTodo<=3 
		...
		Else Null 
	End,
	Case When #Auxiliar2.A_MostrarTodo<=3 Then TiposComprobante.DescripcionAb Else Null End,
...
--		Else Null--	End,
	Case When #Auxiliar2.A_MostrarTodo<=3 
		...
		Else Null 
	End,
	Case When #Auxiliar2.A_MostrarTodo<=3 Then Case When cp.IdProveedor is not null Then Proveedores.Cuit Else IsNull((Select Top 1 P.Cuit From Proveedores P Where P.IdProveedor=cp.IdProveedorEventual),cp.Cuit) End Else Null End,
	...
	Case When #Auxiliar2.A_MostrarTodo<=3 Then IsNull(cp.NumeroCAI,IsNull(cp.NumeroCAE,'')) Else Null End
 FROM #Auxiliar2
