CREATE Procedure [dbo].[Facturas_TX_TT_Contado]
...
SET @vector_T='00912114F55544442512670335100'
...
SELECT 
 ...
 (Select Count(*) From DetalleFacturas df Where df.IdFactura=Facturas.IdFactura and Patindex('%'+Convert(varchar,df.IdArticulo)+'%', '')<>0) as [Cant.Abonos],
