CREATE PROCEDURE [dbo].[InformesContables_TX_IVAVentas]
...
INSERT INTO #Auxiliar0 
 ...
 UNION ALL
/* Codigo agregado por Fernando el 29-04-2014 para agregar la Obra en las Notas de credito */
...
SELECT 
 ...
 WHERE Cre.IdObra is not null and 
 ...
 UNION ALL
 /*FIn de Codigo Agregado por Fernando*/
 SELECT 
  'NC',
  Cre.IdNotaCredito,
  OrdenesCompra.IdObra
...
INSERT INTO #Auxiliar 
 ...
 SELECT 
	...
	Cuentas.Codigo,
	Case When Len(IsNull(Fac.Cliente,''))>0 Then Fac.Cliente COLLATE Modern_Spanish_CI_AS Else Cli.RazonSocial End,
	DescripcionIva.Descripcion,
	Case When Len(IsNull(Fac.CuitClienteExterno,''))>0 Then Fac.CuitClienteExterno COLLATE Modern_Spanish_CI_AS Else Cli.Cuit End,
	...
	End,
	Case When Fac.TipoABC='E' or IsNull(Fac.IdCodigoIva,Cli.IdCodigoIva)=8 or IsNull(Fac.IdCodigoIva,Cli.IdCodigoIva)=9 or (Fac.PorcentajeIva1=0 and IsNull(Fac.AjusteIva,0)=0)
...
UNION ALL 
 ...
 SELECT 
	...
	End * -1,
	Case When Dev.TipoABC='E' or IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)=8 or IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)=9 or Dev.PorcentajeIva1=0
		...
		Else IsNull(Dev.OtrasPercepciones1,0) + IsNull(Dev.OtrasPercepciones2,0)
	End * -1,
	...
	End,
	Case When Dev.TipoABC='B' and IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)<>8 and IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)<>9 and Dev.PorcentajeIva1<>0 
		 Then ((Dev.ImporteTotal - Dev.RetencionIBrutos1 - Dev.RetencionIBrutos2 - Dev.RetencionIBrutos3 - IsNull(Dev.OtrasPercepciones1,0) - 
			IsNull(Dev.OtrasPercepciones2,0) - IsNull(Dev.PercepcionIVA,0)) / (1+(Dev.PorcentajeIva1/100)) * (Dev.PorcentajeIva1 / 100)) * Dev.CotizacionMoneda
		When Dev.TipoABC='E' or IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)=8 or IsNull(Dev.IdCodigoIva,Cli.IdCodigoIva)=9 or Dev.PorcentajeIva1=0 
		 Then 0
		Else (Dev.ImporteIva1 + Dev.ImporteIva2) * Dev.CotizacionMoneda
	End * -1,
	(Dev.RetencionIBrutos1 + Dev.RetencionIBrutos2 + Dev.RetencionIBrutos3) * Dev.CotizacionMoneda * -1,
	IsNull(Dev.PercepcionIVA,0) * Dev.CotizacionMoneda * -1,
