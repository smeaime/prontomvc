CREATE PROCEDURE [dbo].[InformesContables_TX_IVAVentas_Modelo4]
...
INSERT INTO #Auxiliar0 
 SELECT 
  'FA',
  dfoc.IdFactura,
  IsNull(Fac.IdObra,OrdenesCompra.IdObra)
 ...
 SELECT 
  'FA',
  DetFacRem.IdFactura,
  IsNull(Fac.IdObra,DetalleRemitos.IdObra)
...
CREATE TABLE #Auxiliar 
			(
			 ...
			 A_Tasa NUMERIC(6, 2),
			 A_Iva NUMERIC(18, 2),
			 A_PercepcionIIBB NUMERIC(18, 2),
			 A_PercepcionIIBBCap NUMERIC(18, 2),
...
INSERT INTO #Auxiliar 
 ...
 SELECT 
	...
	End,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)<>3 Then IsNull(Fac.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)<>3 Then IsNull(Fac.RetencionIBrutos2,0) Else 0 End +
		Case When IsNull(IIBB3.IdProvinciaReal,IIBB3.IdProvincia)<>3 Then IsNull(Fac.RetencionIBrutos3,0) Else 0 End) * Fac.CotizacionMoneda,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)=3 Then IsNull(Fac.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)=3 Then IsNull(Fac.RetencionIBrutos2,0) Else 0 End +
		Case When IsNull(IIBB3.IdProvinciaReal,IIBB3.IdProvincia)=3 Then IsNull(Fac.RetencionIBrutos3,0) Else 0 End) * Fac.CotizacionMoneda,
	IsNull(Fac.PercepcionIVA,0) * Fac.CotizacionMoneda,
 ...
 LEFT OUTER JOIN IBCondiciones IIBB1 ON IIBB1.IdIBCondicion=Fac.IdIBCondicion
 LEFT OUTER JOIN IBCondiciones IIBB2 ON IIBB2.IdIBCondicion=Fac.IdIBCondicion2
 LEFT OUTER JOIN IBCondiciones IIBB3 ON IIBB3.IdIBCondicion=Fac.IdIBCondicion3
...
UNION ALL 
 ...
 SELECT 
	...
	End,
	Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)<>3 
		Then IsNull(Dev.RetencionIBrutos1,0)+IsNull(Dev.RetencionIBrutos2,0)+IsNull(Dev.RetencionIBrutos3,0) 
		Else 0 
	End * Dev.CotizacionMoneda * -1,
	Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)=3 Then IsNull(Dev.RetencionIBrutos1,0) Else 0 End * Dev.CotizacionMoneda,
	0,
 ...
 LEFT OUTER JOIN IBCondiciones IIBB1 ON IIBB1.IdIBCondicion=Dev.IdIBCondicion
...
UNION ALL 
 ...
 SELECT 
	...
	End,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)<>3 Then IsNull(Deb.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)<>3 Then IsNull(Deb.RetencionIBrutos2,0) Else 0 End + 
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)<>3 Then IsNull(Deb.RetencionIBrutos3,0) Else 0 End) * Deb.CotizacionMoneda,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)=3 Then IsNull(Deb.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)=3 Then IsNull(Deb.RetencionIBrutos2,0) Else 0 End + 
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)=3 Then IsNull(Deb.RetencionIBrutos3,0) Else 0 End) * Deb.CotizacionMoneda,
 ...
 LEFT OUTER JOIN IBCondiciones IIBB1 ON IIBB1.IdIBCondicion=Deb.IdIBCondicion
 LEFT OUTER JOIN IBCondiciones IIBB2 ON IIBB2.IdIBCondicion=Deb.IdIBCondicion2
...
UNION ALL 
 ...
 SELECT 
	...
	End,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)<>3 Then IsNull(Cre.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)<>3 Then IsNull(Cre.RetencionIBrutos2,0) Else 0 End + 
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)<>3 Then IsNull(Cre.RetencionIBrutos3,0) Else 0 End) * Cre.CotizacionMoneda * -1,
	(Case When IsNull(IIBB1.IdProvinciaReal,IIBB1.IdProvincia)=3 Then IsNull(Cre.RetencionIBrutos1,0) Else 0 End +
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)=3 Then IsNull(Cre.RetencionIBrutos2,0) Else 0 End + 
		Case When IsNull(IIBB2.IdProvinciaReal,IIBB2.IdProvincia)=3 Then IsNull(Cre.RetencionIBrutos3,0) Else 0 End) * Cre.CotizacionMoneda * -1,
 ...
 LEFT OUTER JOIN IBCondiciones IIBB1 ON IIBB1.IdIBCondicion=Cre.IdIBCondicion
 LEFT OUTER JOIN IBCondiciones IIBB2 ON IIBB2.IdIBCondicion=Cre.IdIBCondicion2
...
UPDATE #Auxiliar
SET A_PercepcionIIBB=0
WHERE A_PercepcionIIBB IS NULL

UPDATE #Auxiliar
SET A_PercepcionIIBBCap=0
WHERE A_PercepcionIIBBCap IS NULL
...
SET @vector_X='00001111111166166666133'
SET @vector_T='00009472621533033333900'
...
SELECT 
 ...
 Case When A_PercepcionIIBB<>0 then A_PercepcionIIBB Else Null End as [Perc.I.B.],
 Case When A_PercepcionIIBBCap<>0 then A_PercepcionIIBBCap Else Null End as [Perc.I.B.Cap],
...
SELECT 
 ...
 SUM(A_PercepcionIIBB) as [Perc.I.B.],
 SUM(A_PercepcionIIBBCap) as [Perc.I.B.Cap],
 SUM(A_Total) as [Total compr.],
 @Vector_E as Vector_E,
 @Vector_T as Vector_T,
 @Vector_X as Vector_X
