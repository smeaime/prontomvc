...
CREATE Procedure [dbo].[Ganancias_TX_Desarrollo]
...
INSERT INTO #Auxiliar 
 ...
 SELECT 
	0, 
	'Fecha de calculo : '+Convert(varchar,@Fecha,103),
	Null
...
UNION ALL 
 ...
 SELECT 
	0, 
	'Mas '+Convert(varchar,@PorcentajeAdicional)+'% sobre excedente de '+
	Convert(varchar,@TotalAcumulado-@Desde),
	@Excedente
...
SELECT 
 A_Id,
 A_Descripcion as [Detalle],
 A_Importe as [Importe]
FROM #Auxiliar
