CREATE PROCEDURE [dbo].[InformesContables_TX_IVAVentas_Modelo2]
...
SELECT 
 0 as [IdReg],
 A_Fecha as [K_Fecha],
 A_Comprobante as [K_Comprobante],
 '1' as [K_Orden],
 A_Fecha as [Fecha],
 A_Cliente as [Razon social],
 A_Cuit as [CUIT],
 A_Comprobante as [Comprobante],
 A_Total as [Total],
 A_NetoGravado as [Neto gravado],
 A_NetoNoGravado as [No gravado],
 A_Iva as [IVA],
 Null [Iva n/Ins],
...
SELECT 
 ...
 Null as [CUIT],
 Null as [Comprobante],
 A_Percepcion as [Total],
 A_PercepcionIVA as [Neto gravado],
 Null as [No gravado],
 Null as [IVA],
 Null [Iva n/Ins],
 @Vector_E as Vector_E,
 ...
 @Vector_X as Vector_X
FROM #Auxiliar 
WHERE IsNull(A_Percepcion,0)<>0 or IsNull(A_PercepcionIVA,0)<>0
...
SELECT 
 ...
 '3' as [K_Orden],
 Null as [Fecha],
 'TOT. '+Convert(varchar,A_Fecha,103) as [Razon social],
 Null as [CUIT],
 Null as [Comprobante],
 SUM(Isnull(A_Total,0)) as [Total],
 SUM(Isnull(A_NetoGravado,0)) as [Neto gravado],
 SUM(Isnull(A_NetoNoGravado,0)) as [No gravado],
...
SELECT 
 ...
 Null as [CUIT],
 Null as [Comprobante],
 SUM(Isnull(A_Percepcion,0)) as [Total],
 SUM(Isnull(A_PercepcionIVA,0)) as [Neto gravado],
 Null as [No gravado],
 Null as [IVA],
 Null [Iva n/Ins],
 @Vector_E as Vector_E,
...
SELECT 
 ...
 '6' as [K_Orden],
 Null as [Fecha],
 'TOTALES GENERALES' as [Razon social],
 Null as [CUIT],
 Null as [Comprobante],
 SUM(Isnull(A_Total,0)) as [Total],
 SUM(Isnull(A_NetoGravado,0)) as [Neto gravado],
...
SELECT 
 ...
 '9' as [K_Orden],
 Null as [Fecha],
 'TOTAL IVA '+CONVERT(varchar,A_Tasa)+'%' as [Razon social],
 Null as [CUIT],
 Null as [Comprobante],
 Null as [Total],
 SUM(Isnull(A_NetoGravado,0)) as [Neto gravado],
...
SELECT 
 ...
 'B' as [K_Orden],
 Null as [Fecha],
 'TOTAL '+A_CondicionIVA as [Razon social],
 Null as [CUIT],
 Null as [Comprobante],
 Null as [Total],
 SUM(Isnull(A_NetoGravado,0)) as [Neto gravado],
...
SELECT 
 ...
 Null as [IVA],
 Null [Iva n/Ins],
 ' EBH, VAL:1;5;Importe Total;Percep.I.B., VAL:1;6;Neto Gravado;Percep.IVA, '+
	' VAL:1;7;Ex./N.Grav/N.Ins;Imp.Interno, VAL:1;8;IVA;Ret.IVA, '+
	' FN3:10, AN2:2;37, AN2:3;13, AN2:4;20, AN2:5;12, FN2:5;8, AN2:6;12, FN2:6;8, AN2:7;12, FN2:7;8, '+
	' AN2:8;12, FN2:8;8, AN2:9;6, FN2:9;8, CO2:0 ' as Vector_E,
 @Vector_T as Vector_T,
 @Vector_X as Vector_X

ORDER By [K_Fecha], [K_Orden], [K_Comprobante], [Comprobante] DESC
