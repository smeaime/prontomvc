CREATE PROCEDURE [dbo].[InformeDeDiario_TX_2_Modelo5]
...
-- Este es igual al modelo InformeDeDiario_TX_2 con la diferencia que mando en formato LEGAL en el parametro SIZ
...
INSERT INTO #Auxiliar3 
 SELECT 
  Cuentas.IdCuenta,
  (Select Top 1 CuentasGastos.IdCuentaMadre From CuentasGastos Where CuentasGastos.IdCuentaGasto=Cuentas.IdCuentaGasto)
 FROM Cuentas 
...
FROM #Auxiliar2
GROUP BY Fecha, TipoAsiento, Asiento, IdTipoComprobante, 
	 IdComprobante, Concepto, Comprobante
...
SELECT
 ...
 ' SIZ:LEGAL |  | BOL |  | BOL | BOL ' as Vector_E,
 @Vector_T as Vector_T,
 @Vector_X as Vector_X
FROM #Auxiliar2
