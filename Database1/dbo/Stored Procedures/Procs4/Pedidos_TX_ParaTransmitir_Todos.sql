CREATE PROCEDURE [dbo].[Pedidos_TX_ParaTransmitir_Todos]
...
WHERE IsNull(Pedidos.Transmitir_a_SAT,'SI')='SI' and Pedidos.Aprobo is not null and 
	...
	EXISTS(Select Top 1 DetPed.IdPedido
		 ...
		 Where DetPed.IdPedido=Pedidos.IdPedido and (@IdObra<=0 or IsNull(Acopios.IdObra,-1)=@IdObra or IsNull(Requerimientos.IdObra,-1)=@IdObra))