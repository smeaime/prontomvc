...
CREATE PROCEDURE ProduccionPartes_TX_FiltradoPorProceso
@Proceso int
...
Set @vector_T='01113111115E911100'
...
CASE 
	...
	WHEN ProduccionPartes.IdUsuarioCerro is null THEN 'ABIERTO'
	ELSE 'CERRADO'
END as Estado,
FechaDia as [Fecha],
...
where ProduccionPartes.idProduccionProceso=@proceso
