...
CREATE PROCEDURE [dbo].[Remitos_TX_DetallesPendientesDeFacturarPorIdDetalleOrdenCompra]
...
WHERE Remitos.Destino=1 and dr.IdDetalleOrdenCompra=@IdDetalleOrdenCompra and (Remitos.Anulado is null or Remitos.Anulado<>'SI')
