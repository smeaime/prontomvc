...
CREATE Procedure [dbo].[OtrosIngresosAlmacen_TXMes]
@Anio int
AS
SELECT 
 Min(CONVERT(varchar,MONTH(FechaOtroIngresoAlmacen)) + '/' + 
	CONVERT(varchar, YEAR(FechaOtroIngresoAlmacen)) )  as Período,
