...
CREATE  Procedure [dbo].[OtrosIngresosAlmacenSAT_TXFecha]
...
WHERE oia.FechaOtroIngresoAlmacen between @Desde and @hasta and 
	(@IdObraAsignadaUsuario=-1 or oia.IdObra=@IdObraAsignadaUsuario)
