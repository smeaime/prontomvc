CREATE  Procedure [dbo].[PresupuestosVentas_TT]
...
IF LEN(@NombreServidorWeb)>0
   BEGIN
	--SET @sql1='Select IdPresupuestoVenta, Numero, IdCliente, Fecha, IdCondicionVenta, IdVendedor, Observaciones, Estado, TipoVenta, TipoOperacion, ImporteTotal From '+@BasePRONTOConsolidacion+'.dbo.PresupuestosVentas '
