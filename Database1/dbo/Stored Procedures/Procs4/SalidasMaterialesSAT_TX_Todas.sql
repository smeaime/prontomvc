...
CREATE  Procedure [dbo].[SalidasMaterialesSAT_TX_Todas]
...
INSERT INTO #Auxiliar1 
 ...
 WHERE Articulos.NumeroInventario is not null
...
WHERE @IdObraAsignadaUsuario=-1 or Sal.IdObra=@IdObraAsignadaUsuario
ORDER BY Sal.FechaSalidaMateriales
