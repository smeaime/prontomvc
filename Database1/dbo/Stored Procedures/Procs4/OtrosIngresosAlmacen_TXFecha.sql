...
CREATE  Procedure [dbo].[OtrosIngresosAlmacen_TXFecha]
...
WHERE OtrosIngresosAlmacen.FechaOtroIngresoAlmacen between @Desde and @hasta and 
	(@IdObraAsignadaUsuario=-1 or OtrosIngresosAlmacen.IdObra=@IdObraAsignadaUsuario)
