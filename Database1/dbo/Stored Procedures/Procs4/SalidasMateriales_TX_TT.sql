...
ELSE
   BEGIN
	INSERT INTO #Auxiliar1 
	 ...
	 WHERE Articulos.IdArticulo is not null and DetSal.IdSalidaMateriales=@IdSalidaMateriales1
    END
...
INSERT INTO #Auxiliar3 
 ...
 WHERE DetSal.IdSalidaMateriales=@IdSalidaMateriales1
...
SELECT 
 ...
 (Select Sum(IsNull(dsm.Cantidad,0)*IsNull(dsm.CostoUnitario,0)*IsNull(dsm.CotizacionMoneda,1))
  From DetalleSalidasMateriales dsm 
  Where dsm.IdSalidaMateriales=SalidasMateriales.IdSalidaMateriales) as [Costo total],
...
WHERE (SalidasMateriales.IdSalidaMateriales=@IdSalidaMateriales1)
