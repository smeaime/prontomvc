CREATE Procedure [dbo].[RubrosContables_TX_TT_Financieros]
...
WHERE IsNull(RubrosContables.Financiero,'NO')='SI' and RubrosContables.IdRubroContable=@IdRubroContable
