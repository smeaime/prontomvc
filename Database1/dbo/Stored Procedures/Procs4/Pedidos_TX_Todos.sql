...
SET @vector_T='0EQQHBC555555055595G1033311433A8241G00'
...
WHERE (@IdUsuario=-1 or IsNull((Select Top 1 e.PermitirAccesoATodasLasObras From Empleados e Where e.IdEmpleado=@IdUsuario),'SI')='SI') or 
