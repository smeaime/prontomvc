CREATE Procedure [dbo].[DetComprobantesProveedores_M]
...
SET 
 ...
 AmpliacionSubcontrato=@AmpliacionSubcontrato,
 IdDetalleSubcontratoDatos=@IdDetalleSubcontratoDatos,
 IdEquipoDestino=@IdEquipoDestino,
 IdUsuarioModificoCuenta=@IdUsuarioModificoCuenta,
