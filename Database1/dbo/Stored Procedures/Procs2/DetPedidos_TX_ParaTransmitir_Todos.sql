CREATE PROCEDURE [dbo].[DetPedidos_TX_ParaTransmitir_Todos]
...
WHERE 
	...
	IsNull((Select Top 1 Requerimientos.IdObra From DetalleRequerimientos DetReq
...
WHERE IsNull(Pedidos.Transmitir_a_SAT,'SI')='SI' and Pedidos.Aprobo is not null and 
	...
	((@IdObra<=0 or IsNull(Acopios.IdObra,-1)=@IdObra or IsNull(Requerimientos.IdObra,-1)=@IdObra))
