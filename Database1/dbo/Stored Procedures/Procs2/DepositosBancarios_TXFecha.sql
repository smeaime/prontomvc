CREATE  Procedure [dbo].[DepositosBancarios_TXFecha]
...
INSERT INTO #Auxiliar1 
 SELECT 
  ...
  (Select Sum(IsNull(Case When Valores.Importe is Not Null Then Valores.Importe Else 0 End,0)) 
