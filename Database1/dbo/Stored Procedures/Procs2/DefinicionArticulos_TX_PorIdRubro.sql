...
CREATE Procedure [dbo].[DefinicionArticulos_TX_PorIdRubro]
...
WHERE DefinicionArticulos.IdRubro=@IdRubro
ORDER by Rubros.Descripcion,Subrubros.Descripcion,Familias.Descripcion,Orden
