...
CREATE PROCEDURE [dbo].[DetConciliaciones_TX_Conciliados]
...
SELECT
 ...
 (Select top 1 TiposComprobante.DescripcionAb
  from TiposComprobante Where Valores.IdTipoValor=TiposComprobante.IdTipoComprobante) as [Tipo valor],
 DetConc.IdValor,
...
WHERE DetConc.IdConciliacion = @IdConciliacion and 
	(DetConc.Conciliado is null or DetConc.Conciliado='SI') and 
	(@IdValor=-1 or DetConc.IdValor=@IdValor)
