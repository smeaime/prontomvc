CREATE Procedure [dbo].[Cuentas_TX_CuentasGastoPorObraParaCombo]
...
INSERT INTO #Auxiliar1 
 ...
 FROM Cuentas
 WHERE (Cuentas.IdTipoCuenta=2 or Cuentas.IdTipoCuenta=4) and IdObra=@IdObra and Cuentas.IdCuentaGasto is not null
