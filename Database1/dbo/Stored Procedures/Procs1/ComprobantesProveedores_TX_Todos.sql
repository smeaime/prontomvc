CREATE  Procedure [dbo].[ComprobantesProveedores_TX_Todos]
...
INSERT INTO #Auxiliar1 
 ...
 WHERE (cp.Confirmado is null or cp.Confirmado<>'NO')

SET NOCOUNT OFF

DECLARE @vector_X varchar(50),@vector_T varchar(50)
SET @vector_X='0111111111111111111111111111111111133'
SET @vector_T='0093631444220121111111023126263222800'
...
SELECT 
 ...
 Substring(cp.Letra+'-'+Substring('0000',1,4-Len(Convert(varchar,cp.NumeroComprobante1)))+Convert(varchar,cp.NumeroComprobante1)+'-'+
	Substring('00000000',1,8-Len(Convert(varchar,cp.NumeroComprobante2)))+Convert(varchar,cp.NumeroComprobante2),1,20) as [Numero],
