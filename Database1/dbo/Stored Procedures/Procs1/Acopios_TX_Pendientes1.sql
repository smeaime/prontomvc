...
CREATE PROCEDURE [dbo].[Acopios_TX_Pendientes1]
...
set @vector_X='01111111111111111141133'
set @vector_T='02101322000904994199500'
...
SELECT 
 ...
 DetAco.IdDetalleAcopios,
 DetAco.Observaciones as [Observaciones item],
