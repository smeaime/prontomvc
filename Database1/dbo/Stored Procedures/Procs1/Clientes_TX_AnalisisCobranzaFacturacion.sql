CREATE  Procedure [dbo].[Clientes_TX_AnalisisCobranzaFacturacion]
...
DECLARE @IdMonedaPesos int, @IdMonedaDolar int, @IdTipoComprobanteFacturaVenta int, @IdTipoComprobanteDevoluciones int, 
...
INSERT INTO #Auxiliar1 
 SELECT 2, DetRec.IdRecibo, Year(Recibos.FechaRecibo), Month(Recibos.FechaRecibo), 
	Case When Cta.IdTipoComp=@IdTipoComprobanteFacturaVenta Then Facturas.PuntoVenta
		When Cta.IdTipoComp=@IdTipoComprobanteFacturaVenta Then Facturas.PuntoVenta
		...
		Else Null
	End, DetRec.Importe*Recibos.CotizacionMoneda
...
INSERT INTO #Auxiliar1 
 SELECT 1, Facturas.IdFactura, Year(Facturas.FechaFactura), Month(Facturas.FechaFactura), Facturas.PuntoVenta, Facturas.ImporteTotal*Facturas.CotizacionMoneda
 FROM Facturas
...
INSERT INTO #Auxiliar2 
 SELECT IdTipoComprobante, IdComprobante, Año, Mes, PuntoVenta, Importe, 
...
SET @vector_X='0000011166666666666633'
SET @vector_T='0000022233333333333300'
...
ORDER BY [A_Año], [A_Orden], [A_PuntoVenta], [A_IdTipoComprobante] Desc
