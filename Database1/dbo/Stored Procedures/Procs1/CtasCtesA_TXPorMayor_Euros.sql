...
CREATE Procedure [dbo].[CtasCtesA_TXPorMayor_Euros]
...
IF @Todo=-1
	SET @SaldoInicial=0
ELSE
	SET @SaldoInicial=IsNull((Select Sum(IsNull(CtaCte.ImporteTotalEuro,0) * IsNull(tc.Coeficiente,1))
...
IF @Todo<>-1
	INSERT INTO #Auxiliar1 
	 SELECT 0, @IdProveedor, 0, 'INI', 0, ' AL '+Convert(varchar,@FechaDesde,103), 0, @FechaDesde, @SaldoInicial, 1
...
INSERT INTO #Auxiliar1 
 SELECT 
  ...
  CtaCte.Fecha,
  CtaCte.ImporteTotalEuro * TiposComprobante.Coeficiente,
  CtaCte.IdMoneda
 FROM CuentasCorrientesAcreedores CtaCte
...
INSERT INTO #Auxiliar2 
 SELECT 
  ...
  MAX(#Auxiliar1.Fecha),
  SUM(#Auxiliar1.ImporteTotalEuro),
  #Auxiliar1.IdMoneda
 FROM #Auxiliar1 
...
SELECT 
 ...
 #Auxiliar2.Fecha,
 #Auxiliar2.ImporteTotalEuro * -1 as [Imp.orig.],
 Case When #Auxiliar2.ImporteTotalEuro<0 Then #Auxiliar2.ImporteTotalEuro * -1
	Else Null
 End as [Debe],
 Case When #Auxiliar2.ImporteTotalEuro>=0 Then #Auxiliar2.ImporteTotalEuro
	Else Null
 End as [Haber],
 #Auxiliar2.ImporteTotalEuro as [Sdo],
