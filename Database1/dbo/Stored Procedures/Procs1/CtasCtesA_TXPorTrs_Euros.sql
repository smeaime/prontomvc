...
CREATE Procedure [dbo].[CtasCtesA_TXPorTrs_Euros]
...
SELECT 
 ...
 Case When TiposComprobante.Coeficiente=1 Then CtaCte.ImporteTotalEuro*-1
	Else CtaCte.ImporteTotalEuro
 End as [Imp.orig.],
 Case When @Todo=-1
	Then 	Case When TiposComprobante.Coeficiente=1 Then CtaCte.SaldoEuro*-1
			Else CtaCte.SaldoEuro
		End 
	Else 	Case When TiposComprobante.Coeficiente=1 Then CtaCte.ImporteTotalEuro*-1
			Else CtaCte.ImporteTotalEuro
		End 
 End as [Saldo Comp.],
 CtaCte.SaldoTrs,
