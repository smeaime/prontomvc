CREATE Procedure [dbo].[CtasCtesA_TXPorTrs]
...
IF @Pendiente='S'
  BEGIN
	DELETE #Auxiliar1
	WHERE IsNull((Select Top 1 #Auxiliar2.Saldo From #Auxiliar2 Where IsNull(#Auxiliar2.IdImputacion,-1)=IsNull(#Auxiliar1.IdImputacion,-1)),0)=0
...
SELECT 
 ...
 Case When CtaCte.IdTipoComp=@IdTipoComprobanteOrdenPago or CtaCte.IdTipoComp=16 or cp.IdComprobanteProveedor is null
 ...
 Case When TiposComprobante.Coeficiente=1 Then CtaCte.ImporteTotal*-1 Else CtaCte.ImporteTotal End as [Imp.orig.],
 Case When @Todo=-1
