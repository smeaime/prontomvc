CREATE  Procedure [dbo].[AjustesStock_TX_Todos]
...
SET @vector_T='03435111331515E33100'
...
WHERE (@IdObraAsignadaUsuario=-1 or Exists(Select Top 1 Det.IdAjusteStock From DetalleAjustesStock Det Where IsNull(Det.IdObra,0)=@IdObraAsignadaUsuario and AjustesStock.IdAjusteStock=Det.IdAjusteStock)) and 
