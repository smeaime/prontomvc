...
CREATE Procedure [dbo].[Articulos_TX_EquiposTerceros]

AS 

DECLARE @IdRubroEquiposTerceros int
SET @IdRubroEquiposTerceros=IsNull((Select Top 1 P2.Valor From Parametros2 P2 
					Where P2.Campo='IdRubroEquiposTerceros'),0)
...
WHERE IsNull(Articulos.Activo,'')<>'NO' and IsNull(Articulos.IdRubro,-1)=@IdRubroEquiposTerceros
