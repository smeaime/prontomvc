...
CREATE Procedure [dbo].[ComprobantesProveedores_TXMes]
@Anio int
As
SELECT 
min(CONVERT(varchar, MONTH(FechaRecepcion)) + '/' + CONVERT(varchar, YEAR(FechaRecepcion)) )  AS Período,
YEAR(FechaRecepcion), 
MONTH(FechaRecepcion),
CASE 
