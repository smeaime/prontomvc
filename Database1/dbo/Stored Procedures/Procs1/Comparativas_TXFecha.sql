CREATE PROCEDURE [dbo].[Comparativas_TXFecha]
...
INSERT INTO #Auxiliar0 
 SELECT DISTINCT dc.IdComparativa, dc.IdPresupuesto
 FROM DetalleComparativas dc 
 LEFT OUTER JOIN Comparativas ON Comparativas.IdComparativa=dc.IdComparativa
 WHERE Comparativas.Fecha Between @Desde And @Hasta 
...
WHERE Cmp.Fecha Between @Desde And @Hasta 
