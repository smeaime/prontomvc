CREATE Procedure [dbo].[CtasCtesA_TXParaImputar_Euros]
...
SELECT 
 ...
 Null as [Pedido],
 CASE 
	WHEN TiposComprobante.Coeficiente=1 THEN CtaCte.ImporteTotalEuro
	ELSE CtaCte.ImporteTotalEuro*-1
 END as [Imp.orig.],
 CASE 
	WHEN TiposComprobante.Coeficiente=1 THEN CtaCte.SaldoEuro
	ELSE CtaCte.SaldoEuro*-1
 END as [Saldo Comp.],
 CtaCte.SaldoTrs,
 CtaCte.Marca as [*],
