...
{
    public partial class EmpleadoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmpleadoController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EmpleadoController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult GetEmpleado()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetEmpleado);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmpleadoController Actions { get { return MVC.Empleado; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Empleado";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Empleado";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetEmpleado = "GetEmpleado";
            public readonly string EmpleadosParaCombo = "EmpleadosParaCombo";
            public readonly string EmpleadosParaComboSectorCompras = "EmpleadosParaComboSectorCompras";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetEmpleado = "GetEmpleado";
            public const string EmpleadosParaCombo = "EmpleadosParaCombo";
            public const string EmpleadosParaComboSectorCompras = "EmpleadosParaComboSectorCompras";
        ...
        {
            public readonly string empleado = "empleado";
        }
        ...
        static readonly ActionParamsClass_GetEmpleado s_params_GetEmpleado = new ActionParamsClass_GetEmpleado();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetEmpleado GetEmpleadoParams { get { return s_params_GetEmpleado; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetEmpleado
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Empleado/Create.cshtml";
            public readonly string Delete = "~/Views/Empleado/Delete.cshtml";
            public readonly string Details = "~/Views/Empleado/Details.cshtml";
            public readonly string Edit = "~/Views/Empleado/Edit.cshtml";
            public readonly string Index = "~/Views/Empleado/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmpleadoController : ProntoMVC.Controllers.EmpleadoController
    {
        public T4MVC_EmpleadoController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.Empleado empleado);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(ProntoMVC.Data.Models.Empleado empleado)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "empleado", empleado);
            CreateOverride(callInfo, empleado);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.Empleado empleado);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ProntoMVC.Data.Models.Empleado empleado)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "empleado", empleado);
            EditOverride(callInfo, empleado);
            return callInfo;
        }
        ...
        [NonAction]
        partial void GetEmpleadoOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, int id);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetEmpleado(int id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetEmpleado);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            GetEmpleadoOverride(callInfo, id);
            return callInfo;
        }

        [NonAction]
        partial void EmpleadosParaComboOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult EmpleadosParaCombo()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.EmpleadosParaCombo);
            EmpleadosParaComboOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void EmpleadosParaComboSectorComprasOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult EmpleadosParaComboSectorCompras()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.EmpleadosParaComboSectorCompras);
            EmpleadosParaComboSectorComprasOverride(callInfo);
            return callInfo;
        }
