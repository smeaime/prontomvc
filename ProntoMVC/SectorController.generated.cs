...
namespace ProntoMVC.Controllers
{
    public partial class SectorController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SectorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SectorController Actions { get { return MVC.Sector; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Sector";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Sector";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetSectoresJson = "GetSectoresJson";
            public readonly string ListaSectores2 = "ListaSectores2";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GetSectoresJson = "GetSectoresJson";
            public const string ListaSectores2 = "ListaSectores2";
        ...
        static readonly ActionParamsClass_ListaSectores2 s_params_ListaSectores2 = new ActionParamsClass_ListaSectores2();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_ListaSectores2 ListaSectores2Params { get { return s_params_ListaSectores2; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_ListaSectores2
        {
        ...
        {
            public readonly string sector = "sector";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Sector/Create.cshtml";
            public readonly string Delete = "~/Views/Sector/Delete.cshtml";
            public readonly string Details = "~/Views/Sector/Details.cshtml";
            public readonly string Edit = "~/Views/Sector/Edit.cshtml";
            public readonly string Index = "~/Views/Sector/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SectorController : ProntoMVC.Controllers.SectorController
    {
        public T4MVC_SectorController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GetSectoresJsonOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        [NonAction]
        public override System.Web.Mvc.JsonResult GetSectoresJson()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetSectoresJson);
            GetSectoresJsonOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void ListaSectores2Override(T4MVC_System_Web_Mvc_JsonResult callInfo, int jtStartIndex, int jtPageSize, string jtSorting);

        [NonAction]
        public override System.Web.Mvc.JsonResult ListaSectores2(int jtStartIndex, int jtPageSize, string jtSorting)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.ListaSectores2);
            ...
            ListaSectores2Override(callInfo, jtStartIndex, jtPageSize, jtSorting);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.Sector sector);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(ProntoMVC.Data.Models.Sector sector)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "sector", sector);
            CreateOverride(callInfo, sector);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.Sector sector);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ProntoMVC.Data.Models.Sector sector)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "sector", sector);
            EditOverride(callInfo, sector);
            return callInfo;
        }
