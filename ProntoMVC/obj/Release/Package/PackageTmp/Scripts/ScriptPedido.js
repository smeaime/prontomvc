...
//                                    $('#IdUnidad').val(this.value);
    ...
    $("#ListaDrag5").jqGrid({
        ...
        colModel: [
                        ...
                        { name: 'Numero', index: 'Numero', align: 'right', width: 50, editable: false, search: true, searchoptions: { sopt: ['eq']} },
                         { name: 'SubNumero', index: 'Numero', align: 'right', width: 50, frozen: true, editable: false, search: true, searchoptions: { sopt: ['eq']} },
                        { name: 'FechaPedido', index: 'Orden', align: 'right', width: 50, editable: false, search: true, searchoptions: { sopt: ['eq']} },
