...
function AgregarRenglonesEnBlanco(renglonVacio) {
    ...
    if (emptyRows > 0 && rowsLlenas == rows) {
        //   alert(emptyRows);
...
$(function () {
    ...
    window.onerror = function (msg, url, line) {
        ...
        alert("linea " + line + " " + url + "     " + msg + " ");

        if (encodeURIComponent) {
            return loadXMLDoc(ROOT + "Error/JSErrorHandler", "msg=" + encodeURIComponent(msg) + '&url=' + encodeURIComponent(url) + "&line=" + line);
        }
        else {
