...
{
    public partial class CondicionVentaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CondicionVentaController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CondicionVentaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CondicionVentaController Actions { get { return MVC.CondicionVenta; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "CondicionVenta";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "CondicionVenta";
        ...
        public class ActionParamsClass_Edit
        {
            ...
            public readonly string Condiciones_Compras = "Condiciones_Compras";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Views/CondicionVenta/Edit.cshtml";
            public readonly string Index = "~/Views/CondicionVenta/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CondicionVentaController : ProntoMVC.Controllers.CondicionVentaController
    {
        public T4MVC_CondicionVentaController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.Condiciones_Compra Condiciones_Compras);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ProntoMVC.Data.Models.Condiciones_Compra Condiciones_Compras)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Condiciones_Compras", Condiciones_Compras);
            EditOverride(callInfo, Condiciones_Compras);
            return callInfo;
        }
