    ...
    Sub Permisos()
        ...
        Try
            ...
            If rol(0) = "Cliente" Or rol(0) = "WilliamsClientes" Then
                Response.Redirect(String.Format("CartaDePorteInformesAccesoClientes.aspx"))  Response.Redirect(String.Format("~/ProntoWeb/CartaDePorteInformesAccesoClientes.aspx"))
            End If
