<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="CDPDestinos.aspx.vb" Inherits="CDPDestinos" Title="Destinos de Cartas porte" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                DataKeyNames="IdWilliamsDestino" AllowPaging="True" AllowSorting="True" PageSize="10"   HeaderStyle-Wrap=true>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="CUIT" ItemStyle-Wrap=false >
                        <EditItemTemplate>
                            <asp:TextBox ID="txtCUIT" Width="130" runat="server" Text='<%# Bind("[CUIT]") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtNewCUIT" Width="130" runat="server"></asp:TextBox>
                        </FooterTemplate>
                        <ItemTemplate >
                            <asp:Label ID="lblCUIT" Width="130" runat="server" Text='<%# Bind("[CUIT]") %>'  ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
