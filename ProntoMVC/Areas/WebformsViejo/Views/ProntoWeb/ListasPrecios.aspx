    ...
    <table style="padding: 0px; border: none #FFFFFF; width: 696px; margin-right: 0px;"
        ...
        <tr>
            <td colspan="3" style="border: thin none #FFFFFF; font-weight: bold; color: #FFFFFF;
                font-size: large; height: 34px;" align="left" valign="top">
                LISTAS DE PRECIOS
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="gvMaestro" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                DataKeyNames="IdListaPrecios" AllowPaging="True" PageSize="6">
                ...
                <Columns>
                    ...
                    --%>
                    <asp:CommandField HeaderText="" ShowSelectButton="True" ShowHeader="True" />
                    ...
                    <asp:BoundField   DataField="IdListaPrecios" />
            ...
            <asp:GridView ID="gvDetalle" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                DataKeyNames="IdListaPreciosDetalle" Width="700px">
                <%--                OnRowDataBound="gvDetalle_RowDataBound" 
                OnRowCancelingEdit="gvDetalle_RowCancelingEdit"
                OnRowEditing="gvDetalle_RowEditing" 
                OnRowUpdating="gvDetalle_RowUpdating" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Articulo">
                        <EditItemTemplate>
                            <asp:DropDownList ID="cmbArticulo" runat="server" Width="100px">
                            </asp:DropDownList>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblArticulo" runat="server" Width="100px" Text='<%# Eval("Producto") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="cmbNewArticulo" runat="server" Width="100px">
                            </asp:DropDownList>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Destino">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtDestino" runat="server" autocomplete="off" CssClass="CssTextBox"
                                Text='<%# Bind("DestinoDesc") %>' TabIndex="23"></asp:TextBox>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblDestinoDeCartaDePorte" runat="server" Text='<%# Eval("DestinoDesc") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
