<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="CtaCteAcreedores.aspx.vb" Inherits="CtaCteAcreedores" Title="Cta. Cte. Acreedores" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                SelectMethod="GetListDataset" TypeName="Pronto.ERP.Bll.CtaCteAcreedorManager"
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"
                SelectMethod="GetListItems" TypeName="Pronto.ERP.Bll.CtaCteAcreedorManager" DeleteMethod="Delete"
                UpdateMethod="Save">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HFSC" Name="SC" PropertyName="Value" Type="String" />
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvEstadoPorMayor" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                DataSourceID="" GridLines="Horizontal" AllowPaging="True" Width="700px" PageSize="8">
                <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                <Columns>
            ...
            <asp:BoundField DataField="Proveedor" HeaderText="Proveedor" />--%>
                    ...
                    <asp:BoundField DataField="Sdo" HeaderText="Saldo" />
                </Columns>
                <RowStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" VerticalAlign="Top" />
                <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="#F7F7F7" />
                <PagerStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Left" />
            ...
            <asp:GridView ID="gvEstadoPorTrs" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                SortExpression="Id" Visible="False" />--%>
                    ...
                    <asp:BoundField DataField="Ref_" HeaderText="Ref" />
                    <%--        <asp:BoundField DataField="Saldo actual" HeaderText="Saldo actual" />
            <asp:BoundField DataField="Proveedor" HeaderText="Proveedor" />--%>
                    <asp:BoundField DataField="Fecha" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}" />
                    <asp:BoundField DataField="Imp_Orig_" HeaderText="Imp.Orig." />
            ...
            <table style="padding: 0px; border: none #FFFFFF; width: 696px; margin-right: 0px;"
                ...
                <tr style="visibility: hidden; display: none;">
                    ...
                    <td style="width: 175px; height: 24px;">
                        <asp:Label ID="lblProveedor" runat="server" ForeColor="White" Visible="true"></asp:Label>
                    </td>
                ...
                <tr>
                    ...
                    <td class="EncabezadoCell">
                        <asp:RadioButtonList ID="RadioButtonListTrans_O_Mayor" runat="server" AutoPostBack="True">
                    ...
                    <td class="EncabezadoCell">
                        <asp:RadioButtonList ID="RadioButtonListAlcance" runat="server" AutoPostBack="True">
