...
CodeFile="NotaDeDebitos.aspx.vb" Inherits="NotasDeDebito" title="Notas de Debito" %>
    ...
    <asp:LinkButton ID="lnkNuevo" runat="server" Font-Bold="True" 
        ...
        <asp:DropDownList ID="cmbBuscarEsteCampo" runat="server" Height="22px" 
            Style="text-align: right; margin-left: 0px;" Width="119px">
                ...
                <asp:ListItem Text="Fecha" Value="[Fecha Debito]" />
    ...
    <asp:GridView ID="GridView1"  
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Fecha" SortExpression="Fecha">
                <EditItemTemplate>
                    &nbsp;&nbsp;
                    <asp:Calendar ID="Calendar1" runat="server" SelectedDate='<%# Bind("[Fecha Debito]") %>'></asp:Calendar>
                </EditItemTemplate>
                <ControlStyle Width="100px" />
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("[Fecha Debito]", "{0:d}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:BoundField DataField="Total Debito" HeaderText="Total" />
...
<%--                        <asp:BoundField DataField="Cump." HeaderText="Cump." />
            ...
            <asp:BoundField DataField="Ing_Brutos" HeaderText="Ing_Brutos" />
            
            <asp:BoundField DataField="Perc_IVA" HeaderText="Perc_IVA" />
            <asp:BoundField DataField="Otras perc_" HeaderText="Otras perc_" />
            ...
            <asp:BoundField DataField="Venta en cuotas de" HeaderText="Venta en cuotas de" />
            <asp:BoundField DataField="Nro_Cuota" HeaderText="Nro_Cuota" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetListDataset" TypeName="Pronto.ERP.Bll.NotaDeDebitoManager" DeleteMethod="Delete" UpdateMethod="Save">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetListItems" TypeName="Pronto.ERP.Bll.NotaDeDebitoManager" DeleteMethod="Delete" UpdateMethod="Save">
        <SelectParameters>
            <asp:ControlParameter ControlID="HFSC" Name="SC" PropertyName="Value" Type="String" />
...
<%--    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <ServerReport ReportServerUrl="http://nanopc:81/ReportServer" 
            ReportPath="/NotaDeDebitos" />
    </rsweb:ReportViewer>
    <br />
    <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" 
        Font-Size="8pt" Height="299px" Width="770px">
        <LocalReport ReportPath="ProntoWeb\Informes\NotaDeDebitos.rdl">
        </LocalReport>
