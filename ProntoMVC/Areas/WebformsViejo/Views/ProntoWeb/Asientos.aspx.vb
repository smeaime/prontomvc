...
Partial Class Asientos
    ...
    Sub Imprimir(ByVal IdAsiento)
        ...
        Dim p = DirApp() & "\Documentos\" & "Asiento_PRONTO.dot"
        output = ImprimirWordDOT(p, Me, HFSC.Value, Session, Response, IdAsiento, mvarClausula, mPrinter, mCopias, System.IO.Path.GetTempPath & "Asiento.doc", EmpresaSegunString, PathLogo)
        Try
    ...
    End Sub
    Sub Permisos()
        'Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "Asientos")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdAsiento As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("Asiento.aspx?Id={0}", IdAsiento.ToString))
        End Select
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.DetAsientos_TXAsi, DataBinder.Eval(e.Row.DataItem, "Id"))
            gp.DataBind()
        End If
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("Asiento.aspx?Id=-1"))
    End Sub
    ...
    Sub Rebind()
        ...
        'chupo
        Dim dt As DataTable = EntidadManager.GetStoreProcedure(HFSC.Value, enumSPs.Asientos_TXFecha, DateAdd(DateInterval.Year, -2, Now), Now)
        ...
        Debug.print(ProntoDebug.DebugGetDataTableColumnNames(dt))
