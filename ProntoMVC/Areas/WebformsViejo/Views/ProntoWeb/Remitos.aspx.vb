...
Partial Class Remitos
    ...
    Sub Imprimir(ByVal IdRemito)
        ...
        output = ImprimirWordDOT(DirApp() & "\Documentos\" & "Remito_PRONTO_0001.dot", Me, HFSC.Value, Session, Response, IdRemito, mPrinter, mCopias, Args, System.IO.Path.GetTempPath & "Remito.doc")
        Try
    ...
    Sub Permisos()
        'Dim p = BDLmasterPermisosManager.Fetch(ConexBDLmaster, session(SESSIONPRONTO_UserId), "Remitos")
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Select Case e.CommandName.ToLower
            Case "edit"
                ...
                Dim IdRemito As Integer = Convert.ToInt32(GridView1.DataKeys(rowIndex).Value)
                Response.Redirect(String.Format("Remito.aspx?Id={0}", IdRemito.ToString))
        End Select
    End Sub
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gp.DataSource = Pronto.ERP.Bll.EntidadManager.GetStoreProcedure(HFSC.Value, "DetRemitos_TXRem", DataBinder.Eval(e.Row.DataItem, "Id"))
            gp.DataBind()
        End If
    End Sub
    ...
    Protected Sub lnkNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkNuevo.Click
        Response.Redirect(String.Format("Remito.aspx?Id=-1"))
    End Sub
