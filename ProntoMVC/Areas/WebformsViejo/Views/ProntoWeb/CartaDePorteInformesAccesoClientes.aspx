<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="CartaDePorteInformesAccesoClientes.aspx.vb" Inherits="CartaDePorteInformesAccesoClientes"
    Title="Informes" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                <ContentTemplate>
                    <asp:LinkButton ID="btnMasPanel" runat="server" Font-Bold="False" Font-Underline="True"
                        ForeColor="" CausesValidation="False" Font-Size="X-Small" Height="20px"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cmbEstado" runat="server" Style="text-align: right; margin-left: 0px;"
                                       enabled="true"   CssClass="CssCombo" ToolTip="Estado de la carta de porte" Font-Size="Small" Height="22px">
                                        <asp:ListItem Text="Todas (menos las rechazadas)" Value="TodasMenosLasRechazadas"  Enabled="false" />
                    ...
                    <td class="EncabezadoCell" style="height: 18px" visible="false">
                        <asp:RadioButtonList ID="CriterioWHERE" runat="server" RepeatDirection="Horizontal">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DropDownList ID="cmbCriterioWHERE" runat="server" ToolTip=""
                            ...
                            <tr>
                                ...
                                <td class="EncabezadoCell" style="width: 30%; height: 18px;">
                                    <asp:CheckBox ID="chkTitular" runat="server" Checked="false" />
                                ...
                                <td class="EncabezadoCell">
                                    <asp:CheckBox ID="chkIntermediario" runat="server" Checked="false" />
                            ...
                            <tr>
                                ...
                                <td class="EncabezadoCell" style="width: 220px">
                                    <asp:CheckBox ID="chkRemComercial" runat="server" Checked="false" />
                    ...
                    <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server"
                        ...
                        CollapsedText="más filtros..." ExpandedText="ocultar" TextLabelID="btnMasPanel" Collapsed="false">
