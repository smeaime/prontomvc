...
Partial Class ProntoWeb_Principal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Try
        '    Dim NombreArchivo As String = ErrHandler.WriteError("Prueba")
        ...
        '    MsgBoxAjax(Me, "El directorio de log de errores no está habilitado. " & ex.Message)
        'End Try
