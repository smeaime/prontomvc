...
{
    public partial class IngresoBrutoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IngresoBrutoController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected IngresoBrutoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IngresoBrutoController Actions { get { return MVC.IngresoBruto; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "IngresoBruto";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "IngresoBruto";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Edit = "~/Views/IngresoBruto/Edit.cshtml";
            public readonly string Index = "~/Views/IngresoBruto/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_IngresoBrutoController : ProntoMVC.Controllers.IngresoBrutoController
    {
        public T4MVC_IngresoBrutoController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ProntoMVC.Data.Models.IBCondicion o);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(ProntoMVC.Data.Models.IBCondicion o)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
