...
Private Sub cmd_Click(Index As Integer)
   ...
   Select Case Index
      ...
      Case 0
         ...
         If DataCombo1(7).Visible And Not IsNumeric(DataCombo1(7).BoundText) And _
               Me.TipoRequerimiento = "OP" Then
...
'               If (Not IsNumeric(dc.BoundText) And dc.Index <> 5) Or (Len(Trim(dc.BoundText)) = 0 And (dc.Index = 5 Or dc.Index = 6)) Then
         ...
         If txtCosto.Visible And _
               (Len(txtCosto.Text) = 0 Or Not IsNumeric(txtCosto.Text)) Then
