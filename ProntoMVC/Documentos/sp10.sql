/*
ALTER Procedure [dbo].[Articulos_TX_Cardex]
...
declare @IdArticulo int,@FechaDesde datetime, @FechaHasta datetime,@CodigoDesde varchar(20),@CodigoHasta varchar(20),@IdObra1 int,@IdDeposito1 int,@IdUbicacion1 int,
		@MostrarCosto varchar(2) = Null,@Detallado varchar(2) = Null,@RegistrosResumidos varchar(2) = Null,@Descripcion varchar(300) = Null,@SoloKits varchar(2) = Null
set @IdArticulo=193
set @FechaDesde=convert(datetime,'01/01/2000',103)
set @FechaHasta=convert(datetime,'19/01/2015',103)
set @CodigoDesde=0609
set @CodigoHasta=''
set @IdObra1=-1 
set @IdDeposito1=-1 
set @IdUbicacion1=-1 
