...
INSERT INTO #Auxiliar0 Select '01-01-02','Calles','Calles','01-01',2,Null,'<a href="/' + @Directorio + '/Calle/Index">Calles</a>','Calles','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-03','Feriados','Feriados','01-01',3,Null,'<a href="/' + @Directorio + '/Feriado/Index">Feriados</a>','Feriados','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-04','Localidades','Localidades','01-01',4,Null,'<a href="/' + @Directorio + '/Localidad/Index">Localidades</a>','Localidades','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-05','Monedas','Monedas','01-01',5,Null,'<a href="/' + @Directorio + '/Moneda/Index">Monedas</a>','Monedas','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-06','Paises','Paises','01-01',6,Null,'<a href="/' + @Directorio + '/Pais/Index">Paises</a>','Paises','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-07','Provincias','Provincias','01-01',7,Null,Null,'Provincias','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-08','TiposCompra','Tipos de compra','01-01',8,Null,Null,'TiposCompra','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-09','TiposComprobante','Tipos de comprobante','01-01',9,Null,Null,'TiposComprobante','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-10','TiposNegocio','Tipos de negocia p/venta','01-01',10,Null,'<a href="/' + @Directorio + '/TiposNegociosVenta/Index">Tipos de negocia p/venta</a>','TiposNegocio','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-11','TiposOperacionesGrupos','Tipos de operaciones (grupos)','01-01',11,Null,'<a href="/' + @Directorio + '/TiposOperacionesGrupos/Index">Tipos de operaciones (grupos)</a>','TiposOperacionesGrupos','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-12','TiposOperaciones','Tipos de operaciones','01-01',12,Null,'<a href="/' + @Directorio + '/TiposOperacione/Index">Tipos de operaciones</a>','TiposOperaciones','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-13','Traducciones','Traducciones','01-01',13,Null,Null,'Traducciones','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-01-14','Transportistas','Transportistas','01-01',14,Null,'<a href="/' + @Directorio + '/Transportista/Index">Transportistas</a>','Transportistas','NO','Principal'
...
INSERT INTO #Auxiliar0 Select '01-10-03','Ganancias1','Tabla de ganancias','01-10',3,Null,'<a href="/' + @Directorio + '/Ganancia/Index">Tabla de ganancias</a>','Ganancias','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-10-04','IGCondiciones1','Categorías de ganancias','01-10',4,Null,'<a href="/' + @Directorio + '/TipoRetencionGanancia/Index">Categorías de ganancias</a>','IGCondiciones','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-10-05','IBCondiciones1','Categorías de ing. brutos','01-10',5,Null,'<a href="/' + @Directorio + '/IBCondicion/Index">Categorías de ing. brutos</a>','IBCondiciones','NO','Principal'
...
INSERT INTO #Auxiliar0 Select '01-11-03','IGCondiciones2','Categorías de ganancias','01-11',3,Null,'<a href="/' + @Directorio + '/TipoRetencionGanancia/Index">Categorías de ganancias</a>','IGCondiciones','NO','Principal'
INSERT INTO #Auxiliar0 Select '01-11-04','IBCondiciones2','Categorías de ing. brutos','01-11',4,Null,'<a href="/' + @Directorio + '/IBCondicion/Index">Categorías de ing. brutos</a>','IBCondiciones','NO','Principal'
