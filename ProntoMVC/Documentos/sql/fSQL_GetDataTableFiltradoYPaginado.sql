...
WHERE 1=1     
    ...
    And (@Destino IS NULL Or cdp.Destino = @Destino)
    And (@Entregador IS NULL Or cdp.Entregador = @Entregador)
	...
	--AND EXISTS ( SELECT * FROM CartasDePorte COPIAS  where COPIAS.NumeroCartaDePorte=CDP.NumeroCartaDePorte
...
from dbo.fSQL_GetDataTableFiltradoYPaginado  ( NULL, NULL, NULL,'2014-01-06 00:00:00','2014-11-06 00:00:00' ) as cdp
