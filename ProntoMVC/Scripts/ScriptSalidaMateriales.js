...
// COMPLETAR EL ITEM DE PRESUPUESTO DE OBRA CUANDO SE ELIGE LA ETAPA POR EL COMBO
...
$(function () {
    ...
    $("#ListaDrag").jqGrid({
        ...
        colModel: [
                    ...
                    { name: 'NumeroRecepcionAlmacen', index: 'NumeroRecepcionAlmacen', align: 'right', width: 70, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
                    { name: 'NumeroRecepcion', index: 'NumeroRecepcion', align: 'right', width: 100, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
                    ...
                    { name: 'NumeroRequerimiento', index: 'NumeroRequerimiento', align: 'right', width: 50, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
                    { name: 'ItemRM', index: 'ItemRM', align: 'center', width: 30, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
                    { name: 'NumeroPedido', index: 'NumeroPedido', align: 'right', width: 50, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
    ...
    $("#ListaDrag2").jqGrid({
        ...
        colModel: [
                    ...
                    { name: 'IdArticulo', index: 'IdArticulo', width: 80, sortable: false, editable: false, search: false, hidden: true },
                    { name: 'NumeroValeSalida', index: 'NumeroValeSalida', align: 'right', width: 70, editable: false, search: true, hidden: false, searchoptions: { sopt: ['eq'] } },
