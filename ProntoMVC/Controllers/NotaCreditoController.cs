...
namespace ProntoMVC.Controllers
{
 ...
 //   [Authorize(Roles = "Administrador,SuperAdmin,Compras")] //ojo que el web.config tambien te puede bochar hacia el login
    public partial class NotaCreditoController : ProntoBaseController
    {
        ...
        {
            if (!PuedeLeer(enumNodos.NotasCredito)) throw new Exception("No tenés permisos");
        ...
        {
            if (!PuedeEditar(enumNodos.NotasCredito)) throw new Exception("No tenés permisos");
        ...
        private bool Validar(ProntoMVC.Data.Models.Pedido o, ref string sErrorMsg, ref string sWarningMsg)
        {
            ...
            if (!PuedeEditar(enumNodos.NotasCredito)) sErrorMsg += "\n" + "No tiene permisos de edición";
