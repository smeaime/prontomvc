...
namespace ProntoMVC.Controllers
{
    ...
    public partial class CotizacionMonedaController : ProntoBaseController
    {
        ...
        void UpdateColecciones(ref Articulo o)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public virtual ActionResult Cotizaciones(string sidx, string sord, int? page, int? rows, bool _search, string searchField, string searchOper, string searchString)
        {
            var Articulos = db.Cotizaciones.AsQueryable();
            if (_search)
            {
            ...
            var jsonData = new jqGridJson()
            {
                ...
                rows = (
                    ...
                    select new jqGridRowJson
                    {
                        ...
                        cell = new string[] { 
                            "<a href="+ Url.Action("Edit",new {id = a.IdCotizacion} )  +" target='_blank' >Editar</>",
                            "",
