...
namespace ProntoMVC.Controllers
{
    public partial class UnidadController : ProntoBaseController
    {
        ...
        public virtual JsonResult Unidades_DynamicGridData(string sidx, string sord, int page, int rows, bool _search, string filters)
        {
            int totalRecords = 0;
            int pageSize = rows;

            var pagedQuery = Filters.FiltroGenerico<Data.Models.Unidad>
