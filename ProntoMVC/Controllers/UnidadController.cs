...
namespace ProntoMVC.Controllers
{
    ...
    public partial class UnidadController : ProntoBaseController
    {
        ...
        void CargarViewBag(Pedido o)
        {
            ...
            try
            {
                ViewBag.CantidadAutorizaciones = db.Autorizaciones_TX_CantidadAutorizaciones((int)Pronto.ERP.Bll.EntidadManager.EnumFormularios.NotaPedido, o.TotalPedido, -1).Count();
            }
            catch (Exception e)
            {
