...
namespace ProntoMVC.Controllers
{
    public partial class UnidadesOperativaController : ProntoBaseController
    {
        ...
        public virtual JsonResult UnidadesOperativas_DynamicGridData(string sidx, string sord, int page, int rows, bool _search, string filters)
        {
            int totalRecords = 0;
            int pageSize = rows;

            var pagedQuery = Filters.FiltroGenerico<Data.Models.UnidadesOperativa>
            ...
            var Entidad1 = (from a in Entidad
                            select new { IdUnidadOperativa = a.IdUnidadOperativa }).ToList();
