...
namespace ProntoMVC.Controllers
{
    ...
    public partial class ObraController : ProntoBaseController
    {
        ...
        {
            if (!PuedeLeer(enumNodos.Obras)) throw new Exception("No tenés permisos");
        ...
        {
            if (!PuedeEditar(enumNodos.Obras)) throw new Exception("No tenés permisos");
        ...
        /// <returns></returns>
        [HttpPost]
        public virtual ActionResult Obras(string sidx, string sord, int? page, int? rows, bool _search, string searchField, string searchOper, string searchString)
        {
            var Articulos = db.Obras.AsQueryable();
            if (_search)
            {
            ...
            //        Articulos = Articulos.OrderByDescending(a => a.Fecha);
            //    else
            //        Articulos = Articulos.OrderBy(a => a.Fecha);
            //}
            ...
            var jsonData = new jqGridJson()
            {
                ...
                rows = (
                    ...
                    select new jqGridRowJson
                    {
                        ...
                        cell = new string[] { 
                            "<a href="+ Url.Action("Edit",new {id = a.IdObra} )  +" target='_blank' >Editar</>",
                            "",
                            a.NumeroObra.NullSafeToString(), 
                            a.Descripcion.NullSafeToString(), 
                            //a.Cotizacion.NullSafeToString(), 
                            //a.CotizacionLibre.NullSafeToString(), 
